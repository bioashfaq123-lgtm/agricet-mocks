...
// IST = UTC+5:30.  19 June 2026, 8 PM IST (start) → 20 June 2026, 12 PM IST (end).
...
export const LIVE_START_UTC = new Date("2026-06-19T14:30:00Z"); // 8 PM IST, 19 June
export const LIVE_END_UTC   = new Date("2026-06-20T06:30:00Z"); // 12:00 PM IST, 20 June
