      ...
      <div className="min-h-screen bg-gradient-to-br from-primary-50 to-white flex items-center justify-center p-4">
        <div className="card p-8 max-w-md w-full text-center">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
            ...
            <p className="text-amber-600 text-xs">Get lifetime access to all 17 subjects for just ₹199!</p>
          </div>

          <Link href="/signup" className="btn-primary w-full py-3.5 text-base mb-3 flex items-center justify-center gap-2">
            Get Full Access – ₹199 <ArrowRight className="w-5 h-5" />
          </Link>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mt-6 card p-5 bg-primary-50 border border-primary-200 text-center">
          ...
          <p className="text-primary-600 text-xs mt-1 mb-3">3,400+ MCQs + Previous Year Papers for ₹199</p>
