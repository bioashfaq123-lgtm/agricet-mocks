...
export const DA101_LECTURES: Lecture[] = [
  ...
  lec("da-101", 24, "Integrated Farming System (IFS)", "IFS definition & aim (higher profitability without altering ecological/socio-economic balance); integrating crop husbandry with allied enterprises; advantages (productivity, profitability, sustainability, balanced food, recycling of waste, money round the year, saving energy via biogas); IFS types (crop-livestock-fish, crop+dairy+biogas+silviculture); fish as a biological plough"),
  lec("da-101", 25, "Sustainable Agriculture & Organic Farming", "Sustainable agriculture (long-run productivity, objectives, healthy soil via green manure/conservation tillage, soil quality analogous to water & air); organic farming definition (natural ways, no synthetics/GMOs), IFOAM (1972), four principles (Health, Fairness, Ecological Balance, Care), nitrogen fixation by legumes, Brix analysis, certification (APEDA in India, USDA in USA; land chemical-free 3+ years)"),
];
...
export const DA281_LECTURES: Lecture[] = [
  lec("da-281", 1, "Introduction to Forestry & Forest Policy", "Branches of forestry, tree growth stages, National Forest Policy 1988, Indian Forest Act"),
  lec("da-281", 2, "Silvicultural Systems & Practices", "Clear felling, selection system, coppice, shelterwood; afforestation"),
  lec("da-281", 3, "Agroforestry Systems", "Agrisilviculture, silvopastoral, horti-pastoral, shifting cultivation, Taungya"),
  lec("da-281", 4, "Important Timber & Multipurpose Trees", "Teak, Eucalyptus, Casuarina, Bamboo, Subabul – cultivation and uses"),
  lec("da-281", 5, "Social & Farm Forestry", "Farm forestry, windbreaks & shelterbelts, energy plantations, Vanamahotsavam"),
  lec("da-281", 6, "Medicinal Plants – I", "Ashwagandha, Aloe vera, Senna, Coleus – cultivation, active principles, uses"),
  lec("da-281", 7, "Medicinal Plants – II", "Neem, Tulsi, Kalmegh – cultivation and medicinal uses"),
  lec("da-281", 8,  "Aromatic Plants", "Lemongrass, Citronella, Palmarosa, Geranium, Davana – oil extraction, uses"),
  lec("da-281", 9,  "Forest Policy & Protection", "National Forest Policy 1988, Indian Forest Act, forest offences, forest protection"),
  lec("da-281", 10, "Minor Forest Products (MFP)", "Tendu, lac, katha & cutch, tannins, natural colours, oils – collection and trade"),
  lec("da-281", 11, "Nursery & Tree Propagation", "Forest nurseries, seed collection & storage, planting, vegetative propagation"),
  lec("da-281", 12, "Timber Trees – Advanced Topics", "Teak, Rosewood, Sandalwood, Bamboo – wood properties, harvesting, uses, markets"),
  lec("da-281", 13, "Forestry Environmental Services", "Soil & water conservation, leaf litter, agroforestry benefits, fuel & fodder"),
...
export const DA291_LECTURES: Lecture[] = [
  ...
  lec("da-291", 4, "Extension Reforms (ATMA, SREP)", "ATMA, SREP, market-led extension, adoption & diffusion of innovations, adopter categories"),
  lec("da-291", 5, "Rural Sociology", "Rural community characteristics, rural vs urban society, village leadership, social change"),
  lec("da-291", 6, "Panchayati Raj & Local Governance", "Three-tier system: Gram Panchayat, Mandal/Block Parishad, Zilla Parishad"),
  lec("da-291", 7, "Extension Teaching Aims & Methods", "Attention-interest-desire-conviction-action-satisfaction; method & result demonstrations"),
  lec("da-291", 8, "Extension Programme Planning", "Programme, project, plan of work, calendar of work, principles & steps in planning"),
  lec("da-291", 9, "Evaluation in Extension", "Meaning, elements, degrees and importance of evaluation; reconsideration phase"),
  lec("da-291", 10, "Leadership in Extension", "Types of leadership (autocratic/democratic), selection and training of local leaders"),
  lec("da-291", 11, "Agricultural Information Materials", "Leaflets, folders, pamphlets, circular letters, bulletins, wall newspapers"),
  lec("da-291", 12, "Programme Planning & PRA", "Extension programme planning steps, felt needs, Participatory Rural Appraisal (PRA)"),
  lec("da-291", 13, "Community Development", "Community development as a participatory process, people's participation, rural development"),
  lec("da-291", 14, "Developmental Programmes", "Developmental programmes (pre- and post-independence), rural development objectives & problems"),
