...
export const da151Questions: Question[] = [
  ...
  },
  {
    ...
    options: ["8500 kcal per kilogram of petrol", "11100 kcal per kilogram of petrol", "12400 kcal per kilogram of petrol", "9800 kcal per kilogram of petrol"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Disc angle varies between 50 and 60 degrees", "Disc angle varies between 42 and 45 degrees", "Disc angle varies between 15 and 25 degrees", "Disc angle varies between 25 and 35 degrees"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Tilt angle varies between 30 and 40 degrees", "Tilt angle varies between 15 and 25 degrees", "Tilt angle varies between 42 and 45 degrees", "Tilt angle varies between 5 and 10 degrees"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["To increase soil nitrogen through biological fixation", "To improve germination of directly seeded paddy crops", "To reduce water leaching and kill weeds by decomposition", "To increase the hardness of the soil surface layer"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Shelling groundnut pods from harvested crop plants", "Decorticating castor seeds from harvested castor pods", "Threshing cotton bolls in dry zone conditions", "Threshing wheat, barley and gram using bullock power"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["About 7 litres produces 20 hp hours", "About 2.5 litres produces 20 hp hours", "About 10 litres produces 20 hp hours", "About 4.5 litres produces 20 hp hours"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["About 1/4th of total electrical power generated", "About 1/10th of total electrical power generated", "About 1/3rd of total electrical power generated", "About 1/5th of total electrical power generated"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Using inlet and exhaust valves controlled by camshaft", "Through ports in cylinder with a blower or compressor", "Using separate exhaust manifold with turbocharger assistance", "Natural exhaust occurs due to piston movement alone"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Change transmission oil every 1000 hours of operation", "Change transmission oil every 60 hours of operation", "Change transmission oil every 500 hours of operation", "Change transmission oil every 250 hours of operation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Maintains uniform depth during ploughing operation", "Inverts and pulverizes the cut furrow slice completely", "Supports the plough bottom against the furrow wall", "Cuts furrow slice vertically from the land ahead of plough"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Relative humidity should not exceed 60% for drying", "Relative humidity should not exceed 90% for drying", "Relative humidity should not exceed 80% for drying", "Relative humidity should not exceed 70% for drying"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Tapered roller bearings used for their high load capacity", "Oil soaked wooden bearings used because cheaply available", "Ball bearings used for their low friction characteristics", "Chilled cast iron bearings used for their durability quality"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wind speed must be 3 to 5 km per hour", "Wind speed must be 20 to 25 km per hour", "Wind speed must be 15 to 20 km per hour", "Wind speed must be 8 to 10 km per hour"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Wet liner is permanently fixed while dry liner is easily removable", "Wet liner has internal coating while dry liner has external coating", "Wet liner contacts cooling water while dry liner does not contact water", "Wet liner is thicker while dry liner is thinner in construction"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Tiling depth ranges from 30 to 45 cm depth", "Tiling depth ranges from 10 to 15 cm depth", "Tiling depth ranges from 20 to 30 cm depth", "Tiling depth ranges from 5 to 8 cm depth"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Increasing disc angle only changes the cutting direction of disc", "Increasing disc angle improves penetration and increases width of cut", "Increasing disc angle has no effect on ploughing width or depth", "Increasing disc angle improves penetration but reduces width of cut"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Working capacity varies from 0.3 to 0.4 ha per day", "Working capacity varies from 0.5 to 0.8 ha per day", "Working capacity varies from 0.1 to 0.2 ha per day", "Working capacity varies from 0.8 to 1.0 ha per day"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Air-cooled, water-cooled and oil-cooled radiator types", "Flat tube, round tube and oval tube radiator types", "Grilled tube, tubular and honey comb or cellular types", "Open jacket, thermo siphon and forced circulation types"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Wheat can be stored in bags for up to 4 years", "Wheat can be stored in bags for up to 5 years", "Wheat can be stored in bags for up to 6 months", "Wheat can be stored in bags for up to 2 years"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Dry land farming with rainfed crops only", "Plantation crops requiring specialised orchard tractors", "Single cropping with poor irrigation water availability", "Multi-crop areas with adequate irrigation facilities"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Hopper, agitator, feed control, fan or blower and delivery nozzle", "Nozzle, pressure gauge, tank, pump and delivery hose components", "Container, filter, spray lance, nozzle and air pump components", "Drum, agitator, fan, motor and discharge tube components"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Disc diameter is 30 cm in animal drawn disc plough", "Disc diameter is 75 cm in animal drawn disc plough", "Disc diameter is 45 cm in animal drawn disc plough", "Disc diameter is 60 cm in animal drawn disc plough"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Silage has moisture of 65 to 70 percent while dry fodder has 12 percent", "Silage has moisture of 50 to 60 percent while dry fodder has 5 percent", "Silage has moisture of 80 to 90 percent while dry fodder has 20 percent", "Silage has moisture of 30 to 40 percent while dry fodder has 10 percent"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["The drag link connects pitman arm to the steering arm", "The king pin connects pitman arm to steering arm directly", "The steering gear connects pitman arm to the steering arm", "The tie rod connects the pitman arm to the steering arm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Rubber roller achieves 60 to 70 percent hulling efficiency range", "Rubber roller achieves 70 to 80 percent hulling efficiency range", "Rubber roller achieves 85 to 90 percent hulling efficiency range", "Rubber roller achieves 95 to 100 percent hulling efficiency range"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Check row planting has uniform row-to-row and plant-to-plant distance in two perpendicular directions", "Check row planting places seeds at fixed spacing only along one row direction", "Check row planting uses continuous seed stream in one direction", "Check row planting requires specialized broadcasting machinery only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Off-set type works faster because all discs work simultaneously", "Off-set type reduces draft requirement for the same width of operation", "Off-set type can handle heavier soil conditions more efficiently", "Off-set type is useful for orchards and travels left or right of tractor"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Specific gravity of HSD oil is about 0.920", "Specific gravity of HSD oil is about 0.827", "Specific gravity of HSD oil is about 0.730", "Specific gravity of HSD oil is about 0.820"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Manual threshing produces 200 to 250 kg of seed per hour", "Manual threshing produces 15 to 20 kg of seed per hour", "Manual threshing produces 50 to 70 kg of seed per hour", "Manual threshing produces 100 to 140 kg of seed per hour"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Spring tooth harrow has tough flexible teeth that work in stony soils", "Spring tooth harrow has wire loop teeth used mainly for paddy", "Spring tooth harrow has diamond cross-section peg shaped teeth", "Spring tooth harrow has rigid teeth that maintain fixed position"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Both produce identical power for the same cylinder volume", "Two-stroke produces about 1.5 times the power of four-stroke", "Four-stroke produces about 1.5 times the power of two-stroke", "Four-stroke produces about twice the power of two-stroke"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Jointer cuts small furrow off main furrow and throws it toward furrow", "Jointer helps maintain uniform ploughing depth across field", "Jointer provides vertical stability against soil side pressure", "Jointer cuts furrow slice vertically from land ahead of plough"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Optimum air temperature for raw paddy is 85 degrees C exactly", "Optimum air temperature for raw paddy is 40 to 50 degrees C", "Optimum air temperature for raw paddy is 100 to 110 degrees C", "Optimum air temperature for raw paddy is 60 to 70 degrees C"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["17.68 crore", "12.68 crore", "22.68 crore", "30 crore"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["8-10 km/h", "25-30 km/h", "3-5 km/h", "15-20 km/h"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["25-32%", "40-50%", "32-38%", "20-25%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Calorific value", "Volatility", "Knock characteristics", "Viscosity"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["weak relief valve spring", "stuck relief valve", "thin oil", "worn oil pump"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["flywheel", "connecting rod", "cylinder head", "crankshaft"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["the main journal", "the gudgeon pin", "the camshaft", "the crank pin"],
    correct: 1,
