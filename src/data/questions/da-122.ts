...
export const da122Questions: Question[] = [
  ...
  },
  {
    ...
    options: ["Speed up conversion of urea to nitrate", "Kill soil microorganisms", "Slow down nitrification, preventing N loss through leaching and denitrification", "Increase alkalinity of soil"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Vigna radiata var. sublobata", "Sesbania aculeata", "Crotalaria juncea", "Tephrosia purpurea"],
    correct: 0,
