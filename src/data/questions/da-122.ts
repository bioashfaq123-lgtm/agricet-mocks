...
export const da122Questions: Question[] = [
  {
    ...
    options: ["Supply adequate nutrients for normal plant growth", "Resist erosion from rainfall and wind", "Produce maximum crop yield under all conditions", "Retain moisture for extended drought periods"],
    correct: 0,
    explanation: "Soil fertility is defined as the ability of soil to supply adequately the nutrients normally taken from the soil by plants."
  },
  {
    id: "d122_002",
    subject: "da-122",
    question: "Which crop removes the highest quantities of NPK to produce 5 tonnes of yield?",
    options: ["Sorghum removing 90-30-90 kg of NPK", "Maize removing 175-35-175 kg of NPK", "Rice removing 85-15-90 kg of NPK", "Wheat removing 120-50-120 kg of NPK"],
    correct: 1,
    explanation: "Maize requires 175-35-175 kg nitrogen, phosphorus and potassium to give 5 tonnes of yield, while rice removes 85-15-90 kg NPK to produce 3 tonnes."
  },
  {
    id: "d122_003",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "The word 'Manure' originated from the French word 'MANOEUVRER' which refers to 'work with soil'."
  },
  {
    id: "d122_004",
    subject: "da-122",
    question: "Guano is a product of excrement from which type of birds?",
    options: ["Forest birds from tropical rainforests", "Fresh water ducks found in river deltas", "Sea birds like Pelicans, Gannets and Albatrosses", "Migratory birds from African grasslands"],
    correct: 2,
    explanation: "Guano is a product of sea birds (Pelican, Gannets and Albatrosses) excrement covered over long periods and occurring in natural deposits along Pacific coast of Peru and Chile."
  },
  {
    id: "d122_005",
    subject: "da-122",
    question: "Which method of FYM preparation is considered the best quality method?",
    options: ["Covered pit method with roofing protection", "Pit method with soil layer additions", "Open heap method under tree shade", "Field windrow method with turnings"],
    correct: 0,
    explanation: "The covered pit method is the best method of all described. The pit has non-absorbent granite stone lining, a 1.5 feet bund, and roofing with Palmyra or phoenix leaves to control organic matter and nutrient losses."
  },
  {
    id: "d122_006",
    subject: "da-122",
    question: "What is the nutrient composition (N-P-K) of good quality FYM stored in covered pit?",
    options: ["1.5% N, 1.0% P and 2.0% K content", "0.68% N, 0.5% P and 1.0% K content", "0.5% N, 0.3% P and 0.8% K content", "0.3% N, 0.2% P and 0.5% K content"],
    correct: 1,
    explanation: "Good quality FYM stored in covered pit contains 0.68% N, 0.5% P and 1% K as stated in the course material."
  },
  {
    id: "d122_007",
    subject: "da-122",
    question: "The word 'Compost' is derived from Latin word 'COMPONERE' meaning:",
    options: ["Convert waste into fertile matter", "Put together different materials", "Decompose under controlled temperature", "Work done with organic substances"],
    correct: 1,
    explanation: "The word compost is derived from the Latin word 'COMPONERE' meaning to put together."
  },
  {
    id: "d122_008",
    subject: "da-122",
    question: "In urban composting, which material is used as a starter?",
    options: ["Sugarcane trash soaked in urine water", "Dung mixed with biogas slurry water", "Bone meal dissolved in acidic solution", "Night soil from nearby human habitations"],
    correct: 3,
    explanation: "In urban composting, night soil is used as the starter material, while rural compost uses cattle dung as the starter."
  },
  {
    id: "d122_009",
    subject: "da-122",
    question: "What is the nitrogen content of biogas slurry compared to FYM?",
    options: ["Biogas slurry has 0.5% N vs 1.5% in FYM", "Both have equal nitrogen content of 1.2%", "FYM has 2.0% N while biogas slurry has 1.0%", "Biogas slurry has 1.5% N vs 0.7% in FYM"],
    correct: 3,
    explanation: "Biogas slurry has higher nitrogen content (1.5%) as against 0.7% found in FYM, making it a better quality manure."
  },
  {
    id: "d122_010",
    subject: "da-122",
    question: "Thermal efficiency of cow dung burnt in properly designed burners is:",
    options: ["Around 11 per cent thermal efficiency", "Equal to burning dry wood directly", "Around 60 per cent thermal efficiency", "Around 30 per cent thermal efficiency"],
    correct: 2,
    explanation: "Thermal efficiency of cow dung burnt in properly designed burners is 60%, compared to 11% when burnt in the usual manner as fuel."
  },
  {
    id: "d122_011",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Eisenia foetida is one of the effective earthworm species used in vermicomposting along with Perionyx excavatus, Eudrilus eugeniae and Lampito marutii."
  },
  {
    id: "d122_012",
    subject: "da-122",
    question: "How many worms per square meter are introduced in vermicompost pits?",
    options: ["500 worms or 0.5 kg per square meter", "1000 worms or 1 kg per square meter", "250 worms or 0.25 kg per square meter", "2000 worms or 2.0 kg per square meter"],
    correct: 1,
    explanation: "Worms are introduced at 1m² = 1000 worms or 1 kg per tonne of residue in vermicompost pits."
  },
  {
    id: "d122_013",
    subject: "da-122",
    question: "Green manuring in situ can be safely adopted for which conditions?",
    options: ["Summer crops under no irrigation availability", "Sandy soils with very low moisture retention", "Hill crops grown under full shade cover", "Dryland crops in high rainfall above 900 mm"],
    correct: 3,
    explanation: "Green manuring can be safely adopted for irrigated crops and also under rainfed conditions when rainfall is above 900 mm."
  },
  {
    id: "d122_014",
    subject: "da-122",
    question: "Sunnhemp (Crotalaria juncea) has which nutrient composition?",
    options: ["3.5% N, 0.3% P and 1.0% K content", "2.3% N, 0.2% P and 1.4% K content", "1.8% N, 0.1% P and 0.3% K content", "3.0% N, 0.1% P and 0.3% K content"],
    correct: 1,
    explanation: "Sunnhemp (Crotalaria juncea) has nutrient composition of 2.3% N, 0.2% P and 1.4% K."
  },
  {
    id: "d122_015",
    subject: "da-122",
    question: "Daincha (Sesbania aculeata) seeds require scarification before sowing because:",
    options: ["Seeds require soaking in warm water overnight", "Seeds are hard coated and germinate slowly", "Seeds are infected with soil-borne pathogens", "Seeds need chemical treatment for viability"],
    correct: 1,
    explanation: "Daincha seeds require scarification (lightly pounding with sand) for easy germination due to their hard seed coat."
  },
  {
    id: "d122_016",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "Green leaf manuring should be done 15-20 days prior to sowing of the main crop."
  },
  {
    id: "d122_017",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "Azolla pinnata is listed as one of the plants used as a source of green leaf manure, along with Gliricidia maculata, Pongamia glabra, Sesbania rostrata, etc."
  },
  {
    id: "d122_018",
    subject: "da-122",
    question: "Which oil cake is referred to as castor pomace and is poisonous to animals?",
    options: ["Cotton seed cake toxic to grazing animals", "Mahua cake unsuitable for cattle feeding", "Castor cake used only as crop fertilizer", "Neem cake with insecticidal bitter properties"],
    correct: 2,
    explanation: "Castor cake (castor pomace) is a by-product of oil extraction from castor beans. It is poisonous to animals and used only as fertilizer. It contains 4.4% N, 1.9% P2O5 and 1.4% K2O."
  },
  {
    id: "d122_019",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Dried blood is 80% as efficient as the inorganic N fertilizer in providing nitrogen to the crop, making it the highest among protein organic manures."
  },
  {
    id: "d122_020",
    subject: "da-122",
    question: "Horn meal is described as a slow acting fertilizer containing which nutrient?",
    options: ["14 per cent nitrogen in horn material", "10 per cent phosphorus in hoof meal", "20 per cent calcium in ground horn", "8 per cent potassium in horn chips"],
    correct: 0,
    explanation: "Horn meal is a slow acting fertilizer of Nitrogen containing 14% N. About 3-4 kg horn and hoof material can be obtained from each animal."
  },
  {
    id: "d122_021",
    subject: "da-122",
    question: "Rhizobium can fix how much nitrogen per hectare in legume root nodules?",
    options: ["Rhizobium fixes 50-100 kg N per hectare", "Rhizobium fixes 5-10 kg N per hectare", "Rhizobium fixes 200-300 kg N per hectare", "Rhizobium fixes 10-25 kg N per hectare"],
    correct: 0,
    explanation: "Rhizobium establishes symbiotic relations with legumes and can fix 50-100 kg N ha⁻¹, meeting nearly 80-90% of nitrogen requirement of the crop."
  },
  {
    id: "d122_022",
    subject: "da-122",
    question: "Azolla is associated with rice fields due to its symbiosis with which organism?",
    options: ["Azotobacter living freely on Azolla leaves", "Rhizobium bacteria in leaf tissue cavities", "Anabaena azollae blue green algae species", "Pseudomonas present in root epidermal cells"],
    correct: 2,
    explanation: "Azolla pinnata has symbiotic association with Anabaena azollae (BGA) in the epidermal cavity of the lower side of the leaf. This Azolla-Anabaena complex fixes atmospheric nitrogen."
  },
  {
    id: "d122_023",
    subject: "da-122",
    question: "Azospirillum is classified as which type of nitrogen-fixing biofertilizer?",
    options: ["Symbiotic nitrogen fixer in root nodules", "Associative nitrogen fixer with plants", "Phosphate-solubilizing bacteria in soil", "Free-living nitrogen fixer without plants"],
    correct: 1,
    explanation: "Azospirillum is an associative nitrogen-fixing organism — it lives in association with plants but without mutual benefit or interdependency."
  },
  {
    id: "d122_024",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "By application of Azotobacter to various crops, the amount of recommended doses of nitrogenous fertilizers can be reduced by 10-20%."
  },
  {
    id: "d122_025",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "Nitrogen fixation by BGA has been estimated to be 25-30 kg N/ha in paddy rice ecosystems."
  },
  {
    id: "d122_026",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "VAM fungi enhance the nutrient uptake of P, Zn and S and also enhance water uptake under drought conditions."
  },
  {
    id: "d122_027",
    subject: "da-122",
    ...
    correct: 2,
    explanation: "Nitrate nitrogen carries a negative charge, is not adsorbed onto soil particles and is subject to leaching and volatilization losses. Hence nitrate fertilizers are not recommended for irrigated paddy."
  },
  {
    id: "d122_028",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "Ammonium sulphate contains 21% N and 24% S. To neutralize its acidity, 110 kg of calcium carbonate is needed per 100 kg of ammonium sulphate."
  },
  {
    id: "d122_029",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "Urea should be applied under optimum soil moisture (field capacity) conditions only. On application in wetlands, N is lost through leaching; in dry soils it is lost through volatilization."
  },
  {
    id: "d122_030",
    subject: "da-122",
    question: "Which potassic fertilizer is NOT suitable for potato, tobacco and grapes?",
    options: ["Sulphate of potash having 50% potassium", "Potassium phosphate used for foliar spray", "Potassium nitrate having 39% potassium", "Muriate of potash containing 60% potassium"],
    correct: 3,
    explanation: "Muriate of potash (KCl) is useful for all crops except potato, tobacco and grapes. Sulphate of potash is applied to these crops."
  },
  {
    id: "d122_031",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "SSP contains 16% P2O5, 21% calcium and 12% sulphur, making it a preferred source for oilseed crops like groundnut that require sulphur."
  },
  {
    id: "d122_032",
    subject: "da-122",
    question: "Rock phosphate is suitable as fertilizer mainly in which soil conditions?",
    options: ["Waterlogged alkaline soils with high calcium", "Neutral pH soils with good drainage facilities", "Sandy loam soils with low organic matter", "Strongly acidic soils or high rainfall areas"],
    correct: 3,
    explanation: "Rock phosphate is water and citrate insoluble. It is soluble in strongly acidic soils or organic soils, and is used in tea and coffee gardens and high rainfall mountain areas."
  },
  {
    id: "d122_033",
    subject: "da-122",
    question: "The Fertilizer Control Order (FCO) was originally passed on which date?",
    options: ["1st January 1961 under Interstate Trade Act", "15th August 1950 under Indian Agriculture Act", "28th April 1957 under Essential Commodities Act", "26th January 1960 under Fertilizer Movement Act"],
    correct: 2,
    explanation: "The Fertilizer Control Order (FCO) was passed on 28th April 1957 in exercise of the power conferred by Section III of the Essential Commodities Act of 1955, effective from May 18th 1957."
  },
  {
    id: "d122_034",
    subject: "da-122",
    ...
    correct: 2,
    explanation: "As per FCO 1957, urea must have total nitrogen minimum 44% per cent by weight. The biuret content must be maximum 1.50%."
  },
  {
    id: "d122_035",
    subject: "da-122",
    question: "INM is defined as maintenance of soil fertility through optimization of benefits from:",
    options: ["Organic, inorganic and biological components together", "All possible chemical fertilizer combinations only", "Organic manures and biofertilizers excluding chemicals", "Soil testing and site-specific nutrient management only"],
    correct: 0,
    explanation: "INM refers to maintenance of soil fertility and plant nutrient supply through optimization of benefits from all possible sources of organic, inorganic and biological components in an integrated manner."
  },
  {
    id: "d122_036",
    subject: "da-122",
    question: "Rhizobium meliloti is specifically associated with which crop?",
    options: ["Soybean as host legume species", "Cowpea as the preferred legume host", "Black gram as symbiotic host crop", "Berseem as the specific host legume"],
    correct: 3,
    explanation: "Rhizobium meliloti is specifically associated with Berseem. Each Rhizobium species shows host specificity to its particular legume crop."
  },
  {
    id: "d122_037",
    subject: "da-122",
    question: "What is the vermicompost application rate recommended for fruit crops?",
    options: ["1 tonne per hectare for all fruit crops", "5-10 kg per tree for fruit crops", "200 grams per pot for fruit trees", "50 kg per plant for large orchards"],
    correct: 1,
    explanation: "For fruit crops, 5-10 kg/tree of vermicompost is recommended. For field crops the rate is 1 t/ha and for flowering plants in pots, 200g/pot."
  },
  {
    id: "d122_038",
    subject: "da-122",
    question: "Compost with commercially accepted standards must have C:N ratio of:",
    options: ["More than 50 wide C:N ratio", "Between 30-50 moderate C:N ratio", "Exactly 25 fixed C:N ratio", "Less than 20 narrow C:N ratio"],
    correct: 3,
    explanation: "Commercially accepted compost must have C:N ratio less than 20. Other properties include nitrogen >2%, color brown-black, moisture 10-20% and CEC 75-100 meq/100g."
  },
  {
    id: "d122_039",
    subject: "da-122",
    question: "Pillipesara (Phaseolus trilobus) is described as a triple purpose crop because:",
    options: ["It gives vegetables, seeds and oil cakes", "It provides grain, fodder and green manure", "It produces fiber, fodder and green manure", "It supplies wood, leaf and root products"],
    correct: 1,
    explanation: "Pillipesara is a regular green manure, minor pulse crop and fodder crop — hence it is a triple purpose crop. It has good ratooning capacity."
  },
  {
    id: "d122_040",
    subject: "da-122",
    question: "Deep placement of nitrogenous fertilizers in paddy fields is done to:",
    options: ["Improve surface drainage of paddy fields", "Reduce the cost of fertilizer application", "Speed up nitrogen release to soil surface", "Place ammoniacal N in soil reduction zone"],
    correct: 3,
    explanation: "Deep placement places ammoniacal nitrogenous fertilizers in the reduction zone of soil in paddy fields, where ammoniacal nitrogen remains available to the crop and prevents nutrient loss by run-off."
  },
  {
    id: "d122_041",
    subject: "da-122",
    ...
    correct: 2,
    explanation: "Chemical fertilizers are quick acting, have high analytical value, definite chemical composition and supply one or very few plant nutrients, but do NOT improve physical properties of soils."
  },
  {
    id: "d122_042",
    subject: "da-122",
    question: "What is the minimum distance for urban composting from residential areas?",
    options: ["1.5 kilometers from residential townships", "3 kilometers from the nearest settlement", "5 kilometers from the nearest habitation", "500 meters from the residential township"],
    correct: 0,
    explanation: "Urban composting is taken up at least 1.5 km away from the residential areas/townships to prevent nuisance and health hazards."
  },
  {
    id: "d122_043",
    subject: "da-122",
    question: "Ammonium chloride application results in loss of calcium from soil because:",
    options: ["Ammonium acidifies soil causing calcium fixation", "Chlorine forms soluble CaCl2 which leaches out", "Calcium is replaced by ammonium on exchange sites", "Chlorine ions directly dissolve calcium particles"],
    correct: 1,
    explanation: "When ammonium chloride dissociates, chlorine combines with calcium to form calcium chloride which is highly soluble and lost due to leaching, resulting in loss of calcium."
  },
  {
    id: "d122_044",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Calcium ammonium nitrate is highly hygroscopic in nature, hence it must be stored in specialized polythene bags to prevent moisture absorption."
  },
  {
    id: "d122_045",
    subject: "da-122",
    question: "What nitrogen percentage does Calcium Cyanamide contain?",
    options: ["Calcium cyanamide contains 16% nitrogen", "Calcium cyanamide contains 35% nitrogen", "Calcium cyanamide contains 46% nitrogen", "Calcium cyanamide contains 21% nitrogen"],
    correct: 3,
    explanation: "Calcium cyanamide contains 21% N (amide form). Urea contains 46% N and is the most popular amide form fertilizer."
  },
  {
    id: "d122_046",
    subject: "da-122",
    question: "In which soil type does boron availability increase while getting fixed in finer soils?",
    options: ["Alkaline soils with high calcium carbonate content", "Heavy clay soils with montmorillonite minerals", "Waterlogged soils with low oxygen availability", "Coarse textured soils have more boron availability"],
    correct: 3,
    explanation: "Boron availability is more in coarse textured soils and in finer textured soils it gets fixed and becomes unavailable to plants."
  },
  {
    id: "d122_047",
    subject: "da-122",
    question: "Organic farming as defined by FAO is a holistic system that promotes:",
    options: ["Agro-ecosystem health including biodiversity and biological cycles", "Complete elimination of all synthetic compounds", "Maximum crop yield using all available inputs", "Traditional farming with only bullock-drawn implements"],
    correct: 0,
    explanation: "FAO defines organic agriculture as 'a holistic production management system which promotes and enhances agro-ecosystem's health, including biodiversity, biological cycles, and soil biological activity.'"
  },
  {
    id: "d122_048",
    subject: "da-122",
    ...
    correct: 2,
    explanation: "The green manure crop should be incorporated at the stage of 50% flowering when it is tender. Delay in incorporation will affect decomposition."
  },
  {
    id: "d122_049",
    subject: "da-122",
    question: "What percentage of nitrogen in the atmosphere exists in gaseous form?",
    options: ["Nearly 90 per cent of atmospheric nitrogen", "Nearly 78 per cent of atmospheric nitrogen", "Nearly 21 per cent of atmospheric nitrogen", "Nearly 50 per cent of atmospheric nitrogen"],
    correct: 1,
    explanation: "Atmosphere contains nearly 78% of nitrogen in gaseous form, which is 1.5 times higher than the N content present in urea."
  },
  {
    id: "d122_050",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "Pellet application refers to placement of nitrogenous fertilizer in the form of pellets 2.5 to 5 cm deep between the rows of the paddy crop, mixed with soil in 1:10 ratio."
  },
  {
    id: "d122_051",
    subject: "da-122",
    question: "What is the main objective of adding conditioners to mixed fertilizers?",
    options: ["To reduce crystal knitting and prevent caking", "To improve shelf life and reduce degradation", "To balance pH for acidic or alkaline soils", "To increase the nutrient content per kilogram"],
    correct: 0,
    explanation: "Conditioners are added to non-granular or granular mixtures to improve physical condition and decrease caking. The actual purpose is to reduce crystal knitting. Examples include sand and silica."
  },
  {
    id: "d122_052",
    subject: "da-122",
    question: "In INM, reduced investment in chemical fertilizers can be up to:",
    options: ["10 per cent reduction in fertilizer investment", "70 per cent reduction in fertilizer investment", "30 per cent reduction in fertilizer investment", "50 per cent reduction in fertilizer investment"],
    correct: 2,
    explanation: "One of the advantages of INM is reduced investment in chemical fertilizers up to 30 per cent, along with reduced soil and ground water pollution."
  },
  {
    id: "d122_053",
    subject: "da-122",
    question: "Wild indigo (Tephrosia purpurea) is best suited for which soil conditions?",
    options: ["Rich alluvial soils along river flood plains", "Black cotton soils with high clay content", "Waterlogged paddy soils in coastal areas", "Hard coarse gravelly textured and poor soils"],
    correct: 3,
    explanation: "Wild indigo (Tephrosia purpurea) is suited for hard coarse gravelly textured soils and poor soils. It is also used as a green leaf manure and is a self-grown crop when sown once."
  },
  {
    id: "d122_054",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "DAP (Di Ammonium Phosphate) has the grade 18:46 containing 18% N and 46% P2O5, while MAP has 11:46 grade."
  },
  {
    id: "d122_055",
    subject: "da-122",
    ...
    correct: 2,
    explanation: "In SCU, as long as urea remains coated with sulphur without rupture, it does not dissolve. When added to soil, the sulphur coating ruptures by microbial action and soil water slowly penetrates and dissolves the urea."
  },
  {
    id: "d122_056",
    subject: "da-122",
    question: "Phosphate solubilizing bacteria solubilize insoluble phosphates by secreting:",
    options: ["Organic acids like acetic and propionic acids", "Nitrogenase enzyme that reduces phosphate ions", "Enzymes like phosphatase and phytase proteins", "Growth hormones like gibberellic acid and IAA"],
    correct: 0,
    explanation: "Phosphate solubilizing bacteria (Pseudomonas and Bacillus) secrete organic acids such as acetic acid, propionic acid etc. These acids lower the pH and dissolve bound phosphate forms."
  },
  {
    id: "d122_057",
    subject: "da-122",
    question: "Horse gram (Dolichus biflorus) is suitable as green manure for which soils?",
    options: ["Poor and hard soils with drought tolerance", "Rich alluvial soils with good moisture availability", "Sandy loam soils with high permeability", "Waterlogged heavy black cotton clay soils"],
    correct: 0,
    explanation: "Horse gram is suitable as green manure for poor and hard soils. It can also withstand drought. Seed rate is 35 kg/ha and green matter yield is 3.5 tonnes/ha."
  },
  {
    id: "d122_058",
    subject: "da-122",
    question: "What is the N content range of guano organic manure?",
    options: ["12% nitrogen and 1.5% phosphorus content", "4-10% nitrogen and 3-9% phosphorus", "1-4% nitrogen and 10-25% phosphorus", "8-15% nitrogen and 2.3% phosphorus"],
    correct: 3,
    explanation: "Guano contains 8-15% nitrogen, 2.3% phosphorus and 2.4% potassium. The name Guano originated from Peru from the word 'HAUNO' meaning manure."
  },
  {
    id: "d122_059",
    subject: "da-122",
    question: "1000 earthworms weighing about 1 kg can convert how much waste per day?",
    options: ["1000 earthworms convert 10 kg waste daily", "1000 earthworms convert 20 kg waste daily", "1000 earthworms convert 1 kg waste daily", "1000 earthworms convert 5 kg waste daily"],
    correct: 3,
    explanation: "1000 earthworms may convert 5 kg waste material per day. 1000 worms weighs about one kilogram."
  },
  {
    id: "d122_060",
    subject: "da-122",
    question: "Complete complex fertilizers contain how many primary nutrients in combination?",
    options: ["Only one primary nutrient in large quantity", "All three primary nutrients N, P and K combined", "Two primary nutrients like N and P combined", "Four nutrients including calcium along with NPK"],
    correct: 1,
    explanation: "Complete complex fertilizers contain all three major nutrients N, P and K in chemical combination. Examples include 14:28:14, 17:17:17 and 19:19:19."
  },
  {
    id: "d122_061",
    subject: "da-122",
    question: "Vermicompost turnover percentage from total material accommodated in pit is:",
    options: ["The turnover rate of vermicompost is 75%", "The turnover rate of vermicompost is 90%", "The turnover rate of vermicompost is 60%", "The turnover rate of vermicompost is 50%"],
    correct: 0,
    explanation: "The turnover of vermicompost is 75%. If 1000 kg material is accommodated in the pit, the output will be 750 kg of vermicompost."
  },
  {
    id: "d122_062",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "Groundnut cake is an edible oil cake containing 6.5% N, 1.3% P and 1.5% K. It is suitable for cattle and poultry feeding as well as crop fertilization."
  },
  {
    id: "d122_063",
    subject: "da-122",
    question: "Bone meal is particularly useful for soils high in Fe and Al because:",
    options: ["Bone meal absorbs toxic aluminium from soil", "Bone meal alkalizes acidic soil pH effectively", "Bone meal directly chelates excess iron ions", "Bone P dissolves better in acidic soil conditions"],
    correct: 3,
    explanation: "Bone meal is a good P-fertilizer that is particularly useful for soils high in Fe and Al content (acid soils). It can be used for all crops without fear of salt damage unlike chemical fertilizers."
  },
  {
    id: "d122_064",
    subject: "da-122",
    question: "Sodium nitrate contains which percentage of nitrogen as a nitrate fertilizer?",
    options: ["Sodium nitrate contains 26% nitrogen content", "Sodium nitrate contains 21% nitrogen content", "Sodium nitrate contains 33% nitrogen content", "Sodium nitrate contains 16% nitrogen content"],
    correct: 3,
    explanation: "Sodium nitrate (NaNO3) contains 16% N. Calcium nitrate also contains 16% N. Both are nitrate form fertilizers that readily dissociate in soil solution."
  },
  {
    id: "d122_065",
    subject: "da-122",
    question: "Mixing ammonium sulphate with basic slag is prohibited because:",
    options: ["They form toxic compounds harmful to plants", "Both are hygroscopic and absorb excess moisture", "Combined nitrogen content becomes too high", "Acidic fertilizer reacts with alkaline material"],
    correct: 3,
    explanation: "Acidic natured fertilizers should not be mixed with alkaline natured fertilizers. Ammonium sulphate is acidic while basic slag is alkaline, and mixing causes chemical reactions."
  },
  {
    id: "d122_066",
    subject: "da-122",
    question: "The Fertilizer Movement Order (FMO) was passed on which date to regulate interstate movement?",
    options: ["28th April 1957 same as FCO date", "31st December 1960 effective from 1-1-1961", "25th September 1985 as FCO revision date", "15th August 1950 effective from 1951"],
    correct: 1,
    explanation: "The Fertilizer Movement Order (FMO) was passed on 31st December 1960 to regulate interstate movement of fertilizers and came into force from 1-1-1961."
  },
  {
    id: "d122_067",
    subject: "da-122",
    question: "BGA is applied how many days after transplanting of rice crop?",
    options: ["BGA applied 10 days after rice transplanting", "BGA applied 5 days after rice transplanting", "BGA applied 30 days after rice transplanting", "BGA applied 20 days after rice transplanting"],
    correct: 0,
    explanation: "BGA is applied at 10 kg/ha flakes, applied 10 days after the transplanting of rice crop."
  },
  {
    id: "d122_068",
    subject: "da-122",
    question: "Monocropping of the same crop leads to nutrient depletion because:",
    options: ["The same crop produces allelopathic compounds in soil", "Monocropping prevents rainfall reaching the soil surface", "The same depth of soil is mined repeatedly for nutrients", "The same crop attracts pests reducing soil organic matter"],
    correct: 2,
    explanation: "Monocropping of the same crop without crop rotation mines nutrients from the same depth in the soil leading to nutrient depletion. Deep rooted crops should be rotated with surface-rooted crops."
  },
  {
    id: "d122_069",
    subject: "da-122",
    question: "The favourable temperature range for earthworm activity in vermicompost pits is:",
    options: ["18°C to 35°C moderate temperature range", "35°C to 45°C warm temperature range", "40°C to 55°C thermophilic temperature range", "5°C to 15°C cold temperature range"],
    correct: 0,
    explanation: "Favourable temperature for earthworms in composting material is 18°C to 35°C. pH range should be 6.5-7.5 and moisture should be 60-70%."
  },
  {
    id: "d122_070",
    subject: "da-122",
    question: "Poultry manure contains which NPK percentage composition?",
    options: ["3.0% N, 2.0% P and 2.0% K nutrients", "0.7% N, 0.3% P and 0.7% K nutrients", "1.4% N, 1.0% P and 1.4% K nutrients", "0.5% N, 0.4% P and 0.5% K nutrients"],
    correct: 0,
    explanation: "Poultry manure contains 3.0% N, 2.0% P and 2.0% K — making it richer in nutrients than FYM (0.5-1.5% N) and sheep manure."
  },
  {
    id: "d122_071",
    subject: "da-122",
    ...
    correct: 1,
    explanation: "Vermicompost contains 1.5 to 2.10% total nitrogen, 1.0 to 1.50% total phosphorus, and 0.60-0.80% total potassium."
  },
  {
    id: "d122_072",
    subject: "da-122",
    question: "What is the ratio of dung and water used in mixing tank of a biogas plant?",
    options: ["Dung and water mixed in 4:5 ratio", "Dung and water mixed in 2:3 ratio", "Dung and water mixed in 1:1 ratio", "Dung and water mixed in 1:4 ratio"],
    correct: 0,
    explanation: "In the mixing tank adjacent to the digester, dung and water are mixed in 4:5 ratio. The mixed slurry is then passed into the digester through a cement pipe."
  },
  {
    id: "d122_073",
    subject: "da-122",
    ...
    correct: 2,
    explanation: "Biofertilizers can add 20-200 kg N ha⁻¹ (by fixation) under optimum conditions. They can also solubilize/mobilize 30-50 kg P2O5 ha⁻¹."
  },
  {
    id: "d122_074",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Broadcasting is suitable for crops with dense stand where plant roots permeate the whole volume of soil, when large doses of fertilizers are applied, and for insoluble phosphatic fertilizers."
  },
  {
    id: "d122_075",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Urea can be used for foliar spray at 2% concentration (20g/l). Higher or excess concentration results in scorching and defoliation. Biuret content should be below 1.5% for foliar spray."
  },
  {
    id: "d122_076",
    subject: "da-122",
    question: "The Indore process is one of the systems of which type of composting?",
    options: ["Vermicomposting using earthworm technology", "Rural compost prepared by individual farmers", "Urban composting done by local bodies", "In situ green manure incorporation method"],
    correct: 2,
    explanation: "The Indore process, along with ADCO process, Activated compost process, Bangalore process and Coimbatore process, are different systems of urban composting."
  },
  {
    id: "d122_077",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Normally the distance between gas plant and place where gas is to be used should be within 20 meters (Kitchen to gas plant)."
  },
  {
    id: "d122_078",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Non-edible oil cakes (Castor, Neem, Mahua, Cotton seed, Mustard, Safflower) are suitable only for crop fertilization as they are non-palatable, poisonous or bitter for animals."
  },
  {
    id: "d122_079",
    subject: "da-122",
    question: "Fertile soil in arid regions may not be productive because productivity depends on:",
    options: ["Multiple factors including water and climate", "Soil nutrient supply capacity alone matters", "Organic matter content of topsoil layer", "Root depth of crops grown in that region"],
    correct: 0,
    explanation: "Soils in arid regions may be fertile but not productive because productivity depends on multiple factors including air, heat, light, mechanical support, soil fertility and especially water — not just nutrient supply."
  },
  {
    id: "d122_080",
    subject: "da-122",
    question: "Safflower cake has the highest nitrogen content among oil cakes at:",
    options: ["6.9 per cent nitrogen in safflower cake", "4.8 per cent nitrogen in safflower cake", "7.9 per cent nitrogen in safflower cake", "5.2 per cent nitrogen in safflower cake"],
    correct: 2,
    explanation: "Safflower cake (decorticated) has the highest nitrogen content among oil cakes at 7.9% N, 2.2% P and 1.9% K."
  },
  {
    id: "d122_081",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "Side dressing refers to spread of fertilizer in between the rows and around the plants. It is used for placement of nitrogenous fertilizers in crops like maize, sugarcane and cotton."
  },
  {
    id: "d122_082",
    subject: "da-122",
    question: "What is the recommended rate of BGA application per hectare for rice crop?",
    options: ["1 kg per hectare of BGA flakes applied", "5 kg per hectare of BGA flakes applied", "25 kg per hectare of BGA flakes applied", "10 kg per hectare of BGA flakes applied"],
    correct: 3,
    explanation: "Application of 10 kg/ha flakes of BGA is recommended, applied 10 days after the transplanting of rice crop."
  },
  {
    id: "d122_083",
    subject: "da-122",
    question: "Nitrification inhibitors primarily inhibit which bacterial activity in soil?",
    options: ["Nitrobacter bacteria oxidizing nitrite to nitrate", "Nitrosomonas bacteria oxidizing ammonium to nitrite", "Clostridium bacteria converting organic nitrogen compounds", "Azotobacter bacteria fixing atmospheric nitrogen"],
    correct: 1,
    explanation: "Most nitrification inhibitors inhibit activity of Nitrosomonas bacteria that oxidizes ammonium to nitrite. Some inhibitors inhibit Nitrobactor bacteria that oxidizes nitrite to nitrate."
  },
  {
    id: "d122_084",
    subject: "da-122",
    question: "In covered pit method of FYM preparation, application of which fertilizer improves quality?",
    options: ["Ammonium sulphate to enrich nitrogen content", "Single super phosphate applied to the pit", "Urea applied at the rate of 1% by weight", "Muriate of potash to improve potassium content"],
    correct: 1,
    explanation: "Application of single super phosphate (SSP) to the covered pit will improve the quality of FYM manure by providing additional phosphorus to the composting material."
  },
  {
    id: "d122_085",
    subject: "da-122",
    question: "What is the recommended dose of Azotobacter biofertilizer per hectare?",
    options: ["5-8 packets of Azotobacter per hectare", "10-15 packets of Azotobacter per hectare", "2-3 packets of Azotobacter per hectare", "1 packet of Azotobacter per hectare"],
    correct: 2,
    explanation: "The recommended dose of Azotobacter is 2-3 packets per hectare. It can be applied by seed inoculation, seedling inoculation or by broadcasting after mixing with FYM."
  },
  {
    id: "d122_086",
    subject: "da-122",
    question: "Which chelating agent is known as Ethylene Diamine Tetra Acetic Acid?",
    options: ["EDTA is Ethylene Diamine Tetra Acetic Acid", "HEDTA is Ethylene Diamine Tetra Acetic Acid", "DTPA is Ethylene Diamine Tetra Acetic Acid", "EDDHA is Ethylene Diamine Tetra Acetic Acid"],
    correct: 0,
    explanation: "EDTA stands for Ethylene Diamine Tetra Acetic Acid. Other chelating agents include HEDTA, EDDHA, NTA (Nitrilo Tri Acetic Acid) and DTPA (Diethylene Triamine Penta Acetic Acid)."
  },
  {
    id: "d122_087",
    subject: "da-122",
    question: "Urban compost is prepared by which institutions using street sweepings?",
    options: ["Private companies collecting kitchen food wastes", "Agricultural universities using experimental wastes", "Individual farmers using farm organic wastes", "Local bodies and municipalities using municipal waste"],
    correct: 3,
    explanation: "Urban compost is prepared by local bodies, municipalities, corporations etc. with their output of street sweepings, municipal rubbish etc. as organic matter using night soil as starter."
  },
  {
    id: "d122_088",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "Phosphorus fertilizers (water soluble) should be placed 2-5 cm below the soil and 5-6 cm away from the seeds to ensure maximum availability to plants."
  },
  {
    id: "d122_089",
    subject: "da-122",
    question: "Ferrous sulphate (FeSO4.7H2O) contains which percentage of iron?",
    options: ["Ferrous sulphate contains 5% iron content", "Ferrous sulphate contains 35% iron content", "Ferrous sulphate contains 20% iron content", "Ferrous sulphate contains 10% iron content"],
    correct: 2,
    explanation: "Ferrous sulphate (FeSO4.7H2O) contains 20% iron. Fe-EDTA chelate contains 5% Fe and Fe-EDDHA chelate contains 6% Fe."
  },
  {
    id: "d122_090",
    subject: "da-122",
    question: "Zinc sulphate should be applied at what rate for deficiency correction in soil?",
    options: ["1-5 kg ZnSO4 per hectare at last ploughing", "50-100 kg ZnSO4 per hectare in soil", "0.5-1 kg ZnSO4 per hectare at transplanting", "10-50 kg ZnSO4 per hectare at last ploughing"],
    correct: 3,
    explanation: "Zinc sulphate at the rate of 10-50 kg/ha should be applied at the last ploughing before sowing or transplanting for zinc deficiency correction."
  },
  {
    id: "d122_091",
    subject: "da-122",
    question: "Which organic manure has the highest nitrogen content among blood meal and others?",
    options: ["Horn meal with 14% nitrogen content", "Fish meal with 4-10% nitrogen content", "Guano with 8-15% nitrogen content", "Blood meal with 12% nitrogen content"],
    correct: 3,
    explanation: "Blood meal (dried blood) has the highest nitrogen content at 12% N among concentrated animal origin manures (excluding horn meal), and is 80% as efficient as inorganic N fertilizers."
  },
  {
    id: "d122_092",
    subject: "da-122",
    question: "Application of lime to problematic acidic soils is recommended because:",
    options: ["Lime provides calcium and magnesium nutrients directly", "Lime increases soil pH to improve nutrient availability", "Lime improves soil structure by increasing clay content", "Lime kills soil-borne pathogens causing root diseases"],
    correct: 1,
    explanation: "For acidic soils lime should be applied and for basic or alkaline soils gypsum should be applied. Lime neutralizes soil acidity and improves pH to optimum range for nutrient availability."
  },
  {
    id: "d122_093",
    subject: "da-122",
    ...
    correct: 3,
    explanation: "For groundnut, slurry of peat based inoculant in seed furrows is recommended because the groundnut seeds are fragile. For other legumes, seed coat inoculation is the most common method."
  },
  {
    id: "d122_094",
    subject: "da-122",
    ...
    correct: 0,
    explanation: "Azolla has large biomass and high N content (4-6% N) and is recommended as green manure for submerged rice fields within maximum temperature of 38°C. Yield increase is 15-20%."
  },
  {
    id: "d122_095",
    subject: "da-122",
    question: "When applying urea to improve use efficiency, it should be mixed with soil in ratio:",
    options: ["One part urea and 50-100 parts moist soil", "One part urea and 20-25 parts moist soil", "One part urea and 5-10 parts moist soil", "One part urea and 1-2 parts moist soil"],
    correct: 2,
    explanation: "To prevent nitrogen loss, one part of urea and 5-10 parts of soft moist soil are mixed properly and incubated for 20-25 hours before application. This method improves nitrogen use efficiency."
  },
  {
    id: "d122_096",
    subject: "da-122",
    question: "What is the grade of MAP (Mono Ammonium Phosphate) complex fertilizer?",
    options: ["MAP has 11-46 grade N and P2O5", "MAP has 20-20 grade N and P2O5", "MAP has 18-46 grade N and P2O5", "MAP has 16-20 grade N and P2O5"],
    correct: 0,
    explanation: "MAP (Mono Ammonium Phosphate) has 11:46 grade, while DAP (Di Ammonium Phosphate) has 18:46 grade. Both are incomplete complex fertilizers."
  },
  {
    id: "d122_097",
    subject: "da-122",
    question: "Rural compost pit dimensions are typically described as which standard size?",
    options: ["Rural compost pit is 20 x 10 x 3 feet size", "Rural compost pit is 6 x 6 x 4 feet standard", "Rural compost pit is 12 x 50 x 6 feet size", "Rural compost pit is 8 x 4 x 4 feet size"],
    correct: 2,
    explanation: "Rural compost can be done in a pit size of 12 x 50 x 6 feet located on an elevated place. Length and width are adjustable but these are the standard dimensions."
  },
  {
    id: "d122_098",
    subject: "da-122",
    question: "Soil productivity is considered as an economic concept that depends on:",
    options: ["Soil texture and depth as the main factors", "Multiple factors including air, heat, light and water", "Organic matter content and microbial population", "Soil fertility alone as the primary determinant"],
    correct: 1,
    explanation: "Soil productivity is an economic concept and not just a property of soil. It depends on all external factors that control plant growth like air, heat (temperature), light, mechanical support, soil fertility and water."
  },
  {
    id: "d122_099",
    subject: "da-122",
    question: "The FCO was revised in which year with effect from 25-9-1985?",
    options: ["FCO was revised in 1975 to control adulteration", "FCO was revised in 2000 for complex fertilizers", "FCO was revised in 1990 to add new fertilizers", "FCO was revised in 1985 for updated standards"],
    correct: 3,
    explanation: "The Fertilizer Control Order (FCO) originally passed in 1957 was revised in 1985 with effect from 25-9-1985. The Government of India has delegated powers to state governments to implement the order."
  },
  {
    id: "d122_100",
    subject: "da-122",
    question: "Daincha (Sesbania speciosa) is preferred for correction of sodic soils because:",
    options: ["It has very high nitrogen fixation capacity", "It is less woody, less fibrous with heavy foliage", "It grows fast and produces maximum biomass", "It is deep rooted improving soil drainage heavily"],
    correct: 1,
    explanation: "Sesbania speciosa corrects sodic soils because it is less woody and less fibrous, gives heavy foliage and is easily decomposable. It is an erect growing deep-rooted crop useful to improve drainage in heavy soils."
  },
  {
    id: "d122x_001",
    subject: "da-122",
    ...
    options: ["Air for plant growth only in crop production", "Proper nutrients in proper amounts and balance for plant growth", "Water for plant growth only", "Only physical support to plants"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Rich in micronutrients", "High in pH", "A productive soil", "Poor in texture"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Work with soil", "Animal excreta", "To fertilise crops", "To dig"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Both manures and fertilizers are quick acting", "Manures are bulky, fertilizers are non-bulky", "Manures improve physical properties, fertilizers generally do not", "Manures are organic, fertilizers are inorganic"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Chemical treatment of organic waste", "Storing organic waste without decomposition", "Biological decomposition of organic materials under controlled conditions", "Burning organic waste"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Municipal garbage only", "Only animal excreta", "Agricultural waste, crop residues, weeds, and farmyard waste", "Industrial waste"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Nitrogen", "Methane (CH4)", "Hydrogen", "Carbon dioxide"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lumbricus terrestris", "Pheretima posthuma", "Aporrectodea caliginosa", "Eisenia fetida (Red wriggler)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1.5-3.5%", "5-7%", "8-10%", "0.5-0.8%"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Gliricidia", "Dhaincha (Sesbania)", "Crotalaria", "Pillipesara"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Neem cake, castor cake", "Cotton cake, sunflower cake", "Mahua cake", "Mustard cake, linseed cake, groundnut cake, coconut cake"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["N and K", "K and Ca", "N and P", "P and Ca"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Produce organic matter", "Control weeds", "Fix nitrogen and mobilise phosphorus", "Improve soil texture"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Associative", "Obligate", "Free-living", "Symbiotic"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Slow release fertilizer", "Ammonical fertilizer", "Amide fertilizer", "Nitrate fertilizer"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["28-30%", "46-48%", "16-18%", "10-12%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["46-48%", "16-18%", "28-32%", "38-44%"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Ammonium nitrate", "Gypsum (CaSO4)", "Muriate of potash", "Urea"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Manganese deficiency", "Zinc deficiency", "Boron deficiency", "Iron deficiency"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["11-52-0 (N-P-K)", "17-17-17 (N-P-K)", "18-46-0 (N-P-K)", "20-20-0 (N-P-K)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["17% N, 17% P2O5, 17% K2O", "17 kg each of N, P, K per bag", "17 tons per hectare", "17% organic matter"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Alkaline soils (high pH) with high temperature", "Flooded paddy fields with low temperature", "Acidic soils with rain", "Aerobic sandy soils"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Spreading fertilizer uniformly over the soil surface", "Spraying liquid fertilizer on leaves", "Applying fertilizer in bands near seeds", "Placing fertilizer in holes near plant base"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Use of chemical fertilizers only", "Application of only organic manures", "Combined use of organic manures, biofertilizers and chemical fertilizers for sustainable crop production", "Use of only biofertilizers"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Chloride-sensitive crops like fruits, vegetables, and tobacco", "Pulses and oilseeds", "Paddy and wheat", "Sugarcane"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Green manures", "Synthetic chemical pesticides and fertilizers", "Compost and vermicompost", "Biofertilizers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Crop residues", "Droppings (excreta) of sea birds/bats", "Blood of slaughtered animals", "Fish waste"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Free-living N fixers", "Phosphate solubilizers", "Symbiotic N fixers", "Phosphate absorbers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Foliar application of fertilizer", "Broadcasting fertilizer", "Application of fertilizer through irrigation water", "Deep placement of fertilizer"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Soil is well supplied with nutrients", "Seeds are being treated", "Quick correction of nutrient deficiency is needed or soil application is not effective", "Crop is at harvest stage"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Zinc and Sulphur", "Calcium and Sulphur", "Iron and Sulphur", "Magnesium and Sulphur"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Mechanical mixing (blending) of individual fertilizers on the farm", "Chemical reaction of individual fertilizer components", "Manufacturing in factories only", "Using ore minerals directly"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Dry conditions", "Partially aerobic conditions", "Anaerobic conditions", "Aerobic conditions"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["40-50%", "20-30%", "60-70%", "80-90%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Two or more plant nutrients", "Only one plant nutrient element", "All three major nutrients (NPK)", "Organic matter along with nutrients"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["18-46-0 (DAP)", "10-26-26", "28-28-0", "17-17-17"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Soil type", "Wind speed", "Altitude", "Moisture content and temperature of the composting mass"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Municipal waste", "Human habitation waste", "Animal origin manures", "Plant origin manures"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A-4-i,  B-1-ii,  C-2-iii,  D-3-iv", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-2-ii, B-3-iii, C-4-iv,   D-1-i", "A-3-iii, B-4-iv, C-1-i,    D-2-ii"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["A-3-iii, B-1-i,  C-2-ii,   D-4-iv", "A-4-iv, B-2-ii,  C-3-iii,  D-1-i", "A-2-ii, B-3-iii, C-1-i,   D-4-iv", "A-1-i,  B-4-iv,  C-2-ii,   D-3-iii"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-4-iv, B-3-iii, C-1-i,    D-2-ii", "A-2-ii, B-1-i,   C-4-iv,   D-3-iii", "A-3-iii, B-4-iv, C-2-ii,   D-1-i"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-3-iii, C-4-ii,  D-2-iv", "A-4-ii, B-1-i,   C-2-iv,  D-3-iii", "A-3-iii, B-2-iv, C-4-ii,  D-1-i", "A-2-iv, B-4-ii,  C-1-i,   D-3-iii"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-3-iii, B-4-iv, C-1-i,    D-2-ii", "A-1-i,  B-3-iii, C-2-ii,   D-4-iv", "A-2-ii, B-1-i,   C-3-iii,  D-4-iv", "A-4-iv, B-2-ii,  C-1-i,    D-3-iii"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-3-iii, B-4-iv, C-2-ii,   D-1-i", "A-2-ii, B-3-iii, C-1-i,   D-4-iv", "A-4-iv, B-1-i,   C-2-ii,   D-3-iii"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-4-iv, B-3-iii, C-4-iv,   D-1-i", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-3-iii, B-1-i,   C-2-ii,   D-4-iv", "A-2-ii, B-4-iv,  C-1-i,    D-3-iii"],
    correct: 2,
