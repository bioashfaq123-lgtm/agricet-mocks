...
export const farmMachineryQuestions: Question[] = [
  {
    ...
    options: ["Disc harrow", "Mould board plough", "Cultivator", "Rotavator"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Weight of the implement", "Horizontal force required to pull the implement", "Vertical force on the implement", "Speed of operation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["540 RPM and 1000 RPM", "250 RPM", "1500 RPM", "3000 RPM"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Disc plough", "Mould board plough", "Sub-soil plough", "Chisel plough"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Axial flow pump", "Centrifugal pump", "Reciprocating pump", "Gear pump"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fluted roller type", "Brush feed type", "Pneumatic system", "Belt conveyor"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["35 cm", "70 cm", "105 cm", "140 cm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["1-2 bar", "5-20 bar", "50-100 bar", "0.1-0.5 bar"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Broadcaster", "Seed-cum-fertilizer drill", "Slurry applicator", "Duster"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ratio of actual discharge to theoretical discharge", "Ratio of head to power", "Ratio of input to output energy", "Ratio of speed to discharge"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["5-7 days", "15-25 days (mat type nursery)", "45-60 days", "More than 60 days"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Regional Network for Agricultural Machinery", "Research Network for Advanced Machinery", "Rural Network for Agro Mechanization", "Rotating Nozzle Application Method"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["10% soil cover", "30% soil surface cover after planting", "50% crop residue in soil", "75% residue burned"],
    correct: 1,
