...
export const da252LectureQuestions: Question[] = [
  // ── LECTURE 1: Introduction to Surveying ─────────────────────────────────
  {
    ...
    options: ["Designing buildings", "Preparing maps only", "Soil testing", "Determining positions of points and measuring distances, angles, and elevations on the earth's surface"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Irregular", "Cylindrical", "Spherical", "Flat (plane)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Only vertical measurements", "Only angles", "The curvature of the earth (for large areas)", "Only horizontal distances"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Soil nutrient analysis", "Measurement and recording of land for planning and development", "Weather prediction", "Crop yield estimation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Parts to whole", "North to south", "Whole to parts (general to specific)", "Left to right"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A survey instrument", "A chain length", "A reference level or surface from which elevations are measured", "A type of map"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Kolkata", "Karachi", "Chennai", "Mumbai"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Equal area and detail", "Less area with more detail", "Only rivers", "More area with less detail"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Theodolite", "Chain", "Level", "Piezometer"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["East direction", "Vertical downward", "North (or South) direction, clockwise or counter-clockwise", "The horizon"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["20 m / 66 feet", "50 feet", "100 m", "30 m"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["The length of the chain", "A perpendicular (or oblique) measurement from the chain line to a detail point", "The angle between two chain lines", "A measurement along the chain line"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Compass", "Theodolite", "Level", "Cross-staff or optical square"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Two benchmarks", "Two main stations on the main line", "Two subsidiary points to provide additional checks", "End points of the survey"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Measuring distances", "Taking offsets", "Establishing intermediate points on a straight line between two stations", "Plotting the chain survey"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Stopping the survey", "Moving the survey line", "Geometric methods using similar triangles or Pythagoras theorem", "Ignoring the obstacle"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Hectares only", "Chains and links, later converted to hectares", "Gunter's units only", "Square feet only"],
    correct: 1,
  ...
  // ── LECTURE 3: Compass Surveying ──────────────────────────────────────────
  {
    ...
    options: ["Vertical angles", "Horizontal angles (bearings) using a magnetic needle", "Distances", "Elevations"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Magnetic east and true east", "True north and magnetic north", "True north and geographic east", "Magnetic north and south"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["From north, clockwise, 0°–360°", "From east, counter-clockwise", "From south only", "From any direction"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Bearings from east", "Only in degrees", "0°–360° from north", "N/S angle E/W (e.g., N 45° E, S 30° W)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Sun's gravity", "Atmospheric pressure", "Presence of magnetic materials (iron, electric cables) near the compass", "Earth's rotation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Only measuring distances", "Plotting only", "Measuring a series of connected lines with distances and bearings", "Only measuring bearings"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Accumulation of errors in measurement and plotting", "Correct scale selection", "Magnetic north alignment", "Correct measurements"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Two traverse lines", "Horizontal plane and direction of earth's total magnetic field", "Magnetic needle and vertical", "True north and magnetic north"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Level staff", "Compass", "Alidade", "Cross-staff"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Levelling is needed", "All points are visible from one station", "Points are in multiple locations requiring traversing", "Underground surveys are done"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["One instrument station", "A level", "A compass", "Two or more instrument stations with intersecting rays to locate points"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Read fractional parts of the main scale divisions (increase precision)", "Measure magnetic north", "Measure distances", "Set the instrument level"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Extension of the previous survey line", "Magnetic south", "Vertical axis", "North"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Magnetic measurements", "Rapid determination of distances and elevations using stadia hairs in telescope", "Soil profiling", "Underground surveys"],
    correct: 1,
  ...
  // ── LECTURE 5: Levelling Principles and Methods ───────────────────────────
  {
    ...
    options: ["Areas of fields", "Horizontal distances", "Magnetic bearings", "Relative heights (elevations) of points on the earth's surface"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A permanent reference point of known elevation", "A farm boundary marker", "A chain length marker", "A temporary marker"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Any point", "The first staff position (at known point/BM) after setting up instrument", "The last point", "A forward point"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Intermediate sight", "Foresight reading", "Staff height", "Back sight reading"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Compass readings", "HI method", "Comparing consecutive staff readings (rise = previous IS/FS > current reading)", "Triangulation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A large obstacle (river, valley) prevents direct levelling", "There are many intermediate points", "The distance is short", "The area is flat"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["+0.0785 D² (additive)", "+D/2", "–D/4", "–0.0785 D² (subtractive)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["12√K mm", "6√K mm", "Zero", "24√K mm"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["It works without a staff", "It measures angles", "It has a simpler construction and is more stable for ordinary levelling", "It measures horizontal distances"],
    correct: 2,
  ...
  // ── LECTURE 6: Contouring ─────────────────────────────────────────────────
  {
    ...
    options: ["Of equal soil depth", "Of equal elevation (height) above a datum", "Of equal slope", "Of equal horizontal distance"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vertical difference in elevation between successive contour lines", "Distance between contour lines on map", "Scale of the map", "Number of contours on map"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Uniform slope", "Gentle slope", "Steep slope", "Flat terrain"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Curve around valleys", "Bend around ridges", "Cross each other (except for overhangs)", "Close on themselves"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ridge", "Hill top", "Plateau", "Valley / stream"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Pest scouting", "Irrigation system design, soil conservation planning, drainage layout", "Fertilizer recommendations", "Planting decisions only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Grid/section levelling and interpolating contour positions", "Eye sketching only", "Aerial photography", "Direct spot height measurement on contour"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Soil fertility level", "Crop growth rate", "Water pH", "The slope or rate of change of elevation (rise/horizontal distance)"],
    correct: 3,
  ...
  // ── LECTURE 7: Area Measurement ───────────────────────────────────────────
  {
    ...
    options: ["Both A and B depending on shape", "½ × diagonal × sum of offsets", "½ × Base × Perpendicular height", "Side²"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Diagonal lengths", "End ordinates only", "Average of end ordinates", "Ordinates at mid-points of each division"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Any number", "Odd", "Even", "At least 10"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Measure elevations", "Measure areas of irregular figures on a map/plan", "Measure distances", "Measure angles"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["10,000 m²", "100 m²", "100,000 m²", "1,000 m²"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["4,047 m²", "1,000 m²", "2,000 m²", "10,000 m²"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Straight line between consecutive ordinates", "Circular boundary", "No variation between ordinates", "Parabolic boundary between ordinates"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["X and Y coordinates of boundary points (surveyor's formula)", "Chain lengths only", "Compass bearings only", "Contour data"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Measures both horizontal/vertical angles and distances simultaneously", "Only levels the instrument", "Measures magnetic bearings", "Measures only angles"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Capture, store, analyze, and display geographic/spatial data", "Replace surveyors", "Measure gravity", "Only store maps"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Chemical sensors in soil", "Magnetic instruments", "Ground-based instruments only", "Satellite/aerial sensors to gather information about land features without direct contact"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Village revenue maps", "Soil survey reports", "Field-wise crop cultivation details, ownership, area, and irrigation source", "Fertilizer use data"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Crop monitoring, area mapping, and precision agriculture applications", "Only entertainment", "Underground surveys", "Weather forecasting"],
    correct: 0,
