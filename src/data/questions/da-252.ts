...
export const da252Questions: Question[] = [
  ...
  },
  {
    ...
    options: ["10 metres", "20 metres", "30 metres", "66 feet (20.12 m)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["100 square metres", "1000 square metres", "4047 square metres (40.47 ares)", "10000 square metres"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["1000 m²", "5000 m²", "10000 m²", "100000 m²"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Measuring distances", "Marking straight lines and stations", "Measuring angles", "Measuring elevations"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Prismatic compass", "Cross staff", "Theodolite", "Plane table"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It is convenient", "It represents a fixed, stable reference elevation", "It is at zero elevation", "All of the above"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Staff", "Dumpy level", "Prismatic compass", "Chain"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Bearing", "Azimuth", "Latitude", "Declination"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Equal rainfall", "Equal slope", "Equal elevation (height)", "Equal soil type"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Gentle slope", "Steep slope", "Flat terrain", "Valley"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Contour gradient", "Contour interval", "Horizontal equivalent", "Reduced level"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Foresight", "Back sight", "Intermediate sight", "Height of instrument"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Triangles", "Rectangles", "Trapezoids (strips)", "Circles"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Measuring distances", "Measuring horizontal angles", "Measuring differences in elevation", "Measuring soil depth"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Chain surveying", "Plane table surveying", "Theodolite surveying", "Aerial surveying"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0.1 acre", "0.5 acre", "2.5 acres", "5 acres"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["150 m²", "500 m²", "5000 m²", "10000 m²"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sun position", "Magnetic needle pointing north", "Gravity", "Electric current"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Temperature correction", "Sag correction", "Slope correction", "Pull correction"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ranging", "Chaining", "Benchmarking", "Setting out"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Along the survey chain line", "Perpendicular to the chain line to locate boundary features", "At angles other than 90°", "Along the boundaries only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Aerial surveying", "Remote sensing", "GPS/GNSS surveying", "Plane table surveying"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Khasra", "Pahani (1-B record)", "Jamabandi", "Field book"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Acre", "Hectare", "Guntha", "Bigha"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Compass", "Cross staff / Optical square", "Theodolite", "Abney level"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A mark on a bench", "A permanent reference point with known elevation", "The highest point of a survey", "The starting point of any traverse"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Determining height of trees", "Rapid transfer of elevation from one point to another", "Precise determination of levels", "Contouring"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["True north (geographic north)", "Magnetic north", "Grid north", "Benchmark"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Equal slope", "Equal depth", "Equal elevation above datum", "Equal distance from a reference point"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Horizontal distance between two contours", "Vertical distance between two consecutive contours", "Scale of the map", "Distance between two benchmarks"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Surveying", "Levelling", "Traversing", "Ranging"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Height of the tripod", "Elevation of the line of sight above datum", "Length of the staff", "Height of the benchmark"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Base × height", "Both a and c", "Hero's formula (when three sides are known)", "All of the above"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["100 cents", "247.1 cents", "40 cents", "1000 cents"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["True north and magnetic north", "Grid north and true north", "Magnetic north and south", "East and west magnetic poles"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1:500", "1:25,000 and 1:50,000", "1:1,000", "1:10,000"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Measuring angles", "Measuring horizontal distances", "Spirit levelling (height differences)", "Measuring slopes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Fore sight (FS)", "Back sight (BS)", "Intermediate sight (IS)", "Change point"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Measuring angles", "Measuring the area of irregular figures on a map", "Measuring distances along a road", "Setting right angles"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["1/16 acre", "1/40 acre", "1/100 acre", "1/4 acre"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Online seed purchase", "Digital land records and registration in Telangana", "Online fertilizer subsidy", "e-market for crops"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Survey", "Mutation (Daakhil Kharij)", "Registration", "Demarcation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ration card", "Pattadar Passbook", "Voter ID", "Aadhaar card"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Survey of India", "Revenue Department (under Collector/VRO)", "NRSA/NRSC", "Water Resources Department"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["District Collector", "Irrigation Department/Engineers", "Panchayat", "Farmer's committee"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Consolidation", "Fragmentation / Partition", "Mutation", "Alienation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["(n-2) × 180°", "(2n-4) × 90°", "(n+2) × 180°", "(n-1) × 90°"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Topographic surveying", "Cadastral (property) surveying", "Hydrographic surveying", "Route surveying"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Type of soil", "Rise or fall per unit horizontal distance (slope)", "Depth of a water table", "Land revenue rate"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Irrigated land", "Dry land (rainfed / unirrigated land)", "Forest land", "Government wasteland"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only to determine soil type", "To identify and record how land is being used (crop, fallow, forest, built-up, water body, etc.)", "To measure elevation", "To find mineral resources"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Record all measurements, observations and notes made during the survey in the field", "Store survey instruments", "Calculate areas", "Prepare final maps"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["East direction", "South direction", "North (or South) direction", "Previous survey line"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Measuring soil pH", "Crop area estimation, crop health monitoring, and land use mapping from satellite/aircraft images", "Testing seed germination", "Measuring irrigation discharge"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A bank pass book", "Legal proof of ownership and possession of land", "A crop insurance document", "A soil health card"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only entertainment", "Crop monitoring, spray application, field mapping, and area estimation", "Underground water detection", "Soil testing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Providing land to tribals", "Drone-based survey and digital property rights to rural house owners", "Land consolidation in agriculture", "Canal irrigation expansion"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Increase soil organic matter", "Smoothen the field surface for uniform irrigation and better agricultural operations", "Control soil pH", "Improve seed germination"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Bengaluru", "Hyderabad (Balanagar)", "Chennai", "Ahmedabad"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["INSAT series", "IRS (Indian Remote Sensing) satellite series", "GSAT series", "PSLV series"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["New Delhi", "Hyderabad (Nagpur)", "Nagpur", "Bangalore"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["4 classes", "6 classes", "8 classes (I to VIII)", "10 classes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Panchayat office", "Sub-Registrar's office", "Revenue Divisional Office", "District Collector's office"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Plot number", "Survey number (Sy. No.)", "Khasra number", "Block number"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Resistivity survey", "Levelling with a dumpy level or hand level", "GPS survey only", "Remote sensing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Meebhoomi", "Dharani", "Bhoomi", "eLand"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Area on map to area on ground", "Distance on map to corresponding distance on ground", "Height on map to actual height", "Number of contours to area"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Compass", "Abney level / Clinometer", "Planimeter", "Staff"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Satellite calibration", "Verification of satellite-interpreted data by actual field observations on the ground", "Aerial photography", "GIS data entry"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Land registration document", "Seasonal crop survey/inspection conducted by VRO to record actual crop sown in each field", "Soil fertility test", "Water discharge measurement"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only farmer's self-declaration", "GPS-based e-crop survey (electronic crop cutting experiments)", "Manual chain surveying", "Aerial photography only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Land redistribution scheme", "Ceiling surplus distribution", "Assigned lands / Bhodan lands / Grameen Bhoomi", "Pattedar scheme"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Determine ownership boundaries", "Show the physical features of the land — relief (contours), drainage, vegetation, settlements, roads", "Measure soil fertility", "Calculate crop yield"],
    correct: 1,
