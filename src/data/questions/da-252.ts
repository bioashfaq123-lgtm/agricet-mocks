...
export const da252Questions: Question[] = [
  ...
  },
  {
    ...
    options: ["150 links", "50 links", "75 links", "100 links"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["100 ft long with 100 links", "33 ft long with 16 links", "66 ft long with 100 links", "20 m long with 100 links"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Surveyor or observer", "Follower or rear chainman", "Scout or pioneer", "Leader or head chainman"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Offsetting", "Chaining", "Traversing", "Ranging"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["10 metres", "5 metres", "30 metres", "15 metres"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["0.85 to get mean velocity", "0.75 to get mean velocity", "0.95 to get mean velocity", "0.65 to get mean velocity"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Low permeability and fine texture", "Sandy loam with moderate drainage", "High permeability and coarse texture", "Heavy clay with water repellent properties"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1 horizontal to 4 vertical", "1 horizontal to 2 vertical", "1 horizontal to 1 vertical", "2 horizontal to 3 vertical"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["50 to 80%", "80 to 100%", "30 to 50%", "20 to 40%"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["80% of difference", "40% of difference", "60% of difference", "100% of difference"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Obtuse-angled for best coverage", "Right-angled for easy calculation", "In ratio 1:2:3 for accuracy", "As equal as possible (nearly equilateral)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Both chain and vision obstructed", "Only vision is obstructed by hill", "Both chain and vision blocked by building", "Only chaining is obstructed by pond"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["10 to 20 L/h", "0.1 to 0.5 L/h", "5 to 10 L/h", "0.6 to 3 L/h"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["3 times the ordinate value", "4 times the ordinate value", "2 times the ordinate value", "1 (no multiplication)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sufficient in volume and velocity to cut deep wide channels", "Limited to the surface of sandy soils", "Less than 0.3 mm/s in velocity", "Only caused by wind action on slopes"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Half the base line length", "The length of the base line", "The number of ordinates plus one", "The common distance between ordinates"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A-4-iv, B-3-iii, C-2-ii, D-1-i", "A-2-ii, B-1-i,  C-4-iv,  D-3-iii", "A-1-iii, B-2-i, C-3-ii,  D-4-iv", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1/3 to 1/5 of orifice size", "1/7 to 1/10 of orifice size", "Equal to the orifice size", "1/2 to 1/3 of orifice size"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Less than 0.1 mm", "0.1 to 0.5 mm", "Greater than 2.0 mm", "0.5 to 2.0 mm"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["200 to 250 cm below ground", "5 to 15 cm below ground", "30 to 75 cm below ground", "100 to 150 cm below ground"],
    correct: 2,
...

  {
    ...
    options: ["Chain surveying", "Plane surveying", "Geodetic surveying", "Compass surveying"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["100 and 150 links", "150 and 200 links", "50 and 100 links", "100 and 200 links"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Invar tape", "Metallic tape", "Steel tape", "Cloth tape"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["0.5 to 4 mm", "10 to 20 mm", "0.05 to 0.5 mm", "4 to 10 mm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["100 mm", "50 mm", "150 mm", "75 mm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Lean-to", "Saw-tooth", "Even span", "Quonset"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Only the rectangular rule", "Pythagoras theorem", "Trigonometric sine and cosine rules", "Trapezoidal rule and Simpson's one-third rule"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Greenhouse environment monitoring", "Compass surveying to measure bearings", "Distance measurement by recording paces", "Chain surveying to measure right angles"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["10 cm square", "25 cm square", "100 cm square", "50 cm square"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lower initial cost", "Better for paddy (flooded field) cultivation", "Requires no pump or pressure", "Suitable for undulating terrain without land leveling"],
    correct: 3,
