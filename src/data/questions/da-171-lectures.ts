...
export const da171LectureQuestions: Question[] = [
  // ── LECTURE 1: Introduction to Plant Pathology ───────────────────────────
  {
    ...
    options: ["Animal diseases", "Plant diseases and their management", "Insect pests of plants", "Plant nutrition"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Anton de Bary", "Louis Pasteur", "Robert Koch", "Martinus Beijerinck"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Host, Pathogen, Environment", "Plant, Insect, Soil", "Temperature, Humidity, Wind", "Soil, Water, Air"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Classify fungi", "Prove that a specific microorganism causes a specific disease", "Study plant viruses", "Develop pesticides"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Epidemiology", "Diagnosis", "Taxonomy", "Etiology"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Study of disease symptoms", "Study of causal agents of diseases", "Study of disease spread", "Study of resistant varieties"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reisolate the pathogen", "Inoculate healthy plant", "Associate the organism with diseased plant", "Grow the organism in pure culture"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Plant nutrition", "The spread and dynamics of disease in plant populations", "Weed management", "Soil microorganisms"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Drought", "Late blight of potato (Phytophthora infestans)", "Bacterial wilt", "Virus disease"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Causal agents of disease", "Signs and symptoms of plant diseases", "Disease control methods", "Pathogen genetics"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mycelium", "Thallus", "Sporangium", "Conidium"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Ascospores", "Basidiospores", "Conidia", "Oospores"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Chitin", "Cellulose", "Both chitin and cellulose", "Neither"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ascomycetes", "Basidiomycetes", "Oomycetes", "Zygomycetes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Have no cell wall", "Have no known sexual stage", "Only reproduce sexually", "Are all plant pathogens"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Basidiomycetes", "Ascomycetes (order Erysiphales)", "Oomycetes", "Zygomycetes"],
    correct: 1,
  ...
  // ── LECTURE 3: Bacteria and Phytoplasma ──────────────────────────────────
  {
    ...
    options: ["Gram-negative rods", "Gram-positive cocci", "Spore-forming anaerobes", "Acid-fast bacteria"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Xanthomonas axonopodis pv. citri", "Pseudomonas syringae", "Agrobacterium tumefaciens", "Erwinia carotovora"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Pseudomonas fluorescens", "Agrobacterium tumefaciens", "Xanthomonas campestris", "Rhizobium japonicum"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Xanthomonas oryzae pv. oryzae", "Pseudomonas glumae", "Burkholderia glumae", "Erwinia oryzae"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Erwinia carotovora", "Xanthomonas campestris", "Fusarium solani", "Rhizoctonia solani"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["DNA", "Cell wall", "Ribosomes", "Membrane"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["White powdery coating", "Water-soaked lesions that turn necrotic", "Orange-brown pustules", "Dark sooty mold"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Pseudomonas syringae pv. tabaci", "Xanthomonas axonopodis", "Agrobacterium rhizogenes", "Erwinia"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Stomata, hydathodes, and wounds", "Cuticle only", "Root epidermis", "All intact surfaces"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Mancozeb", "Streptomycin sulfate", "Carbendazim", "Monocrotophos"],
    correct: 1,
  ...
  // ── LECTURE 4: Viruses and Viroids ───────────────────────────────────────
  {
    ...
    options: ["DNA/RNA + protein coat (capsid)", "Chitin and protein", "Cellulose + lipid", "Peptidoglycan"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Photographed by electron microscopy", "Crystallized", "Transmitted by a vector", "Cloned"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Small viruses", "Naked RNA molecules without protein coat", "Modified bacteria", "Phytoplasmas"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Potato virus Y", "Potato leaf roll virus", "Potato spindle tuber viroid (PSTVd)", "Phytoplasma"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Insects (aphids, whitefly)", "Infected seed", "Mechanical contact", "Soil bacteria directly"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Mungbean yellow mosaic virus (MYMV)", "Cowpea mosaic virus", "Bean common mosaic virus", "Soybean mosaic virus"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Virus", "Phytoplasma", "Fungus", "Bacterium"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ustilago tritici", "Tilletia caries", "Ustilago nuda", "Puccinia graminis"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Soil-borne diseases only", "Seed-borne smut diseases of cereals", "Viral diseases", "Nematodes"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Insect pests", "Soil-borne pathogens", "Viral diseases", "Bacterial leaf diseases"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Helminthosporium oryzae", "Sclerotium oryzae-sativae", "Pyricularia oryzae", "Sarocladium oryzae"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Foliar pathogens", "Vascular pathogens that block xylem (Fusarium, Verticillium)", "Leaf-spotting fungi", "Root surface pathogens"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Surface-borne fungi and bacteria", "Viruses inside seed", "Nematodes in soil", "All pathogens"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Synthetic fungicides", "Trichoderma viride and Pseudomonas fluorescens", "Insecticides", "Growth regulators"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Nutrient content", "Seed-borne pathogens", "Germination only", "Seed size"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chemical fungicide", "Biocontrol agent against soil-borne pathogens", "Insecticide", "Plant growth promoter only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Erysiphe", "Puccinia", "Ustilago", "Alternaria"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Alternaria solani", "Phytophthora infestans", "Fusarium solani", "Botrytis cinerea"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Phytophthora infestans", "Alternaria solani", "Cercospora solani", "Fusarium oxysporum"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Soil-borne", "Seed-borne", "Air-borne", "Water-borne"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Copper sulphate + lime", "Sulphur + copper", "Carbendazim + mancozeb", "Zineb + thiram"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Claviceps purpurea", "Ustilago reiliana", "Puccinia striiformis", "Fusarium graminearum"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Rust", "Tikka disease", "Blight", "Scorch"],
    correct: 1,
  ...
  // ── LECTURE 7: Disease Management – Chemical Control ─────────────────────
  {
    ...
    options: ["Mancozeb (contact)", "Propiconazole (systemic)", "Copper oxychloride", "Bordeaux mixture"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Phloem only", "Xylem (acropetal) and/or phloem (basipetal)", "Epidermis", "Cell wall"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Carbendazim", "Mancozeb", "Metalaxyl", "Propiconazole"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only viruses", "Bacterial and fungal diseases", "Only smuts", "Only rusts"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["True fungi", "Oomycetes (downy mildews, Phytophthora)", "Bacteria", "Viruses"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Monocropping", "Crop rotation", "Heavy fertilization", "Close plant spacing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Inhibiting ergosterol synthesis", "Inhibiting mitochondrial respiration (Qo site)", "Disrupting cell membranes", "Inhibiting tubulin"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Horizontal (field) resistance and vertical (race-specific) resistance", "Temporary and permanent resistance", "Chemical and biological resistance", "Passive and aggressive resistance"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Susceptibility", "Disease resistance mechanism", "Nutrient uptake", "Photosynthesis"],
    correct: 1,
  ...
  // ── LECTURE 8: Microbiology – Beneficial Microorganisms ───────────────────
  {
    ...
    options: ["All grasses", "Legume roots for N₂ fixation", "Mycorrhizal fungi", "Rice roots"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Symbiotic N₂ fixer in legumes", "Free-living / associative N₂ fixer in rhizosphere of cereals", "Phosphate solubilizer only", "Mycorrhizal fungus"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Bacteria and plant roots", "Fungi and plant roots", "Algae and plant leaves", "Nematodes and roots"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fixes phosphorus", "Has symbiotic cyanobacterium Anabaena that fixes N₂", "Releases potassium", "Controls weeds"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fixing nitrogen", "Solubilizing insoluble phosphates to plant-available forms", "Producing growth hormones only", "Controlling soil pH"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Legumes", "Non-leguminous plants (Casuarina, Alnus)", "Rice", "Cotton"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Anabaena, Nostoc, Tolypothrix", "Chlorella, Spirogyra", "Saccharomyces, Aspergillus", "Rhizobium, Azotobacter"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Nitrogen fixation", "Phosphorus uptake in low-P soils", "Carbon dioxide fixation", "Water exclusion"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chemical reactions", "Earthworms to decompose organic matter", "Fungi only", "High temperature composting"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Insects", "Soil-borne fungal pathogens (produces antibiotics)", "Viral diseases", "Nematodes"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fungal diseases", "Lepidopteran pests (caterpillars)", "Bacterial diseases", "Nematodes"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Nitrogenase", "Nitrate reductase", "Urease", "Amylase"],
    correct: 0,
