...
export const da171LectureQuestions: Question[] = [
  // ── LECTURE 1: Introduction to Plant Pathology ───────────────────────────
  {
    ...
    options: ["Plant nutrition", "Plant diseases and their management", "Insect pests of plants", "Animal diseases"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Host, Pathogen, Environment", "Temperature, Humidity, Wind", "Soil, Water, Air", "Plant, Insect, Soil"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Prove that a specific microorganism causes a specific disease", "Study plant viruses", "Classify fungi", "Develop pesticides"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Reisolate the pathogen", "Grow the organism in pure culture", "Inoculate healthy plant", "Associate the organism with diseased plant"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Soil microorganisms", "Plant nutrition", "The spread and dynamics of disease in plant populations", "Weed management"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Chlorosis due to iron deficiency", "Rice blast", "Citrus canker", "Late blight of potato"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Virus disease", "Late blight of potato (Phytophthora infestans)", "Bacterial wilt", "Drought"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Causal agents of disease", "Disease control methods", "Pathogen genetics", "Signs and symptoms of plant diseases"],
    correct: 3,
  ...
  // ── LECTURE 2: Fungi – Structure and Classification ───────────────────────
  {
    ...
    options: ["Autotrophic", "Chemosynthetic", "Photosynthetic", "Heterotrophic"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Conidium", "Mycelium", "Sporangium", "Thallus"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chitin", "Lignin", "Peptidoglycan", "Cellulose"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Neither", "Cellulose", "Chitin", "Both chitin and cellulose"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ascospore", "Oospore", "Zygospore", "Basidiospore"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Root structures", "Fruit bodies", "Compact, hard masses of hyphae for survival", "Type of spores"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sporangia", "Asci", "Conidia", "Basidia"],
    correct: 0,
  ...
  // ── LECTURE 3: Bacteria and Phytoplasma ──────────────────────────────────
  {
    ...
    options: ["Spore-forming anaerobes", "Gram-negative rods", "Acid-fast bacteria", "Gram-positive cocci"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Pseudomonas syringae", "Xanthomonas axonopodis pv. citri", "Erwinia carotovora", "Agrobacterium tumefaciens"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Xanthomonas campestris", "Erwinia carotovora", "Rhizoctonia solani", "Fusarium solani"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fungus", "Phytoplasma", "Bacterium", "Virus"],
    correct: 1,
  ...
  // ── LECTURE 4: Viruses and Viroids ───────────────────────────────────────
  {
    ...
    options: ["Peptidoglycan", "DNA/RNA + protein coat (capsid)", "Chitin and protein", "Cellulose + lipid"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Transmitted by a vector", "Cloned", "Crystallized", "Photographed by electron microscopy"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Double-stranded DNA", "Double-stranded RNA", "Single-stranded RNA", "Single-stranded DNA"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Naked RNA molecules without protein coat", "Modified bacteria", "Phytoplasmas", "Small viruses"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Potato spindle tuber viroid (PSTVd)", "Phytoplasma", "Potato virus Y", "Potato leaf roll virus"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Leafhopper", "Myzus persicae (aphid)", "Thrips", "Whitefly"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Banana bunchy top virus (BBTV)", "Cucumber mosaic virus", "Banana streak virus", "Banana bract mosaic virus"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Capsid", "Nucleoprotein", "Capsomere", "Nucleocapsid"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Excess water", "Uneven chlorophyll distribution", "Nutrient toxicity", "Fungal pigmentation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Virus", "Bacterium", "Phytoplasma", "Fungus"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ustilago nuda", "Tilletia caries", "Puccinia graminis", "Ustilago tritici"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Viral diseases", "Seed-borne smut diseases of cereals", "Soil-borne diseases only", "Nematodes"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Viral diseases", "Insect pests", "Bacterial leaf diseases", "Soil-borne pathogens"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Sarocladium oryzae", "Helminthosporium oryzae", "Sclerotium oryzae-sativae", "Pyricularia oryzae"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Vascular pathogens that block xylem (Fusarium, Verticillium)", "Leaf-spotting fungi", "Root surface pathogens", "Foliar pathogens"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Insecticides", "Trichoderma viride and Pseudomonas fluorescens", "Growth regulators", "Synthetic fungicides"],
    correct: 1,
  ...
  // ── LECTURE 6: Air-borne Diseases – Rusts, Blasts, Blights ───────────────
  {
    ...
    options: ["Helminthosporium oryzae", "Pyricularia oryzae", "Rhizoctonia solani", "Xanthomonas oryzae"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Alternaria", "Erysiphe", "Puccinia", "Ustilago"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Fusarium solani", "Botrytis cinerea", "Phytophthora infestans", "Alternaria solani"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Phytophthora infestans", "Alternaria solani", "Fusarium oxysporum", "Cercospora solani"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ascomycetes", "Basidiomycetes", "Oomycetes (Sclerospora, Peronosclerospora)", "Deuteromycetes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Copper sulphate + lime", "Carbendazim + mancozeb", "Sulphur + copper", "Zineb + thiram"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Claviceps purpurea", "Ustilago reiliana", "Fusarium graminearum", "Puccinia striiformis"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Rust", "Tikka disease", "Scorch", "Blight"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Xylem (acropetal) and/or phloem (basipetal)", "Phloem only", "Epidermis", "Cell wall"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Only viruses", "Only smuts", "Only rusts", "Bacterial and fungal diseases"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Oomycetes (downy mildews, Phytophthora)", "Viruses", "True fungi", "Bacteria"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Crop rotation", "Close plant spacing", "Monocropping", "Heavy fertilization"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Temporary and permanent resistance", "Chemical and biological resistance", "Horizontal (field) resistance and vertical (race-specific) resistance", "Passive and aggressive resistance"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Nutrient uptake", "Photosynthesis", "Disease resistance mechanism", "Susceptibility"],
    correct: 2,
  ...
  // ── LECTURE 8: Microbiology – Beneficial Microorganisms ───────────────────
  {
    ...
    options: ["Legume roots for N₂ fixation", "Rice roots", "All grasses", "Mycorrhizal fungi"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Free-living / associative N₂ fixer in rhizosphere of cereals", "Mycorrhizal fungus", "Phosphate solubilizer only", "Symbiotic N₂ fixer in legumes"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Bacteria and plant roots", "Algae and plant leaves", "Nematodes and roots", "Fungi and plant roots"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Releases potassium", "Fixes phosphorus", "Has symbiotic cyanobacterium Anabaena that fixes N₂", "Controls weeds"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Controlling soil pH", "Fixing nitrogen", "Producing growth hormones only", "Solubilizing insoluble phosphates to plant-available forms"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Legumes", "Non-leguminous plants (Casuarina, Alnus)", "Cotton", "Rice"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chlorella, Spirogyra", "Rhizobium, Azotobacter", "Saccharomyces, Aspergillus", "Anabaena, Nostoc, Tolypothrix"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Nitrogen fixation", "Phosphorus uptake in low-P soils", "Water exclusion", "Carbon dioxide fixation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Insects", "Soil-borne fungal pathogens (produces antibiotics)", "Nematodes", "Viral diseases"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Bacterial diseases", "Nematodes", "Fungal diseases", "Lepidopteran pests (caterpillars)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["chitin or cellulose or both", "lignin and suberin", "cellulose only", "peptidoglycan"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["cuticle penetration only", "haustoria", "wounds or natural openings (stomata and lenticels)", "root nodules"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["xylem vessels", "mesophyll", "epidermis", "sieve tube cells of phloem"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["aphids only", "thrips", "whiteflies", "phloem-feeding leafhoppers and plant hoppers"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["membrane", "cell wall", "capsid", "coat protein"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["loss of yield", "disease severity", "symptom on the plant", "pathogen or its parts or products seen on host plant"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["any foreign material", "the chemical used for control", "the symptom", "the part of the pathogen which on contact with susceptible host causes infection"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["constantly present in moderate to severe form confined to particular area", "occurs periodically in destructive form", "occurs at irregular intervals", "very sporadic"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["High temperature, high humidity", "Dry and hot conditions", "Low temperature and humid conditions", "High temperature, low humidity"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["yellow spots", "red pustules", "black or purplish black dusty mass on floral organs", "white powdery mass"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ustilago and Tilletia", "Alternaria and Cercospora", "Pythium, Phytophthora, Fusarium", "Erysiphe and Peronospora"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["ring spots", "uniform yellowing", "alternate green and yellow patches", "necrosis"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["uniform yellowing", "tissue along vein is green, between veins is chlorotic", "circular chlorosis with green centre", "tissue close to vein is yellow, remaining area is green"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["powdery masses", "soft, watery tissue with slimy foul smelling ooze", "dry corky tissue", "black pustules"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["alternate hosts", "economic hosts", "resistant plants", "weed hosts that bridge gap between two crop seasons"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["sick soils", "diseased soils", "dead soils", "infected soils"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["soil, seed and planting material during normal agronomic operations", "nematodes", "wind and water", "insects and birds"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["colonization", "spore germination and growth of germ tube on host surface", "host invasion", "toxin production"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Insect vectors", "Rain water", "Direct penetration", "Wounds only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["waterlogging", "continuous cultivation of same crop causing pathogen saturation", "high pH", "chemical toxicity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["removal of diseased plants or affected parts from field", "seed treatment", "chemical spraying", "deep ploughing"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Protection", "Eradication", "Avoidance", "Exclusion"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Powdery mildews", "Rusts", "Smuts", "Downy mildews"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Rusts", "Downy mildews", "Wilts", "Smuts"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["excess water", "injury to root system, plugging of vessels or toxic substances from pathogen", "insect damage only", "viral infection only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Root tissues", "Cortical tissues of stem, fruits or leaves", "Seed tissues", "Vascular tissues"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["circular to angular spots occurring along leaf veins, petioles, stems and fruits", "downy growth", "powdery growth", "yellow patches"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Xanthomonas oryzae", "Helminthosporium oryzae", "Rhizoctonia solani", "Pyricularia oryzae"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Brown plant hopper", "Whitefly", "Thrips", "Green leafhopper"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Tomato spotted wilt virus", "Aspergillus niger", "Cercospora arachidicola (early Tikka) and Cercosporidium personatum (late Tikka)", "Puccinia arachidis"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Bengal gram (chickpea)", "Redgram", "Green gram", "Black gram"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Green gram and Black gram", "Sunflower", "Castor", "Sorghum"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Cucurbits", "Bhendi", "Brinjal", "Tomato"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Guava", "Banana", "Coconut", "Mango"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Guava", "Coconut", "Mango", "Citrus"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Damping-off", "Wilt", "Hypertrophy - transformation of plant parts", "Blight"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Castor", "Cotton", "Gingelly (Sesame)", "Sunflower"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["direct cuticle penetration", "haustorium formation", "wounds and less frequently through natural openings", "special infection pegs"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["secondary infection", "the initial infection from sources of pathogen survival", "only soil-borne infections", "only aerial infections"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wilts", "Rusts", "Powdery mildews", "Downy mildews"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["killing the pathogen directly", "alkalizing the soil", "enhancing antagonistic micro-organisms that suppress pathogen activity", "acidifying the soil"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Downy mildews", "Powdery mildews", "Bacterial blights", "Root rots"],
    correct: 1,
  ...
  },
  {
    ...
    lectureNo: 5,
    question: "Loose smut of wheat is caused by",
    options: ["Alternaria triticina", "Erysiphe tritici", "Puccinia graminis", "Ustilago tritici"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Virus", "Bacteria", "Fungus", "Nematode"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["periodically in destructive form", "every crop season", "at very irregular intervals in fewer instances", "constantly in one region"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ragi (finger millet)", "Jowar", "Maize", "Bajra"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["leaf blight", "heat stress", "root rot", "smut and ergot diseases"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Damping-off", "Wilts", "Rusts", "Smuts"],
    correct: 2,
