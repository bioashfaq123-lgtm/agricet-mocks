...
export const computerApplicationsQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["Non-volatile memory that retains data without power supply", "Volatile memory that loses data when power is off", "Used for temporary data storage", "An input device"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Compiler is faster at writing programs in computer systems", "Both work identically in data processing", "Interpreter produces machine code; Compiler produces source code for office applications", "Compiler translates whole program before execution; Interpreter translates one statement at a time"],
    correct: 3,
