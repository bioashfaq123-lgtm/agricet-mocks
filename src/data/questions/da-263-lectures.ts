...
export const da263LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["Hyderabad", "farmer", "river", "city"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["beautifully", "and", "with", "fast"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["produced", "harvest", "field", "green"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["grow", "grows", "have grew", "grew"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["cultivate", "kharif", "farmers", "crops"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["An", "No article needed", "The", "A"],
    correct: 2,
  ...
  // ── LECTURE 2: Tenses ─────────────────────────────────────────────────────
  {
    ...
    options: ["Past Continuous", "Present Perfect", "Present Continuous", "Simple Present"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["She watered the plants yesterday.", "She waters the plants daily.", "She has watered the plants.", "She will water the plants."],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Subject + V2", "Subject + has/have + V3 (past participle)", "Subject + had + V3", "Subject + is/am/are + V-ing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["growing", "grown", "growed", "grew"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Simple Future Passive", "Simple Present", "Future Perfect", "Simple Past"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Rice was growing by the farmer.", "Rice is grown by the farmer.", "The farmer is grown by rice.", "Rice grew by the farmer."],
    correct: 1,
  ...
  },
  {
    ...
    options: ["I have been working since morning.", "He works since five years.", "I worked since yesterday.", "I have been working since two hours."],
    correct: 0,
  ...
  // ── LECTURE 3: Reading Comprehension and Vocabulary ───────────────────────
  {
    ...
    options: ["Translate languages", "Understand and interpret a given passage", "Speak fluently", "Write essays"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["barren", "lush", "productive", "rich"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Expensive", "Naturally occurring or native to a region", "Foreign or imported", "Synthetic or artificial"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["loose", "loosed", "losed", "lost"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["harmful", "irrelevant", "destructive", "essential"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Reading backwards", "Reading quickly to get the general idea or main points", "Reading every word carefully", "Reading aloud"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reading for general meaning", "Avoiding difficult words", "Reading every word slowly", "Reading quickly to find specific information (dates, names, figures)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Temperature", "Any form of water falling from the atmosphere (rain, snow, hail)", "Humidity level", "Wind speed"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Very wet", "Moderate climate", "Very cold", "Extremely dry (little or no rainfall)"],
    correct: 3,
  ...
  // ── LECTURE 4: Letter Writing and Report Writing ──────────────────────────
  {
    ...
    options: ["Officials, organizations, or institutions (professional/official)", "Pen pals only", "Social media", "Friends and family (personal)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Dear Sir / Madam,", "Hello,", "Hi there,", "Dear Friend,"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["See you,", "With love,", "Cheers,", "Yours faithfully / Yours sincerely,"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Applicant's qualifications, experience, and why they are suitable for the post", "Personal gossip", "Irrelevant personal information", "Complaints about other candidates"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Contains only opinions", "Has no headings", "Presents information, findings, or recommendations in a structured format", "Is written informally like a diary"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Bibliography", "Conclusion", "Introduction / Terms of Reference", "Appendix"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Identifies the topic/purpose of the communication concisely", "Is the sender's address", "Lists the enclosures", "Is the greeting"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Closed Communication", "Carbon Copy", "Content Checked", "Certified Copy"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Humorous", "Aggressive and threatening", "Long and filled with personal opinions", "Polite, factual, and clearly state the problem and desired resolution"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Unknown public", "Foreign organizations", "A group of people within an organization informing them of policy/decisions", "One person only"],
    correct: 2,
  ...
  // ── LECTURE 5: Grammar – Sentence Types, Voices, and Direct-Indirect Speech ─
  {
    ...
    options: ["He said that I am a farmer.", "He said that he was a farmer.", "He said that he is a farmer.", "He told that he was a farmer."],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Each of the plants needs water.", "Each plants need water.", "Each of the plants need water.", "All plant needs water."],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Neither seeds nor fertilizer are available.", "Neither the seeds nor the fertilizer was available.", "Neither the seeds nor the fertilizer were available.", "Neither seeds or fertilizer was available."],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Third (Unreal past)", "Zero", "Second (Unreal present)", "First (Real)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["They have went to the field.", "He has been working here since 2020.", "We discussed the problem.", "She knows how to drive."],
    correct: 0,
  ...
  // ── LECTURE 6: Communication Skills and Technical Writing ─────────────────
  {
    ...
    options: ["It uses technical jargon always", "It is very long and detailed", "The message is clearly understood by the receiver as intended", "Only the sender speaks"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Body language, gestures, facial expressions", "Telephone calls", "Emails", "Written memos"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Interrupting frequently", "Only hearing words", "Thinking about other things while someone speaks", "Paying full attention, understanding, and responding appropriately to the speaker"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Creative fiction about farming", "Clear, precise writing for professional/technical audiences (reports, manuals, research papers)", "Writing social media posts", "Writing poetry about crops"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["File complaints", "Apply for passports", "Present qualifications, experience, and skills to a potential employer", "Apply for loans"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Creative", "Complex", "Courteous", "Complicated"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["It is unnecessary noise", "It delays the message", "It is only for formal communication", "It confirms whether the message was understood and allows correction of misunderstandings"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Listening alone", "Communication skills, knowledge, leadership, and team behavior", "Writing ability only", "Only English vocabulary"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Topic sentence, supporting details, and a concluding sentence", "Random mix of sentences", "List of words", "Only examples"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Citing sources properly", "Copying others' work and presenting it as your own without acknowledgment", "Paraphrasing correctly", "Writing original content"],
    correct: 1,
  ...
  // ── LECTURE 7: Common Errors, Idioms, and Proverbs ────────────────────────
  {
    ...
    options: ["He is tall than his brother.", "He is more tall than his brother.", "He is most taller than his brother.", "He is taller than his brother."],
    correct: 3,
  ...
  },
  {
    ...
    options: ["accomodate", "accommadate", "acomodate", "accommodate"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["To work very hard", "To garden around trees", "To hunt animals", "To avoid coming directly to the point"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Physical actions make noise", "What you do is more significant than what you say", "Always shout your actions", "Words are always powerful"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Outdoors in rain", "Below average temperature", "Feeling ill/unwell", "Hiding from sun"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sewing is important", "Save time for stitching", "Timely action prevents bigger problems later", "Nine is a lucky number"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["'went' should be 'go' (didn't + base verb)", "No error", "'today' should be 'yesterday'", "'He' should be 'She'"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["interplay / balance", "conflict", "problem", "gap"],
    correct: 0,
