...
export const da101Questions: Question[] = [
  {
    ...
    options: ["Land and to study", "Soil and cultivation", "Field and to manage", "Crop and to grow"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Karnal, Haryana state", "Nagpur, Maharashtra state", "Hyderabad, Telangana state", "Cuttack, Orissa state"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Crop and to study", "Soil and cultivation practice", "Field and to manage", "Land and to grow"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Hyderabad, India", "Rome, Italy", "Aleppo, Syria", "Nairobi, Kenya"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Adilabad district of Telangana", "Nalgonda district of Telangana", "Medak district of Telangana", "Warangal district of Telangana"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["500–700 mm annually", "700–900 mm annually", "868–1124 mm annually", "1200–1400 mm annually"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Maximum ozone and photochemical reactions", "Hydrogen and helium as predominant gases", "Radio-reflecting ionised layers and ions", "Almost all water vapour, aerosols, and weather events"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["16 kilometers above sea level", "80 to 140 kilometers above sea level", "50 to 55 kilometers above sea level", "7 to 8 kilometers above sea level"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1°C per kilometer altitude", "6.5°C per kilometer altitude", "3.5°C per kilometer altitude", "10°C per kilometer altitude"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["80 to 140 kilometers altitude", "400 to 1000 kilometers altitude", "14 to 20 kilometers altitude", "50 to 55 kilometers altitude"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Long wave radiation from clouds", "Ultraviolet rays from the sun", "Visible light from the solar spectrum", "Infrared thermal radiation from earth"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["50 to 80 kilometers altitude", "80 to 400 kilometers altitude", "140 to 400 kilometers altitude", "20 to 50 kilometers altitude"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["78.09 percent by volume", "20.95 percent by volume", "75.53 percent by volume", "0.93 percent by volume"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Atmospheric pressure in millibars", "Hours of bright sunshine", "Wind velocity and direction", "Rainfall amount in millimeters"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Temperature fluctuations during daytime", "Length of night or dark period", "Solar radiation quality and wavelength", "Light intensity changes only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Long-day plant flowering in summer", "Short-day plant flowering in long nights", "Day-neutral plant unaffected by daylength", "Long-night neutral plant with open flowering"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0.7 to 3.0 microns wavelength", "3.0 to 10.0 microns wavelength", "0.005 to 0.4 microns wavelength", "0.4 to 0.7 microns wavelength"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1 percent of incident light", "20 percent of incident light", "5 percent of incident light", "10 percent of incident light"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["C = 5/9 multiplied by (F + 32)", "C = 9/5 multiplied by F minus 32", "C = (F + 32) multiplied by 9/5", "C = 5/9 multiplied by (F − 32)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["36 to 38°C maximum temperature", "30 to 32°C maximum temperature", "40°C maximum temperature", "40 to 43°C maximum temperature"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["24 hours since last setting", "12 hours since last setting", "6 hours since last setting", "48 hours since last setting"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Maximum thermometer", "Dry bulb thermometer", "Minimum thermometer", "Wet bulb thermometer"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Between 10 and 20°C with still air", "Below −10°C for 1 hour", "Between 0 and 10°C with moderate winds", "Above 45°C for 30 minutes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["30 minutes exposure time", "6 hours exposure time", "3 hours exposure time", "2 hours exposure time"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1050 millibars at sea level", "760 millibars at sea level", "980 millibars at sea level", "1013.25 millibars at sea level"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Hygrometer for pressure reading", "Barometer for pressure reading", "Psychrometer for pressure reading", "Anemometer for pressure reading"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["East wind", "West wind", "South wind", "North wind"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Wind vane instrument", "Barometer pressure instrument", "Sunshine recorder instrument", "Robinson's cup anemometer"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["15 kmph minimum speed", "30 kmph minimum speed", "8 kmph minimum speed", "50 kmph minimum speed"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["50 kmph strong wind", "15 kmph strong wind", "8 kmph strong wind", "30 kmph strong wind"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Volume of moist air sample", "Saturated vapour pressure in percentage", "Total mass of the air sample", "Dew point air temperature value"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Millibars of vapour pressure", "Grams per cubic meter dry air", "Volume of moist air (kg m⁻¹)", "Percentage of total air mass"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Difference between wet and dry bulb readings", "Absorption of moisture by chemical substance", "Variation in length of strand of human hair", "Variation in electrical resistance of sensor"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["150 cm diameter and 30 cm deep", "120 cm diameter and 25.2 cm deep", "60 cm diameter and 15 cm deep", "90 cm diameter and 20 cm deep"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["80 calories per gram", "270 calories per gram", "1000 calories per gram", "540 calories per gram"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["5 percent less than fresh water", "20 percent less than fresh water", "10 percent less than fresh water", "15 percent less than fresh water"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Season", "Cloud formation pattern", "Wind direction change", "Rain season incoming"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Campbell in year 1853", "Celsius in year 1742", "Fohlin in year 1700", "Halley in year 1636"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Goa in the month of July", "Tamil Nadu in the month of May", "Maharashtra in the month of June", "Kerala in the month of June"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["80 to 90 percent", "10 to 20 percent", "30 to 40 percent", "50 to 60 percent"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["June to September period", "April to June period", "January to March period", "October to mid-December period"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["10 mm of rainfall needed", "50 mm of rainfall needed", "20 mm of rainfall needed", "30 mm of rainfall needed"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["12 hours or less", "24 hours or less", "2 hours 30 minutes or less", "6 hours or less"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Land cools faster creating high continental pressure", "Ocean heats faster creating high pressure over ocean", "Mountain barriers deflect winds causing reversal pattern", "Heats faster than ocean creating low pressure over land"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Coimbatore, Tamil Nadu", "Lucknow, Uttar Pradesh", "Pusa, New Delhi", "Nagpur, Maharashtra"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Hyderabad, Telangana", "Coimbatore, Tamil Nadu", "Pusa, New Delhi", "Cuttack, Orissa"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Kanpur, Uttar Pradesh", "Jhansi, Uttar Pradesh", "Indore, Madhya Pradesh", "Jabalpur, Madhya Pradesh"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Jhansi, Uttar Pradesh state", "Bhopal, Madhya Pradesh state", "Hyderabad, Telangana state", "Jodhpur, Rajasthan state"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Bifurcation of Andhra Pradesh state in 2014", "Merger of ANGRAU research stations in 2012", "Reorganization of Telangana districts in 2016", "Formation of Telangana state in 2009"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Palem research station campus", "Polasa, Jagtial research station", "Rajendranagar research station campus", "Warangal research station campus"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sugarcane and wheat crops", "Maize and tobacco crops", "Rice, cotton, and sugarcane", "Horsegram and fodder crops"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Nagpur, Maharashtra state", "Jabalpur, Madhya Pradesh state", "Kanpur, Uttar Pradesh state", "Hyderabad, Telangana state"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Nagpur, Maharashtra state", "Coimbatore, Tamil Nadu state", "Kasargod, Kerala state", "Lucknow, Uttar Pradesh state"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["1827 in Calcutta", "1788 in Calcutta", "1871 in Calcutta", "1864 in Calcutta"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1975 first rice hybrid", "1986 first rice hybrid", "1998 first rice hybrid", "1993 first rice hybrid"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1986 establishment year", "1993 establishment year", "1982 establishment year", "1979 establishment year"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["1956 programme launch", "1960 programme launch", "1963 programme launch", "1966 programme launch"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Atmospheric pressure", "Rainfall amount", "Wind speed", "Temperature value"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["32°C optimum for sorghum", "25°C optimum for sorghum", "20°C optimum for sorghum", "29°C optimum for sorghum"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wheat with minimum 4.5°C", "Maize with minimum 8–10°C", "Sorghum with minimum 12–13°C", "Rice with minimum 10°C"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Transpiration process of heat transfer", "Radiation process of heat transfer", "Convection process of heat transfer", "Conduction process of heat transfer"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["All weather-related processes involve movement of molecules", "It occurs in vacuum without any medium", "It only operates in liquid water bodies", "Heat moves along solid bodies only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Both sides receive equal intensity", "Top of the mountain only", "Leeward side with high intensity", "Windward side with high intensity"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Temperate coastal areas", "Mountain range zones", "Polar regions of the earth", "Tropical regions of the earth"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Freeze into ice crystals immediately", "Stay suspended in the atmosphere", "Fall to the ground as rainfall", "Evaporate back into water vapour"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Windward current movement", "Leeward wind movement", "Backing wind movement", "Veering wind movement"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1971 programme year", "1974 programme year", "1970 programme year", "1965 programme year"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["80 to 140 kilometers altitude", "140 to 400 kilometers altitude", "50 to 80 kilometers altitude", "400 to 1000 kilometers altitude"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["6.5°C per 100 meters altitude", "1°C per 100 meters altitude", "3°C per 100 meters altitude", "5°C per 100 meters altitude"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Rome, Italy", "Aleppo, Syria", "Hyderabad, India", "Nairobi, Kenya"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Rome, Italy", "Ivory Coast, West Africa", "Nairobi, Kenya", "Aleppo, Syria"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Condensation of water vapour", "Precipitation from cloud droplets", "Transpiration from plant stomata", "Evaporation from water surface"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Ionosphere layer", "Mesosphere layer", "Stratosphere layer", "Troposphere layer"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Vindhya ranges mountain barrier", "Aravalli ranges mountain barrier", "Eastern Ghats mountain barrier", "Western Ghats mountain barrier"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Testing and developing farm implements", "Agricultural climate characterization and weather forecasting", "Seed research and seed technology only", "Biological control of crop pests"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["150 percent cropping intensity", "130 percent cropping intensity", "85 percent cropping intensity", "110 percent cropping intensity"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["25 percent net sown area", "14.35 percent net sown area", "40.68 percent net sown area", "30.3 percent net sown area"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wells followed by canals", "Canals followed by wells", "Tanks followed by rivers", "Borewells followed by lift irrigation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Maize pest management and integrated control", "Maize variety improvement and export quality", "Maize genetics and molecular breeding only", "Maize, maize cropping systems, and fodder maize"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Longitudinally due to temperature differences", "Horizontally from high pressure to low pressure", "Circularly around a low pressure centre", "Vertically from ground to upper atmosphere"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ionosphere or thermosphere layer", "Troposphere lowest layer", "Stratosphere second layer", "Ozonosphere or mesosphere layer"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Hyderabad, Telangana state", "Coimbatore, Tamil Nadu state", "Junagadh, Gujarat state", "Kanpur, Uttar Pradesh state"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Ionisation of gases and radio wave reflection", "No major movement of air at troposphere top", "Maximum ozone and photochemical reactions", "Maximum wind speeds and intense storm activity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ice crystal formation causing cell dehydration", "Low temperature accumulating toxins in roots", "Lifting plants upward causing roots to stretch or break", "High temperature causing stem scorching near soil"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Anticyclones on water", "Waterspouts on water", "Cyclones on water", "Typhoons on water"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Temperature inversion occurs on clear nights", "Cold rain is followed by evaporative cooling dry wind", "Temperature at the surface in an air mass is below freezing", "Dew point falls below 0°C on calm clear nights"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Building biomass through photosynthesis process", "Maintaining warmth to plant life", "Providing protection from harmful UV rays", "Transporting pollen between flowers"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Sugarcane, rice, and cropping systems", "Pulses, maize, and oilseeds", "Rice, sesame, water management", "Cotton, jowar, rainfed rice, and soybean"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Turmeric spice crop", "Cotton cash crop", "Sugarcane cash crop", "Tobacco cash crop"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["All three Telangana zones equally", "Southern Telangana Zone only", "Central Telangana Zone only", "Both Northern and Central Telangana Zones"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1956 year established", "1966 year established", "1963 year established", "1960 year established"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["22,000 thunderstorms per day", "88,000 thunderstorms per day", "44,000 thunderstorms per day", "4,400 thunderstorms per day"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Atmospheric variables collectively", "Agrometeorological indices collectively", "Weather factors collectively", "Climatic elements collectively"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Root damage due to physical abrasion", "Stem lodging and physical breakage", "Increased photosynthesis due to light scattering", "Stomata closure and plant suffocation"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Saidapet, Tamil Nadu", "Nagpur, Maharashtra", "Pusa, Bihar", "Coimbatore, Tamil Nadu"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Mumbai", "Hyderabad", "New Delhi", "Bangalore"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Dew point to dry bulb temperature × 100", "Actual vapour pressure to saturation vapour pressure × 100", "Saturation vapour pressure to actual vapour pressure × 100", "Amount of water vapour to total air volume × 100"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Crops are harvested", "Weeds benefit the crop", "Weeds cause maximum damage if not controlled", "Weed control has no effect on crop yield"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A water storage tank for irrigation", "A method of soil conservation", "A type of crop rotation", "An area that drains into a common outlet"],
    correct: 3,
...
D.  1972                         |  4.  ICRISAT established       |  iv.  Dryland crop research",
    options: ["A-3-i,  B-2-ii,  C-4-iii,  D-1-iv", "A-2-ii, B-3-iii, C-1-i,   D-4-iv", "A-1-i,  B-4-ii,  C-3-iii,  D-2-iv", "A-4-iv, B-1-i,   C-2-ii,   D-3-iii"],
    correct: 1,
...
D.  Exosphere                    |  4.  Above 400 km             |  iv.  H and He gases dominate",
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-4-iv, B-3-iii, C-1-i,   D-2-ii", "A-3-iii, B-2-ii, C-4-iv,   D-1-i", "A-2-ii, B-3-iii, C-1-i,   D-4-iv"],
    correct: 3,
...
D.  Campbell Stokes recorder     |  4.  Atmospheric pressure     |  iv.  hPa or mb",
    options: ["A-4-iv, B-3-iii, C-2-ii,  D-1-i", "A-2-ii, B-4-iv,  C-1-i,   D-3-iii", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-3-iii, B-1-i,  C-2-ii,   D-4-iv"],
    correct: 1,
...
D.  Minimum tillage              |  4.  Reduce soil disturbance  |  iv.  Strip till cultivator",
    options: ["A-1-i,  B-2-ii,  C-4-iii,  D-3-iv", "A-2-ii, B-1-i,   C-3-iii,  D-4-iv", "A-4-iv, B-3-iii, C-2-ii,   D-1-i", "A-3-iii, B-4-iv, C-1-i,    D-2-ii"],
    correct: 1,
...
D.  Transplanting                |  4.  All small grains         |  iv.  Uniform seed placement",
    options: ["A-2-ii,  B-1-i,   C-4-iv,   D-3-iii", "A-4-iv,  B-3-iii, C-1-i,    D-2-ii", "A-3-iii, B-4-iv,  C-2-ii,   D-1-i", "A-1-i,   B-2-ii,  C-3-iii,  D-4-iv"],
    correct: 2,
...
D.  Parasitic weed               |  4.  Striga asiatica          |  iv.  Orobanchaceae",
    options: ["A-1-i,  B-2-ii,  C-4-iv,   D-3-iii", "A-4-iv, B-3-iii, C-2-ii,   D-1-i", "A-2-ii, B-1-i,   C-3-iii,  D-4-iv", "A-3-iii, B-4-iv, C-1-i,    D-2-ii"],
    correct: 2,
...
D.  Quizalofop                   |  4.  Selective pre-emergence   |  iv.  Used in maize",
    options: ["A-4-iv, B-3-iii, C-2-ii,   D-1-i", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-2-ii, B-1-i,   C-4-iv,   D-3-iii", "A-3-iii, B-4-iv, C-1-i,    D-2-ii"],
    correct: 2,
...
D.  Drip irrigation              |  4.  40-50%                   |  iv.  Flat land, heavy soils",
    options: ["A-4-iv, B-3-ii,  C-2-iii,  D-1-i", "A-2-ii, B-1-i,   C-4-iv,   D-3-iii", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-3-iii, B-4-iv, C-1-i,    D-2-ii"],
    correct: 0,
...
D.  Terrace farming              |  4.  Engineering measure      |  iv.  Steep slope water erosion",
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-3-ii, B-1-i,   C-2-iii,  D-4-iv", "A-4-iv, B-1-i,   C-3-iii,  D-2-ii", "A-2-ii, B-3-i,   C-1-iii,  D-4-iv"],
    correct: 1,
...
D.  Drying                       |  4.  Reducing moisture content  |  iv.  Sun drying floor",
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-2-ii, B-3-iii, C-1-i,   D-4-iv", "A-4-iv, B-1-i,   C-2-ii,   D-3-iii", "A-3-iii, B-4-iv, C-2-ii,   D-1-i"],
    correct: 1,
