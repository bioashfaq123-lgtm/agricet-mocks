...
export const da241LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["Total exports only for farm income analysis for crop production", "Total agricultural output in the agricultural economy in agriculture", "Total foreign debt in rural economic context under field conditions", "Total value of all goods and services produced in a country in a year"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Fixed costs decrease with output for farm income analysis for crop production", "Supply always equals demand in the agricultural economy in agriculture", "Output always increases with more inputs in rural economic context under field conditions", "As more of a variable input is added to fixed inputs, marginal product eventually decreases"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Fixed prices in the agricultural economy in agriculture", "Cyclical price fluctuations due to lag between planting and harvesting decisions", "Government pricing policy in rural economic context under field conditions", "Long-run equilibrium for farm income analysis for crop production"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Total expenditure on a good in the agricultural economy", "Producer's profit for farm income analysis under field conditions", "Market surplus of goods in rural economic context in agriculture", "Difference between what consumer is willing to pay and what they actually pay"],
    correct: 3,
  ...
  // ── LECTURE 4: Farm Management and Agricultural Marketing ─────────────────
  {
    ...
    options: ["Management of farm workers in the agricultural economy in agriculture", "The science and art of organizing and operating a farm for maximum profit", "Government farm policy in rural economic context under field conditions", "Study of crop production only for farm income analysis for crop production"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Farm production only in the agricultural economy in agriculture", "All business activities involved in the flow of goods from producer to consumer", "Import of agricultural products in rural economic context under field conditions", "Farm subsidies for farm income analysis for crop production"],
    correct: 1,
  ...
  // ── LECTURE 10: Sustainable Agriculture Economics ─────────────────────────
  {
    ...
    options: ["Farm input costs in the agricultural economy in agriculture", "Direct farm subsidies in rural economic context under field conditions", "Export revenues for farm income analysis for crop production", "Costs or benefits not reflected in market prices (pollution, soil degradation)"],
    correct: 3,
...

  {
    ...
    options: ["Building in the agricultural economy", "Seeds stored for next season", "Land in rural economic context", "Services of a labourer on a particular day"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Cobb-Douglas function", "Constant returns production", "Long run production function", "Short run production function"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Total product x Total input", "Marginal product / Total input", "Change in total product / Change in input", "Total product / Total input (Y/X)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Total physical product expressed in monetary value", "Marginal product multiplied by price of input", "Total revenue minus total cost", "Average product at maximum output"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Law of Returns to Scale", "Law of Diminishing Utility", "Law of Proportionality", "Law of Comparative Advantage"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Homogeneous factor inputs", "Constant technology", "Long-run planning period", "Factor proportions are variable"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Total Product is maximum", "Marginal Product equals Average Product", "Marginal Product is maximum", "Marginal Product is zero"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Between 0 and 1", "Equal to 1", "Greater than 1", "Negative"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Stage I and Stage II both", "Stage I - where MPP > APP", "Stage II - where MPP < APP and TPP increases", "Stage III - where MPP is negative"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Average product to marginal product squared", "Change in revenue to change in cost", "Marginal Physical Product to Average Physical Product", "Total product to total input"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-2-i, B-1-ii, C-4-iii, D-3-iv", "A-3-i, B-2-ii, C-1-iii, D-4-iv", "A-1-ii, B-2-i, C-3-iv, D-4-iii", "A-1-i, B-2-ii, C-3-iii, D-4-iv"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A cafe where more cooks in small space inhibit efficiency", "A factory using bulk purchasing to reduce costs", "A motor vehicle factory splitting workers for specialization", "A pharmaceutical company sharing research costs with a university"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["The actual cash expenditure on farm inputs in rural economic context", "The depreciation on farm machinery in the agricultural economy", "The value of return sacrificed from the next best alternative activity", "The cost of hired labour on the farm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Implicit costs and explicit costs in rural economic context", "Fixed costs and indirect costs in the agricultural economy", "Working costs, operating costs, direct costs and prime costs", "Overhead costs and sunk costs for farm income analysis"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["An inverse S-shaped curve", "A U-shaped curve in the agricultural economy", "A downward sloping hyperbola", "A horizontal straight line parallel to X-axis"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["TFC / Q in the agricultural economy in agriculture", "( TFC + TVC) / Q for farm income analysis for crop production", "TVC / Q in rural economic context under field conditions", "Change in TC / Change in Q"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["MR = AR + (e/(e-1))", "e = AR x MR", "AR = MR + e", "MR = AR x (e-1)/e"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["The minimum points of all short run average cost curves", "A single short run average cost curve", "An entire family of Short Run Average Cost (SAC) curves", "Only the long run marginal cost curves"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Each for one and one for each", "One for all and none for one", "Each for all and all for each", "Together we stand divided we fall"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["French cooperative model", "Raiffeissen model from Germany", "American credit union model", "British Rochdale model"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Modification phase", "Initiation phase", "Golden Era", "Restructuring phase"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-2-i, B-1-ii, C-4-iii, D-3-iv", "A-3-i, B-4-ii, C-2-iii, D-1-iv", "A-1-ii, B-2-i, C-3-iv, D-4-iii", "A-1-i, B-2-ii, C-3-iii, D-4-iv"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Credere", "Creditus", "Credo", "Creditum"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["18 months to 5 years", "6 to 18 months", "5 to 10 years", "3 to 6 months"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Transferred to government warehouses", "Kept with the farmer who uses it as collateral", "Kept under the control of lending institutions", "Sold immediately to repay the loan"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["4% per annum", "8% per annum", "2% per annum", "6% per annum"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Rs. 10 crores", "Rs. 5 crores", "Rs. 1 crore", "Rs. 50 crores"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["One entry (debit only)", "Two entries (debit and credit)", "One entry (credit only)", "Three entries"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Triple entry system", "Double entry system", "Single entry system", "Cash basis only system"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Less than 750 mm per annum", "Between 750 mm and 1150 mm", "Less than 500 mm per annum", "More than 1150 mm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["At least 5% but not more than 25%", "At least 50% but not more than 90%", "At least 25% but not more than 75%", "At least 10% but not more than 49%"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["It should be written and flexible", "It should be based only on short-term goals", "It should be oral and informal", "It should be rigid and unchangeable"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["On some specified date in the future", "Immediately after the sale (spot market)", "After payment of full price upfront", "Through barter without money"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Seasonality of production", "Small size of holdings", "Perishability of the product", "Bulkiness of products"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Absolutely, without any conditions in the agricultural economy", "Plus or minus the cost of transport between surplus and deficit areas", "Only when government fixes them in rural economic context", "Only during peak seasons for farm income analysis"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["One government supplier of fertilizers in the agricultural economy", "Two companies selling the same pesticide in rural economic context", "Government price control on all inputs for farm income analysis", "Multiple brands of insecticides, pump sets, fertilizers at different prices"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Settling prices by pressing/twisting fingers under cloth using code symbols", "Sample quotation method where agent visits buyers", "Open auction where highest bidder wins in the agricultural economy", "Fixed price sales determined by government in rural economic context"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Private negotiations method", "Open auction method", "Dara sale method", "Hatha system"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Time utility", "Possession utility", "Form utility", "Place utility"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["32 regional offices", "17 regional offices", "25 regional offices", "10 regional offices"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["National Agricultural Credit Committee", "State Level Bankers Committee (SLBC)", "District Level Technical Committee (DLTC)", "Reserve Bank of India directly"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Pune, Maharashtra", "Kandla, Gujarat", "Hyderabad, Andhra Pradesh", "Chennai, Tamil Nadu"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["1965 at Hyderabad", "1967 at Poona", "1975 at Mumbai", "1970 at Delhi"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["BEP = F / (P-V)", "BEP = F x P x V", "BEP = (F+V) / P", "BEP = P / (F-V)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["A test of arithmetic accuracy of postings in the ledger", "A forecast of future farm income in the agricultural economy", "A record of daily transactions in rural economic context", "A summary of all income and expenses"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Mixed farming with both crops and animals", "Intensive dairy farming in the agricultural economy", "Grazing of livestock on public pastures not fit for cultivation", "Growing crops on terraced hill areas in rural economic context"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Market price plus commission", "Government notified prices only", "Reasonable prices", "Import parity prices"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["International agricultural credit transactions for farm income analysis", "Financial management of individual farm business units in the agricultural economy", "Personal loans of farmers for household needs in rural economic context", "Total credit needs of agricultural sector, terms and methods of use of total credit"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["50% of outstanding advances", "75% of outstanding advances", "100% of outstanding advances", "25% of outstanding advances"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["P x Q in the agricultural economy in agriculture", "TR - TC for farm income analysis for crop production", "TR/Q in rural economic context under field conditions", "Change in TR / Change in Q (or TRn - TRn-1)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Providing long-term loans to state governments for cooperative societies", "Granting medium-term loans to State Cooperative Banks during natural calamities", "Capitalization of NABARD in the agricultural economy", "Financing individual farmers directly in rural economic context"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Cannot be divided into smaller units and hence are used in whole numbers", "Are always fixed in the short run in the agricultural economy", "Have constant marginal productivity in rural economic context", "Can be divided into smaller doses and measured continuously"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Time utility", "Possession utility", "Place utility", "Form utility"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A horizontal (perfectly elastic) straight line at the market price", "Upward sloping showing increasing revenue in the agricultural economy", "Downward sloping like the market demand curve", "Vertical (perfectly inelastic) line in rural economic context"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Quality variation and grading for farm income analysis", "Perishability and decay rate in the agricultural economy", "Price determination in forward markets in rural economic context", "Transportation and storage costs (restricting location to near consumption areas)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-1-ii, B-2-i, C-3-iv, D-4-iii", "A-3-i, B-4-ii, C-2-iii, D-1-iv", "A-1-i, B-2-ii, C-3-iii, D-4-iv", "A-2-i, B-1-ii, C-4-iii, D-3-iv"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sri. B. Sivaraman", "Prof. D.R. Gadgil", "Sri. F.K.F Nariman", "Sri. A.D. Gorwala"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Reducing number of workers in the agricultural economy", "Improving efficiency of production processes and investing in efficient equipment", "Government tax incentives for farm income analysis", "External economies with university partnerships in rural economic context"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only rural cooperatives", "Only urban cooperatives with non-agriculturists", "Only credit cooperatives", "All types of cooperatives"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["High interest rates in the agricultural economy", "Excessive government control in rural economic context", "Lack of demand for cooperative credit", "Laissez-faire policy of Government and illiteracy of people"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["The time required for a resource to be completely transformed into a product", "The market period for selling farm produce in the agricultural economy", "The time between planting and harvesting in rural economic context", "The planning period for farm management for farm income analysis"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Support household consumption needs of farmers in the agricultural economy", "Help farmers overcome distress sales and market produce at remunerative prices", "Purchase tractors and tube wells in rural economic context", "Fund farm production operations for farm income analysis"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Marginal Product becomes zero in the agricultural economy", "Marginal Product equals Average Product (APP is maximum)", "Total Product is maximum in rural economic context", "Average Product becomes zero for farm income analysis"],
    correct: 1,
