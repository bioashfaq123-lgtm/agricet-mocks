...
export const da241LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["TFC / Q in the agricultural economy in agriculture", "( TFC + TVC) / Q for farm income analysis for crop production", "TVC / Q in rural economic context", "Change in TC / Change in Q"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["P x Q in the agricultural economy in agriculture", "TR - TC for farm income analysis for crop production", "TR/Q in rural economic context", "Change in TR / Change in Q (or TRn - TRn-1)"],
    correct: 3,
