...
export const da111Questions: Question[] = [
  {
    ...
    options: ["Cultivating plants using modern irrigation methods", "Applying fertilizers for maximum crop production", "Studying the ecology of wild plant species", "Improving the genetic make-up of plants for human use"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Selection of plants from natural habitats", "Mutation breeding of crop plants", "Domestication of wild plant species", "Hybridization of wild plants with cultivated ones"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["1900 by scientists working with pea plants", "1902 by Sutton and Boveri in chromosomes", "1850 as published by Mendel in journal", "1850 by Gregor John Mendel in Vienna"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Watson and Crick, who described DNA structure", "Hugo de Vries, who discovered plant mutations", "Charles Darwin, who proposed natural selection theory", "Gregor Mendel, who studied pea plant genetics"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Oenothera Lamarkiana (Evening Prime Rose)", "Nicotiana tabacum (Tobacco) plants", "Zea mays (Maize) plants", "Pisum sativum (Garden Pea) plants"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Gregor Mendel in the year 1850", "Watson and Crick in year 1953", "Hugo de Vries in the year 1900", "Sutton and Boveri in the year 1902"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Fraenkel-Conrat who proposed RNA structure", "Nirenberg and Khorana for nucleic acid code", "Watson and Crick in the year 1953", "Hugo de Vries and Stadler in mutation work"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Varieties requiring more crop management period", "Long duration varieties for maximum biomass yield", "Late maturing varieties to increase crop duration", "Early maturing varieties permitting new crop rotations"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["360 days to 270 days through intensive selection", "200 days to 100 days by developing early varieties", "270 days to 170 days through breeding programs", "270 days to 120 days by hybridization method"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Gossypium hirsutum (Cotton) seed kernel", "Groundnut (Arachis hypogaea) seed pods", "Khesari (Lathyrus sativus) food legume crop", "Brassica sp. causing harmful erucic acid"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Androecium consisting of male reproductive parts", "Gynoecium with stigma, style and ovary parts", "Corolla consisting of brightly coloured petals", "Calyx consisting of sepals protecting the bud"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Corolla of brightly coloured attractive petals", "Calyx composed of green protective sepals", "Gynoecium with stigma, style and ovary", "Androecium containing microsporangia in anthers"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Gymnosperms such as pine and cycads only", "Fungi such as mushrooms and bread mold", "Ferns and mosses in moist environments", "Angiosperms only among all plant groups"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Filament of stamen connecting to anther", "Style connecting ovary to the stigma", "Pollen tube entering the embryo sac", "Ovules inside the ovary wall surface"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Two microspores through first meiotic division", "Eight microspores from two meiotic divisions", "Four microspores that become pollen grains", "Six microspores arranged in two triplets"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Three degenerate leaving one functional megaspore", "Two megaspores develop into functional embryos", "Three megaspores develop into endosperm cells", "All four megaspores develop into embryo sacs"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Integument protecting the embryo sac tissue", "Embryo sac or megagametophyte structure", "Nucellus tissue enclosing the ovule body", "Perisperm residual tissue in mature seed"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Paddy, Maize and Castor as examples", "Sunflower, Sesame and Mustard as examples", "Pea, Beans and Chick Pea as examples", "Wheat, Jowar and Barley as examples"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Anther to stigma of the same flower itself", "One flower to flowers on the same plant", "Anther to stigma of flowers of another plant", "Wind blown pollen to distant plant stigmas"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Stigmas of other flowers of the same plant", "The stigma of flowers of a different species", "The stigma of a genetically different plant", "Stigmas only in insect-pollinated crop plants"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Pistil matures before anthers in the flower", "Spatial separation of stigma and anthers always", "Anthers mature before pistil in the flower", "Simultaneous maturation of anthers and stigma"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Functional pollen to fertilize the same flower", "Stigma to become receptive in self pollinated crops", "Pollen release from anthers in bisexual flowers", "Anther formation during early flower development"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Wind called anemophily in paddy crops", "Insects called entomophily in Cestrum plants", "Birds called ornithophily in Bignonia plants", "Water called epihydrophily or hypohydrophily"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Formation of embryo sac from megaspore", "Growth of pollen tube in the style", "Sexual fusion or fertilization of gametes", "Formation of ovule inside the ovary"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Diploid cells of nucellus or integuments", "Megaspore mother cell after meiotic division", "Unfertilized egg cell of the embryo sac", "Synergids or antipodal cells only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Sunflower, where seeds are the economic product", "Maize, where both grain and fodder are needed", "Onion, where vegetative part is the economic product", "Bajra, where grains are the economic product"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Bajra, Carrot, Chillies, Maize, Wheat and Sunflower", "Tomato, Barley, Brinjal, Paddy and Soybean", "Onion, Garlic, Carrot, Radish and Beet crops", "Cotton, Sunflower, Groundnut and Sesame crops"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Horizontally just below or on the ground surface", "Above ground as horizontal stem rooting at nodes", "Upward as an aerial stem producing bulbils", "Vertically underground storing food in tubers"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Bulbs that consist predominantly of modified leaves", "Tubers with nodes arranged spirally for budding", "Canes or setts used for vegetative multiplication", "Suckers arising from underground stem parts"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Taxus baccata from the Taxaceae conifer family", "Atropa belladonna from the Solanaceae family", "Datura stramonium in the Solanaceae family", "Colchicum autumnale belonging to the Liliaceae family"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Tetraploid species with four genome sets", "Diploid species with two complete genomes", "Triploid hybrid produced for sterile fruit", "Hexaploid species with six genome sets"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Triticum aestivum and Hordeum vulgare barley", "Triticum sp. and Secale cereale (rye) species", "Avena sativa and Avena byzantina oat species", "Oryza sativa and Oryza perennis rice species"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Self-pollinated crops like paddy and wheat", "Vegetatively propagated crops like potato", "Apomictic crops like citrus and mango", "Cross pollinated crops like cotton and bajra"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Eight years as in mass selection method", "Ten years as in pure line selection method", "Five years for identification and release", "Nine years from selection to variety release"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A research station for genetic improvement work", "A new place where it was not previously grown", "A hybridization program for crossing purposes", "A selection program for purifying existing variety"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["DNA replication during the S phase of cell cycle", "Protein synthesis in the ribosomal machinery", "Chromosome replication in dividing plant cells", "Spindle fibre formation during anaphase of meiosis"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Father of Genetics for his landmark research", "Father of Plant Tissue Culture for his 1902 work", "Father of Plant Breeding for his contributions", "Father of Mutation Breeding for mutation work"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Divide rapidly on any type of culture medium", "Produce secondary metabolites in liquid medium", "Resist viral and bacterial pathogens in culture", "Give rise to a whole plant regardless of ploidy"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Endosperm culture to produce triploid plants", "Anther culture for production of haploid plants", "Protoplast fusion for somatic hybridization", "Meristem culture as meristems are virus-free"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Meristem culture in aseptic tissue conditions", "Protoplast fusion or somatic hybridization method", "Anther culture using haploid pollen grains", "Embryo rescue technique to overcome barriers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Female parent variety is included as standard", "Improved variety is included as a second check", "Check variety is included but it is not replicated", "Male parent variety is included for comparison"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Two seasons at two or more locations", "Five seasons at multi-location research stations", "Three seasons with one or more check varieties", "One season at a single research location"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Deputy Director General (Crop Science), ICAR", "Director of Agriculture of the concerned State", "Production Commissioner, Government of India", "Director High Yielding Varieties Programme"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Director of Research of State Agriculture University", "Director of State Seed Certification Agency", "Director of Agriculture for field crops only", "Deputy Director General (Crop Science), ICAR"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Multiple embryos from polyembryony phenomenon", "Fleshy pericarp tissue for seed dispersal", "A store of food surrounded by a protective coat", "Endosperm tissue only without any seed coat"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Blue (azure blue shade ISI No. 104) colour", "Golden yellow tag issued by producing agency", "White colour tag issued by Seed Certification Agency", "Opel green colour for truthfully labeled seed"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Opel green colour for truthful labeling purposes", "Golden yellow colour tag by producing agency", "White colour issued by seed certification agency", "Blue colour as ISI standard azure blue shade"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Apomictic crops like mango and citrus trees", "Cross fertilized crops like maize and bajra", "Vegetatively propagated crops like potato", "Self-pollinated crops like paddy and groundnut"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Time of applying pesticides and fungicides", "Time of irrigation during the crop season only", "Time of sowing using the same drill for varieties", "Time of applying fertilizers during crop growth"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["3 meters generally for foundation and certified seed", "200 meters for certified seed production fields", "400 meters for foundation seed production fields", "100 meters for both seed production classes"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["7 days ahead of contaminating crop fields", "21 days ahead of the contaminating maize crops", "35 days ahead of the contaminating crop fields", "14 days ahead of the contaminating crop fields"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Pollen shedders from both male and female rows", "Weed plants from around the seed crop boundary", "Diseased plants only from the seed crop field", "Off-type plants phenotypically different from variety"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["20 chromosomes as in maize crop plants", "22 chromosomes found in many diploid crops", "24 chromosomes in the rice plant genome", "26 chromosomes in the diploid genome"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["60 minutes under normal field temperature", "10 minutes under field temperature conditions", "45 minutes at peak flowering time daily", "30 minutes under humid field conditions"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["60 to 70 percent for anther dehiscence", "50 to 60 percent for stigma receptivity", "40 to 50 percent for optimal pollen viability", "70 to 80 percent for optimal seed setting"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["F1 hybrid to maintain the male sterile trait", "Any commercial variety for hybrid seed production", "B-line or maintainer line for A-line maintenance", "R-line restorer to produce male fertile hybrids"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["2:1 (female:male) standard ratio for all hybrids", "6:2 (female:male) for maximum seed production", "4:2 (female:male) ratio for higher seed yield", "8:2 (A-line:R-line) currently adopted in practice"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1.05 using 150g of salt per 1000 ml water", "1.00 which is plain water without any salt", "1.10 using 200g of salt per 1000 ml water", "1.03 using 120g of salt per 1000 ml water"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Suppress weed growth in the seed production field", "Fully exert panicles from flag leaves for pollination", "Increase tillering for more productive panicles", "Reduce plant height for better lodging resistance"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["24 chromosomes as in related grass species", "28 chromosomes as in many hybrid corn types", "20 chromosomes as a diploid monoecious crop", "14 chromosomes as in barley crop species"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cleistogamy where flowers never open at all", "Protandry where anthers mature before pistil", "Protogyny where pistil matures before anthers", "Homogamy where both mature simultaneously"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Leaves from the plant for better light penetration", "Roots from the plant for replanting seedlings", "Male inflorescence (tassel) from the female parent", "Female inflorescence (cob) from the female plant"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["300 meters for foundation and 200m certified", "600–1000 meters for A-line maintenance seed", "50 meters for foundation and 30m certified seed", "200 meters for foundation and 100m certified"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reduction in isolation distance requirements", "Synchronization of flowering between male and female", "Higher fertilizer utilization by both parental lines", "Better weed control in the seed production field"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Short term storage: 6 to 8% moisture level", "Long term storage: 15 to 17% moisture content", "Long term Storage: 6–8% moisture content", "Long term storage: 10 to 13% moisture content"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["75% germination as the minimum standard", "80% germination as the minimum standard", "85% germination as the minimum standard", "90% germination as the minimum standard"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Convolvulus arvensis found in wheat fields", "Argemone mexicana found in mustard crop", "Wild paddy (Oryza sativa var. Fatua) rice weed", "Chicory (Chicorum intybus) found in berseem"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sepals, Petals, Stamens, Carpels", "Perianth, Stamen, Pistil, Bract", "Calyx, Androecium, Gynoecium, Receptacle", "Root, Stem, Leaves, Flower"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Deterioration of F1 generation", "Equal performance of F1 and parents", "Superiority of F1 hybrid over both parents", "Superiority of parents over F1"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["State seed committee guidelines", "ISTA rules", "NSC standards only", "AOSA rules"],
    correct: 1,
