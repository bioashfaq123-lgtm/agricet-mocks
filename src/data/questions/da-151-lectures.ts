...
export const da151LectureQuestions: Question[] = [
  ...
  // ── Lecture 1: Farm Power Sources ──────────────────────────────────────────
  {
    ...
    options: ["1000 watts", "746 watts", "550 watts", "1341 watts"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["2–5 HP", "25–35 HP", "15–20 HP", "8–12 HP"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Joule (J)", "Horsepower (HP)", "Kilowatt (kW)", "Newton (N)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Diesel engines", "Electric motors", "Solar energy", "Bullock draft power"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["4–5 ha/day", "0.5–0.75 ha/day", "2–3 ha/day", "1–1.5 ha/day"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Operating mould board ploughs", "Pumping irrigation water via solar pumps", "Running combine harvesters", "Powering grain combine threshers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Diesel engine", "Electric motor", "Petrol engine", "Bullock pair"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["0.1 HP for 8 hours", "0.5 HP for 8 hours", "0.05 HP for 8 hours", "1.0 HP for 8 hours"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Petrol engine (25–32%)", "Electric motor (85–95%)", "Steam engine (15–20%)", "Diesel engine (32–38%)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["1 kW = 0.746 HP", "1 kW = 0.5 HP", "1 kW = 2.0 HP", "1 kW = 1.341 HP"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Seed sowing", "Lifting water from wells", "Combine harvesting", "Primary tillage"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["2.5 kW/ha", "0.5 kW/ha", "1.5 kW/ha", "4.0 kW/ha"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Solar radiation to electricity", "Crop residues to ethanol", "Wind energy to mechanical power", "Organic waste to methane for cooking/power"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Engine torque at the crankshaft", "Total weight of the implement", "Vertical force on the tractor rear axle", "Horizontal pull required to move an implement through soil"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Orchards requiring canopy management", "Large farm holdings of 10+ ha", "Dryland farms needing deep tillage", "Small and marginal farms with wet paddy fields"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["High Speed Diesel (HSD)", "Petrol", "LPG", "CNG"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["540 RPM at 21-spline shaft", "540 RPM at 6-spline shaft", "750 RPM at 6-spline shaft", "1000 RPM at 6-spline shaft"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Has lower purchase cost", "Consumes less fuel per hour", "Provides better traction in wet and heavy soils", "Is lighter and easier to manoeuvre"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Above 75 HP", "20–35 HP", "Below 20 HP (mini tractors)", "36–50 HP"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["PTO shaft", "Engine crankshaft", "Belt pulley mounted on the tractor", "Drawbar"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["500–800 RPM", "1800–2200 RPM", "1200–1500 RPM", "3000–3600 RPM"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Providing traction in soil", "Reducing road damage", "Lowering fuel consumption", "Reducing tractor weight"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["25–30% for maximum grip", "50% for maximum drawbar pull", "0% for best efficiency", "8–12% for optimum traction efficiency"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Land levellers only", "Trailed disc ploughs only", "Passive implements like mould board plough", "Rotary implements requiring external power (rotavator, sprayer, combine)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Matching tractor size to farm area and implement requirements", "Fuel tank capacity", "Number of gears in the transmission", "Colour and brand of the tractor"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Type of crops grown", "Colour of the tractor body", "Type of implements to be used", "Farm size and topography"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Drawbar HP includes additional fuel consumption", "Drawbar is operated at higher speeds", "Transmission losses, rolling resistance and implement weight reduce available power at drawbar", "Engine HP does not include governor losses"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Orchards, vegetable gardens and small plots", "Large wheat farms > 10 ha", "Deep subsoiling operations", "Commercial sugarcane harvesting"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Orchard spraying", "Light vegetable farming", "Waterlogged paddy fields and heavy clay soils", "Road transport of farm produce"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["To drive the PTO shaft", "To attach and hydraulically control mounted implements", "To connect the trailer for road transport", "To apply brakes on all four wheels"],
    correct: 1,
  ...
  // ── Lecture 3: Tractor Engine & Systems ─────────────────────────────────────
  {
    ...
    options: ["Suction → Power → Compression → Exhaust", "Power → Suction → Compression → Exhaust", "Compression → Suction → Power → Exhaust", "Suction → Compression → Power → Exhaust"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Oil cooling only", "Evaporative cooling", "Air cooling only", "Water (liquid) cooling with radiator"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Equal power to both rear wheels at all times", "Automatic gear changes based on load", "The PTO to operate independently of ground speed", "Both rear wheels to rotate at different speeds while turning"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["25:1 to 30:1", "6:1 to 8:1", "16:1 to 22:1", "10:1 to 12:1"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Filter impurities from diesel", "Pressurise the crankcase", "Deliver metered, high-pressure fuel to injectors at correct timing", "Cool the fuel before combustion"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Better suited for high ambient temperatures", "Simpler, lighter and require less maintenance", "More powerful than water-cooled", "More fuel efficient"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Clutch", "Differential", "Final drive", "Gearbox"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Reduce friction, prevent wear, cool components and seal piston rings", "Increase fuel efficiency by burning oil", "Cool the engine only", "Clean the air filter"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["PTO speed varies with ground speed", "PTO is driven by a separate small engine", "PTO operates only when the tractor is moving", "PTO can be engaged/disengaged independently of the clutch"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Its speed is proportional to forward speed of the tractor", "It has no safety guards", "It runs at 540 RPM always", "It requires a separate diesel engine"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Prevent engine from overheating by releasing coolant to the atmosphere", "Measure fuel temperature before injection", "Maintain optimum engine operating temperature by regulating coolant flow", "Control the speed of the cooling fan"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Controls the hydraulic system", "Drives the PTO shaft", "Further reduces speed and increases torque to the rear axle", "Transfers power from the engine to the gearbox"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Reduce engine noise", "Cool the engine oil", "Improve fuel filtration", "Increase power output by forcing more air into the cylinders"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Suction stroke", "Exhaust stroke", "Power/expansion stroke", "Compression stroke"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cooling the engine", "Filtering the fuel", "Starting the engine", "Lifting and controlling mounted implements"],
    correct: 3,
  ...
  // ── Lecture 4: Primary Tillage Implements ───────────────────────────────────
  {
    ...
    options: ["Penetrating the soil vertically", "Cleaning the plough share", "Inverting, turning and pulverising the furrow slice", "Cutting the furrow slice from the side"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Angle between successive discs", "Angle of the plough with the soil surface", "Angle of tilt of the disc from vertical", "Angle between disc face and vertical plane parallel to direction of travel"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Forming ridges and furrows", "Harrowing and clod breaking", "Breaking hard pan and compacted layers below normal ploughing depth", "Surface tillage and seedbed preparation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Heel → Share → Mould board → Beam", "Share → Mould board → Land side → Heel → Beam", "Share → Mould board → Land side → Furrow wheel", "Beam → Mould board → Share → Land side"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5–10 cm", "30–50 cm", "15–25 cm", "10–15 cm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Lighter soil type", "Smaller plough share", "Decreasing ploughing depth", "Increasing ploughing speed and depth"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Requires no tractor to operate", "Can only operate in paddy fields", "Leaves crop residues on the surface and does not invert the soil", "Inverts the soil completely"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Support the rear of the plough on the road", "Attach the plough to the tractor", "Guide the plough into the next furrow and control ploughing width", "Pulverise clods behind the plough"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Chisel plough", "Disc plough", "Rotary plough", "Mould board plough"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Cutting and lifting the furrow slice from the bottom", "Pressing the soil to form a firm seedbed", "Supporting the plough body", "Turning the soil upside down"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Disc plough", "Mould board plough", "Chisel plough", "Subsoiler"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0° (vertical)", "60–75°", "5–15°", "30–45°"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cultivation between crop rows during the season", "The first tillage to open the soil after harvest to a good depth", "Tillage done with hand tools only", "Fine seedbed preparation after primary tillage"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lateral (sideways) displacement of the plough in the furrow", "The share from wearing too fast", "Vertical penetration of the share", "The furrow slice from crumbling too much"],
    correct: 0,
  ...
  // ── Lecture 5: Secondary Tillage & Intercultivation ─────────────────────────
  {
    ...
    options: ["Tandem is pulled by animals; offset is tractor-drawn", "Tandem discs are flat; offset discs are concave", "Tandem has all discs in one gang; offset has discs in two gangs set at opposite angles", "Tandem has two gangs in line (front gang throws soil outward, rear throws inward); offset has the gangs shifted to one side"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Only works in dry conditions", "Performs primary and secondary tillage in a single pass", "Requires no tractor PTO connection", "Uses a cutter bar to slice crop residues"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wet paddy field intercultivation", "Primary tillage after harvest", "Stony or hard soils where tynes might break", "Deep ploughing operations"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Break subsoil hardpan", "Turn and invert the soil for pest control", "Form drainage channels", "Prepare a fine seedbed, incorporate fertilisers and control weeds"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["To remove large stones from the field", "To form raised beds for vegetable crops", "To smooth and level the field surface for uniform irrigation", "To cut soil to uniform depth for planting"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["At harvesting time to loosen the soil", "After sowing, between rows, to control weeds and aerate the soil", "Before sowing for seedbed preparation", "During the first irrigation for soil cracking"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Levelling the field before sowing", "Harvesting root crops", "Primary deep ploughing", "Forming ridges and furrows for planting row crops and irrigation"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["15–22 cm", "60–90 cm", "30–45 cm", "120–150 cm"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Number of discs in the gang", "Diameter of discs and angle at which they are set", "Length of the harrow frame", "Speed of the tractor only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vegetable bed preparation", "Dry land wheat cultivation", "Wet paddy field preparation (puddling)", "Oilseed crop sowing"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Rotary tiller", "Roller/clod crusher", "Disc plough", "Subsoiler"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Number of workers available", "Colour of the soil", "Brand of tractor used", "Initial clod size, soil moisture content and required seedbed fineness"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Increase tractor usage", "Invert soil for better weed burial", "Reduce soil disturbance, conserve moisture and reduce erosion", "Maximise number of tillage passes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Mouldboard plough", "Power harrow", "Subsoiler", "Rotary hoe"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Cuts weeds below the surface without disturbing the soil much", "Pulverises surface into fine tilth", "Cuts soil deep and inverts it", "Creates ridges for irrigation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Removing excess soil from roots", "Aerating roots by removing soil", "Building up soil around the base of sugarcane plants to support stalks and cover fertiliser", "Making ridges for drainage only"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Plough deep before sowing", "Plant rice seedlings in puddle mud", "Sow seeds directly into undisturbed crop residue without prior tillage", "Apply fertiliser without seeds"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["15 × 10 cm", "30 × 15 cm", "20 × 15 cm", "45 × 20 cm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Changing tractor speed only", "Adjusting the furrow opener angle", "Changing seed hopper size", "Varying the exposed length of the fluted roller or changing the gear ratio on ground wheel"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Sows seeds in rows at uniform spacing", "Sows only in puddled soils", "Broadcasts seeds uniformly", "Places individual seeds at pre-set spacing within the row, reducing need for thinning"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Open the furrow for seed placement", "Apply fertiliser beside the seed", "Drive the seed metering mechanism", "Cover seeds with soil and ensure good seed-soil contact"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Runner opener", "Single disc opener", "Hoe/shoe opener", "Double disc opener"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Broadcast on the surface", "On top of seeds", "Separately below and to the side of the seed", "Mixed with seeds in the same furrow"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["10–15 days old", "30–35 days old", "18–25 days old", "5–7 days old"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Clean seeds before sowing", "Germinate seeds in the field", "Apply herbicides with seeds", "Transport seeds from the hopper to the furrow openers through tubes"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["150 kg/ha", "100 kg/ha", "50 kg/ha", "200 kg/ha"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Seeds blown pneumatically into deep furrows", "Fine seeds placed at shallow depth using fluted rollers", "Smaller tubers placed deeper using cup-type metering", "Large seeds broadcast on surface"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Refractometer", "Canvas sheet or collection tray to count seeds dropped in measured revolutions", "Soil test kit", "Hygrometer"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Plant sugarcane sets mechanically", "Sow small vegetable seeds in raised beds", "Transplant paddy seedlings in rows", "Sow wheat directly into standing paddy stubble without prior burning"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Broadcasting seeds from a hopper", "Transplanting seedlings from a mat", "Drilling seeds into puddled soil with furrow openers", "Rolling perforated drums that release seeds in rows on puddled soil surface"],
    correct: 3,
  ...
  // ── Lecture 7: Plant Protection Equipment ───────────────────────────────────
  {
    ...
    options: ["25 litres", "10 litres", "5 litres", "15 litres"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Tree and orchard spraying", "Soil applications and band spraying", "Broadcast foliar spraying on row crops", "Applying granules"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Requires no engine", "Applies only dry dust formulations", "Uses high pressure to atomise liquid", "Uses a high-speed air blast to break liquid into fine mist and carry it to the canopy"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Band application of pesticides", "Granule application", "Soil incorporation of herbicides", "Fungicide application on fruits and vegetables requiring penetration into canopy"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Works without a power source", "No need for water", "Wider field coverage per unit time with uniform application", "Lower cost"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Too heavy to be carried by the pump", "Greater risk of drift and evaporation before reaching the target", "Poor coverage of leaf surface", "They cannot carry systemic pesticides"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["High volume (>500 L/ha) in water", "Only as dry dust", "Very low volume (0.5–5 L/ha) of concentrated formulation", "Moderate volume (200–500 L/ha)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Life jacket", "Sunglasses and hat", "Gloves, face shield/goggles, protective clothing, and respirator/mask", "Helmet and boots only"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Application is in flooded field only", "Pesticide formulation is in dust form and dry application is required", "Very high pressure spraying is needed", "Pesticide must be dissolved in water first"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Nozzle output × Pressure × Swath", "Nozzle output (L/min) × 600 ÷ (Speed km/h × Swath m)", "Nozzle output (L/min) ÷ (Speed × Swath)", "Speed × Swath ÷ Nozzle output"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Deep soil penetration like a plough", "Aerial application in tall/inaccessible crops with GPS guidance and reduced labour", "No requirement for pesticide formulation", "Applying fertiliser to soil only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0.1–0.5 bar", "8–12 bar", "1.5–4 bar", "20–30 bar"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Adding water three times, shaking and emptying into the sprayer tank, each rinse", "Washing with three different solvents", "Filling with pesticide three times for reuse", "Washing with soap three times"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Fertiliser solution at high pressure", "Herbicides in coarse droplets directly to soil (pre-emergence) or as band spray", "Fungicides in fine mist on leaf surface", "Insecticides in orchards"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Depth of spray penetration into the canopy", "Length of the boom pipe", "Width of land covered per pass by the sprayer (determined by number and spacing of nozzles)", "Width of the tractor"],
    correct: 2,
  ...
  // ── Lecture 8: Irrigation Equipment & Pumps ─────────────────────────────────
  {
    ...
    options: ["Filters sediment from irrigation water", "Rotates at high speed to impart velocity and centrifugal force to water", "Controls water flow rate at the outlet", "Reciprocates to push water through valves"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Cannot pump more than 1 m3/hr", "Is installed below water level in the borewell; motor and pump are in one sealed unit", "Uses only wind energy", "Is installed at the surface; pump and motor are separate"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0.1–0.5 litres/hour", "50–100 litres/hour", "10–20 litres/hour", "2–8 litres/hour"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["60–70%", "75–85%", "40–50%", "95–100%"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Suction head only", "Delivery head minus suction head", "Only pipe friction losses", "Suction lift + delivery head + friction losses + velocity head"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Water temperature is too cold", "Too much water is available", "Suction head is too high and water vaporises at the inlet, forming bubbles that implode", "The impeller speed is too low"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Paddy fields", "Large field crops like wheat", "Orchards and horticultural crops requiring targeted irrigation close to trees", "Greenhouse cooling only"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Kilowatts", "Kilograms per second", "Metres of head", "Litres per second (L/s) or cubic metres per hour (m³/hr)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Low head, high discharge", "Very low head, very low discharge", "High head, high discharge", "High head, low discharge"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["The soil's basic infiltration rate (to avoid runoff and ponding)", "The wind speed", "The crop evapotranspiration rate", "The atmospheric humidity"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Axial flow pump", "Reciprocating hand pump", "Submersible pump", "Centrifugal (surface) pump"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Add fertiliser to the water", "Control timing of irrigation", "Increase water pressure", "Prevent clogging of emitters by removing suspended particles and algae"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["The chemical quality of irrigation water", "How evenly water is distributed across the field", "How uniform the water pressure is in the pump", "The energy efficiency of the pump motor"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sprinkler irrigation requiring 5–7 bar", "Very low head, very high discharge (drainage, flood irrigation)", "Very high head, low discharge applications", "Deep borewell applications"],
    correct: 1,
  ...
  // ── Lecture 9: Harvesting & Threshing Machinery ─────────────────────────────
  {
    ...
    options: ["Flails on a rotating drum", "Reciprocating sickle sections between stationary counter-cutters (finger bars)", "Rotating blades like a lawn mower", "Laser cutting"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Harvesting (cutting), threshing and cleaning/separation in one pass", "Ploughing, sowing and harvesting", "Cutting, baling and transport", "Threshing, drying and bagging"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["300–500 RPM", "100–200 RPM", "700–1200 RPM", "2000–3000 RPM"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["The cleaning sieves", "Only the threshing drum", "Reel, cutter bar, auger and feeder house for gathering and conveying cut crop to threshing unit", "The grain tank and auger only"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sucking grain with a fan", "Beating with hammers", "Rubbing and impact between rotating rasp bars and concave", "Electrostatic separation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Only water to wash grain", "Magnets to separate grain", "Cyclones only", "Wind from a fan and oscillating sieves to separate grain from chaff and short straw"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Applies herbicide to harvested grain", "Drives the threshing drum", "Conveys threshed and cleaned grain from sieves to the grain tank", "Cuts and transports straw"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["It is cheaper to purchase", "It can harvest crops at any moisture content without adjustments", "It requires no skilled operator", "It has better manoeuvrability, wider cut, and the operator has better visibility and control"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Control the gap between cylinder and concave, affecting threshing intensity and grain damage", "Control fan speed for cleaning", "Set the height of the reel", "Change the width of the header"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Threshes and cleans the grain", "Applies herbicide to cut stubble", "Loads bundles onto a trailer automatically", "Ties cut crop into bundles with twine for collection and stooking"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["The feed conveyor", "Straw walker and cleaning fan (aspirator)", "The grain elevator", "Concave only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Harvesting tall sorghum", "Wet paddy fields where wheeled combines would sink or slip", "Dry upland wheat harvesting", "Orchard harvesting under trees"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Broadcasts seeds for the next crop", "Digs the groundnut plants from the soil, shakes off soil and lays them in windrows for drying", "Picks pods from the soil and threshes on the spot", "Sprays fungicide on pods"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["To separate straw from grain in the cleaning unit", "To chop and uniformly spread straw on the field for mulching or incorporation", "To collect straw in a bundle for sale", "To load straw directly into a trailer"],
    correct: 1,
  ...
  // ── Lecture 10: Farm Safety & Maintenance ───────────────────────────────────
  {
    ...
    options: ["It prevents clothing or body parts from getting entangled in the rotating PTO shaft", "It improves PTO power transmission efficiency", "It protects the PTO shaft from rain and rust", "It increases PTO speed"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Remote Operated Power System", "Rear Operations Protection Shield", "Roll-Over Protective Structure", "Rotating Overhead Protection System"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Operating on steep slopes, turning too fast, or front-end rearing when too heavy a load is hitched to the drawbar", "Travelling at low speed on level ground", "Parking on flat ground", "Operating in soft soil at low speed"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["200–250 hours of operation", "10 hours of operation", "50 hours of operation", "1000 hours of operation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Changing engine oil and filter", "Checking engine oil level, radiator coolant level, tyre pressure, air cleaner and fuel level", "Overhauling the fuel injection pump", "Replacing clutch disc"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Record hours of operation, maintenance done, repairs, fuel consumption and field operations", "Record labour wages only", "Track rainfall data", "List crop varieties grown on the farm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Keep the implement in the lowest position and at full working depth", "Remove all lubricants from the implement", "Raise and lock the implement in transport position and attach safety SMV emblem", "Leave the PTO engaged for fast travel"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["It removes water from diesel fuel", "It cools the engine oil", "It slows down the engine to save fuel", "Dust and debris block airflow, causing rich mixture, excess fuel use, power loss and engine wear"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Once a year during off-season", "Only when the bearing squeaks", "Every 500 hours", "Every 8–10 operating hours (daily or as per manufacturer schedule)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Every 250–500 hours or when engine becomes noisy (tapping sound)", "Every 50 hours", "Every 2000 hours or never", "Only at initial assembly"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Increase fuel injection pressure", "Warm the fuel in cold weather", "Add cetane improver to the fuel", "Remove water and particles from diesel before it reaches the injection pump, preventing costly damage"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A green light indicating the engine is running", "A regulatory plate showing the engine HP", "A red triangular reflective sign warning road users that the vehicle travels at <40 km/h", "A speed limit sign for the driver"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Just remove the battery and leave everything else", "Drain coolant, add antifreeze, change oil, lubricate all points, coat exposed metal, charge battery and store under cover", "Fill the fuel tank completely and leave the engine unlubricated", "Leave the fuel tank empty to prevent fuel degradation only"],
    correct: 1,
