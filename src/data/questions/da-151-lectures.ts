...
export const da151LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    "options": [
      "Powering grain combine threshers",
      "Pumping irrigation water via solar pumps",
      "Operating mould board ploughs",
      "Running combine harvesters"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Crop residues to ethanol",
      "Solar radiation to electricity",
      "Wind energy to mechanical power",
      "Organic waste to methane for cooking/power"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Engine torque at the crankshaft in plant breeding",
      "Total weight of the implement for crop improvement",
      "Vertical force on the tractor rear axle",
      "Horizontal pull required to move an implement through soil"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Orchards requiring canopy management",
      "Dryland farms needing deep tillage",
      "Large farm holdings of 10+ ha",
      "Small and marginal farms with wet paddy fields"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "At the tractor engine flywheel",
      "At the belt pulley",
      "At the tractor drawbar to pull implements",
      "At the PTO shaft"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "540 RPM at 6-spline shaft",
      "750 RPM at 6-spline shaft",
      "1000 RPM at 6-spline shaft",
      "540 RPM at 21-spline shaft"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Provides better traction in wet and heavy soils",
      "Consumes less fuel per hour",
      "Is lighter and easier to manoeuvre",
      "Has lower purchase cost"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "PTO shaft in plant breeding",
      "Engine crankshaft for crop improvement",
      "Drawbar in variety development",
      "Belt pulley mounted on the tractor"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "50% for maximum drawbar pull",
      "25–30% for maximum grip",
      "8–12% for optimum traction efficiency",
      "0% for best efficiency"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Passive implements like mould board plough",
      "Rotary implements requiring external power (rotavator, sprayer, combine)",
      "Trailed disc ploughs only in plant breeding",
      "Land levellers only for crop improvement"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Matching tractor size to farm area and implement requirements",
      "Colour and brand of the tractor",
      "Fuel tank capacity in plant breeding"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Colour of the tractor body",
      "Farm size and topography",
      "Type of crops grown",
      "Type of implements to be used"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Drawbar HP includes additional fuel consumption in plant breeding",
      "Drawbar is operated at higher speeds for crop improvement",
      "Transmission losses, rolling resistance and implement weight reduce available power at drawbar",
      "Engine HP does not include governor losses in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Large wheat farms > 10 ha",
      "Orchards, vegetable gardens and small plots",
      "Commercial sugarcane harvesting",
      "Deep subsoiling operations"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Road transport of farm produce",
      "Light vegetable farming in plant breeding",
      "Orchard spraying for crop improvement",
      "Waterlogged paddy fields and heavy clay soils"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "To connect the trailer for road transport",
      "To drive the PTO shaft",
      "To apply brakes on all four wheels",
      "To attach and hydraulically control mounted implements"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Constant fuel level in the tank",
      "Constant engine speed regardless of load variations",
      "Constant oil pressure in the sump",
      "Constant wheel speed regardless of load"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Compression → Suction → Power → Exhaust",
  ...
  },
  {
    ...
    "options": [
      "Heat of compressed air (compression ignition)",
      "Spark plug igniting fuel-air mixture",
      "Glow plug continuously",
  ...
  },
  {
    ...
    "options": [
      "Air cooling only",
      "Water (liquid) cooling with radiator",
      "Evaporative cooling",
      "Oil cooling only"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Both rear wheels to rotate at different speeds while turning",
      "The PTO to operate independently of ground speed",
      "Automatic gear changes based on load",
      "Equal power to both rear wheels at all times"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Deliver metered, high-pressure fuel to injectors at correct timing",
      "Filter impurities from diesel for crop improvement",
      "Pressurise the crankcase in variety development",
      "Cool the fuel before combustion in plant breeding"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "More fuel efficient",
      "More powerful than water-cooled",
      "Better suited for high ambient temperatures",
      "Simpler, lighter and require less maintenance"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Clean the air filter in plant breeding",
      "Increase fuel efficiency by burning oil",
      "Cool the engine only for crop improvement",
      "Reduce friction, prevent wear, cool components and seal piston rings"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "PTO is driven by a separate small engine",
      "PTO speed varies with ground speed",
      "PTO can be engaged/disengaged independently of the clutch",
      "PTO operates only when the tractor is moving"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "It requires a separate diesel engine in plant breeding",
      "It has no safety guards for crop improvement",
      "Its speed is proportional to forward speed of the tractor",
      "It runs at 540 RPM always in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Maintain optimum engine operating temperature by regulating coolant flow",
      "Prevent engine from overheating by releasing coolant to the atmosphere",
      "Control the speed of the cooling fan",
      "Measure fuel temperature before injection"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Further reduces speed and increases torque to the rear axle",
      "Controls the hydraulic system in plant breeding",
      "Transfers power from the engine to the gearbox",
      "Drives the PTO shaft for crop improvement"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Increase power output by forcing more air into the cylinders",
      "Reduce engine noise for crop improvement",
      "Improve fuel filtration in plant breeding",
      "Cool the engine oil in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Lifting and controlling mounted implements",
      "Cooling the engine",
      "Starting the engine",
      "Filtering the fuel"
    ],
  ...
  },
  {
    ...
    "options": [
      "Cleaning the plough share",
      "Cutting the furrow slice from the side",
      "Inverting, turning and pulverising the furrow slice",
      "Penetrating the soil vertically"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Angle of the plough with the soil surface",
      "Angle between disc face and vertical plane parallel to direction of travel",
      "Angle between successive discs in plant breeding",
      "Angle of tilt of the disc from vertical"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Forming ridges and furrows in plant breeding",
      "Breaking hard pan and compacted layers below normal ploughing depth",
      "Surface tillage and seedbed preparation for crop improvement",
      "Harrowing and clod breaking in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Share → Mould board → Land side → Heel → Beam",
      "Beam → Mould board → Share → Land side",
      "Share → Mould board → Land side → Furrow wheel",
      "Heel → Share → Mould board → Beam"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Decreasing ploughing depth",
      "Lighter soil type",
      "Smaller plough share",
      "Increasing ploughing speed and depth"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Inverts the soil completely in plant breeding",
      "Requires no tractor to operate for crop improvement",
      "Leaves crop residues on the surface and does not invert the soil",
      "Can only operate in paddy fields in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Attach the plough to the tractor in plant breeding",
      "Pulverise clods behind the plough for crop improvement",
      "Support the rear of the plough on the road",
      "Guide the plough into the next furrow and control ploughing width"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Soil is already well-aerated in plant breeding",
      "Soil is loose and sandy in variety development",
      "Crop requires shallow root development for crop improvement",
      "A hardpan exists below 20 cm that restricts root growth"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Cutting and lifting the furrow slice from the bottom",
      "Turning the soil upside down in plant breeding",
      "Pressing the soil to form a firm seedbed",
      "Supporting the plough body for crop improvement"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Cultivation between crop rows during the season in plant breeding",
      "The first tillage to open the soil after harvest to a good depth",
      "Tillage done with hand tools only for crop improvement",
      "Fine seedbed preparation after primary tillage in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The furrow slice from crumbling too much",
      "Vertical penetration of the share",
      "The share from wearing too fast",
      "Lateral (sideways) displacement of the plough in the furrow"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Tandem has two gangs in line (front gang throws soil outward, rear throws inward); offset has",
      "Tandem has all discs in one gang; offset has discs in two gangs set at opposite angles",
      "Tandem discs are flat; offset discs are concave in plant breeding",
      "Tandem is pulled by animals; offset is tractor-drawn for crop improvement"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Requires no tractor PTO connection",
      "Performs primary and secondary tillage in a single pass",
      "Only works in dry conditions",
      "Uses a cutter bar to slice crop residues"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Wet paddy field intercultivation in plant breeding",
      "Stony or hard soils where tynes might break",
      "Deep ploughing operations for crop improvement",
      "Primary tillage after harvest in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Prepare a fine seedbed, incorporate fertilisers and control weeds",
      "Turn and invert the soil for pest control",
      "Form drainage channels in plant breeding",
      "Break subsoil hardpan for crop improvement"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "To remove large stones from the field",
      "To cut soil to uniform depth for planting",
      "To smooth and level the field surface for uniform irrigation",
      "To form raised beds for vegetable crops"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "After sowing, between rows, to control weeds and aerate the soil",
      "Before sowing for seedbed preparation in plant breeding",
      "At harvesting time to loosen the soil for crop improvement",
      "During the first irrigation for soil cracking in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Harvesting root crops in plant breeding",
      "Levelling the field before sowing for crop improvement",
      "Primary deep ploughing in variety development",
      "Forming ridges and furrows for planting row crops and irrigation"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Diameter of discs and angle at which they are set",
      "Speed of the tractor only in plant breeding",
      "Number of discs in the gang for crop improvement",
      "Length of the harrow frame in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Dry land wheat cultivation",
      "Vegetable bed preparation",
      "Oilseed crop sowing",
      "Wet paddy field preparation (puddling)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Initial clod size, soil moisture content and required seedbed fineness",
      "Brand of tractor used in plant breeding",
      "Number of workers available for crop improvement",
      "Colour of the soil in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Invert soil for better weed burial",
      "Reduce soil disturbance, conserve moisture and reduce erosion",
      "Increase tractor usage in plant breeding",
      "Maximise number of tillage passes"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Pulverises surface into fine tilth in variety development",
      "Creates ridges for irrigation in plant breeding",
      "Cuts soil deep and inverts it for crop improvement",
      "Cuts weeds below the surface without disturbing the soil much"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Removing excess soil from roots in plant breeding according to plant breeding and genetics science principles",
      "Building up soil around the base of sugarcane plants to support stalks and cover fertiliser",
      "Aerating roots by removing soil in variety development according to plant breeding and genetics science principles",
      "Making ridges for drainage only according to plant breeding and genetics science principles"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Plate/cell wheel metering",
      "Fluted roller (force feed) mechanism",
      "Air seeder mechanism",
      "Belt conveyor metering"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Sow seeds directly into undisturbed crop residue without prior tillage",
      "Plough deep before sowing for crop improvement",
      "Apply fertiliser without seeds in plant breeding",
      "Plant rice seedlings in puddle mud"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Changing tractor speed only in plant breeding",
      "Adjusting the furrow opener angle for crop improvement",
      "Changing seed hopper size in variety development",
      "Varying the exposed length of the fluted roller"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Places individual seeds at pre-set spacing within the row, reducing need for thinning",
      "Broadcasts seeds uniformly in plant breeding according to plant breeding and genetics science principles",
      "Sows only in puddled soils for crop improvement",
      "Sows seeds in rows at uniform spacing in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Drive the seed metering mechanism in plant breeding",
      "Cover seeds with soil and ensure good seed-soil contact",
      "Open the furrow for seed placement",
      "Apply fertiliser beside the seed for crop improvement"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "On top of seeds in plant breeding",
      "Broadcast on the surface for crop improvement",
      "Mixed with seeds in the same furrow",
      "Separately below and to the side of the seed"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Clean seeds before sowing in plant breeding",
      "Transport seeds from the hopper to the furrow openers through tubes",
      "Germinate seeds in the field for crop improvement",
      "Apply herbicides with seeds in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Large seeds broadcast on surface",
      "Seeds blown pneumatically into deep furrows",
      "Fine seeds placed at shallow depth using fluted rollers",
      "Smaller tubers placed deeper using cup-type metering"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Refractometer in plant breeding according to plant breeding and genetics science principles",
      "Soil test kit according to plant breeding and genetics science principles",
      "Canvas sheet or collection tray to count seeds dropped in measured revolutions",
      "Hygrometer in variety development according to plant breeding and genetics science principles"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Plant sugarcane sets mechanically in plant breeding",
      "Transplant paddy seedlings in rows for crop improvement",
      "Sow small vegetable seeds in raised beds",
      "Sow wheat directly into standing paddy stubble without prior burning"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Drilling seeds into puddled soil with furrow openers",
      "Rolling perforated drums that release seeds in rows on puddled soil surface",
      "Broadcasting seeds from a hopper in plant breeding",
      "Transplanting seedlings from a mat for crop improvement"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Soil applications and band spraying",
      "Broadcast foliar spraying on row crops",
      "Tree and orchard spraying",
      "Applying granules"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Uses a high-speed air blast to break liquid into",
      "Requires no engine for crop improvement",
      "Uses high pressure to atomise liquid in variety development",
      "Applies only dry dust formulations in plant breeding"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Adjusting the pH of the spray solution in plant breeding",
      "Determining and adjusting the volume of spray liquid applied per unit area",
      "Selecting the type of pesticide to use for crop improvement",
      "Cleaning the nozzles after use in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Granule application in plant breeding according to plant breeding and genetics science principles",
      "Soil incorporation of herbicides for crop improvement",
      "Fungicide application on fruits and vegetables requiring penetration into canopy",
      "Band application of pesticides in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Lower cost in plant breeding",
      "No need for water for crop improvement",
      "Works without a power source",
      "Wider field coverage per unit time with uniform application"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Poor coverage of leaf surface in plant breeding",
      "Too heavy to be carried by the pump",
      "They cannot carry systemic pesticides for crop improvement",
      "Greater risk of drift and evaporation before reaching the target"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Moderate volume (200–500 L/ha) in plant breeding",
      "Very low volume (0.5–5 L/ha) of concentrated formulation",
      "High volume (>500 L/ha) in water",
      "Only as dry dust for crop improvement"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Sunglasses and hat in plant breeding",
      "Gloves, face shield/goggles, protective clothing, and respirator/mask",
      "Helmet and boots only under tropical agricultural conditions",
      "Life jacket for crop improvement"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Very high pressure spraying is needed for crop improvement",
      "Application is in flooded field only in plant breeding",
      "Pesticide formulation is in dust form and dry application is required",
      "Pesticide must be dissolved in water first in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Nozzle output (L/min) ÷ (Speed × Swath) in plant breeding",
      "Speed × Swath ÷ Nozzle output for crop improvement",
      "Nozzle output × Pressure × Swath in variety development",
      "Nozzle output (L/min) × 600 ÷ (Speed km/h × Swath m)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Applying fertiliser to soil only in plant breeding",
      "Deep soil penetration like a plough for crop improvement",
      "Aerial application in tall/inaccessible crops with GPS guidance and reduced labour",
      "No requirement for pesticide formulation in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Filling with pesticide three times for reuse in plant breeding",
      "Washing with three different solvents for crop improvement",
      "Washing with soap three times in variety development",
      "Adding water three times, shaking and emptying into the sprayer tank, each rinse"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Herbicides in coarse droplets directly to soil (pre-emergence) or as band spray",
      "Insecticides in orchards in plant breeding",
      "Fungicides in fine mist on leaf surface for crop improvement",
      "Fertiliser solution at high pressure in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Width of the tractor in plant breeding",
      "Length of the boom pipe in variety development",
      "Depth of spray penetration into the canopy for crop improvement",
      "Width of land covered per pass by the sprayer"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Remove the husk from paddy",
      "Separate the grain (kernels) from the cobs",
      "Crush sugarcane for juice"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Remove the kernels from the pods",
      "Separate grain from chaff",
      "Polish brown rice",
      "Dry the harvested grain"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Prevent rats from entering the storage structure",
      "Improve air circulation",
      "Support the conical roof"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Rotating blades like a lawn mower as recommended by ICAR guidelines",
      "Reciprocating sickle sections between stationary counter-cutters (finger bars)",
      "Laser cutting in plant breeding in irrigated crop production systems",
      "Flails on a rotating drum based on conventional agronomic practices"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Harvesting (cutting), threshing and cleaning/separation in one pass",
      "Cutting, baling and transport for crop improvement",
      "Threshing, drying and bagging in plant breeding",
      "Ploughing, sowing and harvesting in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "The grain tank and auger only for crop improvement",
      "Only the threshing drum in plant breeding",
      "Reel, cutter bar, auger and feeder house for gathering",
      "The cleaning sieves in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Beating with hammers in plant breeding",
      "Electrostatic separation for crop improvement",
      "Rubbing and impact between rotating rasp bars and concave",
      "Sucking grain with a fan"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Wind from a fan and oscillating sieves",
      "Magnets to separate grain for crop improvement",
      "Only water to wash grain in variety development",
      "Cyclones only in plant breeding"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Cuts and transports straw in plant breeding",
      "Drives the threshing drum for crop improvement",
      "Applies herbicide to harvested grain in variety development",
      "Conveys threshed and cleaned grain from sieves to the grain tank"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Only grain tank losses in plant breeding",
      "Fuel losses only in variety development",
      "Only header losses for crop improvement",
      "Header losses (cutterbar, reel), threshing losses, and separation/cleaning losses"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "It can harvest crops at any moisture content without adjustments",
      "It is cheaper to purchase according to plant breeding and genetics science principles",
      "It requires no skilled operator in plant breeding according to plant breeding and genetics science principles",
      "It has better manoeuvrability, wider cut, and the operator has better visibility and control"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Control fan speed for cleaning in plant breeding",
      "Control the gap between cylinder and concave, affecting threshing intensity and grain damage",
      "Change the width of the header for crop improvement",
      "Set the height of the reel in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Loads bundles onto a trailer automatically in plant breeding",
      "Ties cut crop into bundles with twine for collection and stooking",
      "Applies herbicide to cut stubble for crop improvement",
      "Threshes and cleans the grain in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Concave only in plant breeding",
      "Straw walker and cleaning fan (aspirator)",
      "The feed conveyor",
      "The grain elevator"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Orchard harvesting under trees in plant breeding",
      "Harvesting tall sorghum for crop improvement",
      "Wet paddy fields where wheeled combines would sink or slip",
      "Dry upland wheat harvesting in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Picks pods from the soil and threshes on the spot in plant breeding",
      "Digs the groundnut plants from the soil, shakes off soil and lays them in windrows for drying",
      "Broadcasts seeds for the next crop in variety development according to plant breeding and genetics science principles",
      "Sprays fungicide on pods according to plant breeding and genetics science principles"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "To separate straw from grain in the cleaning unit in plant breeding",
      "To load straw directly into a trailer for crop improvement",
      "To collect straw in a bundle for sale in variety development",
      "To chop and uniformly spread straw on the field for mulching or incorporation"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "It prevents clothing or body parts from getting entangled in the rotating PTO shaft",
      "It protects the PTO shaft from rain and rust",
      "It improves PTO power transmission efficiency in plant breeding",
      "It increases PTO speed according to plant breeding and genetics science principles"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Rear Operations Protection Shield",
      "Roll-Over Protective Structure",
      "Rotating Overhead Protection System",
      "Remote Operated Power System"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Travelling at low speed on level ground for crop improvement",
      "Parking on flat ground in plant breeding",
      "Operating on steep slopes, turning too fast",
      "Operating in soft soil at low speed in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Changing engine oil and filter in plant breeding according to plant breeding and genetics science principles",
      "Replacing clutch disc according to plant breeding and genetics science principles",
      "Checking engine oil level, radiator coolant level, tyre pressure, air cleaner and fuel level",
      "Overhauling the fuel injection pump in variety development according to plant breeding and genetics science principles"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Record hours of operation, maintenance done, repairs, fuel consumption and field operations",
      "Track rainfall data in plant breeding according to plant breeding and genetics science principles",
      "Record labour wages only for crop improvement",
      "List crop varieties grown on the farm in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Remove all lubricants from the implement in plant breeding",
      "Raise and lock the implement in transport position and attach safety SMV emblem",
      "Leave the PTO engaged for fast travel for crop improvement",
      "Keep the implement in the lowest position and at full working depth"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "It cools the engine oil in plant breeding",
      "It removes water from diesel fuel for crop improvement",
      "Dust and debris block airflow, causing rich mixture",
      "It slows down the engine to save fuel in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Every 8–10 operating hours (daily or as per manufacturer schedule)",
      "Every 500 hours in plant breeding",
      "Once a year during off-season for crop improvement",
      "Only when the bearing squeaks in variety development"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Every 2000 hours or never in plant breeding",
      "Every 250–500 hours or when engine becomes noisy (tapping sound)",
      "Every 50 hours for crop improvement",
      "Only at initial assembly in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Add cetane improver to the fuel for crop improvement as recommended by ICAR guidelines",
      "Increase fuel injection pressure in plant breeding according to plant breeding and genetics science principles",
      "Remove water and particles from diesel before it reaches the injection pump, preventing costly damage",
      "Warm the fuel in cold weather in variety development as recommended by ICAR guidelines"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "A green light indicating the engine is running in plant breeding",
      "A speed limit sign for the driver for crop improvement",
      "A red triangular reflective sign warning road users that the vehicle travels at <40 km/h",
      "A regulatory plate showing the engine HP in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Leave the fuel tank empty to prevent fuel degradation only in plant breeding",
      "Fill the fuel tank completely and leave the engine unlubricated for crop improvement",
      "Just remove the battery and leave everything else in variety development",
      "Drain coolant, add antifreeze, change oil, lubricate all points, coat exposed metal, charge battery and store under cover"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "cast iron or pressed steel alloy",
      "copper in plant breeding",
      "drop forged steel",
      "aluminum alloy for crop improvement"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "cast iron in plant breeding",
      "aluminum alloy for crop improvement",
      "copper alloy in variety development",
  ...
  },
  {
    ...
    "options": [
      "it is half the size in plant breeding",
      "it works for half time for crop improvement",
      "camshaft gear has twice as many teeth as crankshaft gear",
      "it has half efficiency in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "cooling of cylinder in plant breeding",
      "introduction of fresh fuel",
      "removal of burnt exhaust gases from cylinder",
      "lubrication of parts for crop improvement"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Viscosity in plant breeding",
      "Calorific value",
      "Interval between injection and auto-ignition",
      "Boiling point"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "fine dust particles",
      "only water",
      "coarse materials, water and dust"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Cooling, Heating, Sealing, Filtering",
      "Reducing friction, Cooling, Sealing, Heating",
      "Reducing friction, Cooling, Sealing, Cleaning",
      "Reducing friction, Heating, Sealing, Cooling"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "an oil pump in plant breeding",
      "a dipper at the lower end of connecting rod",
      "an oil fan for crop improvement",
      "a spray nozzle in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "two stroke engines",
      "high speed multi-cylinder engines in tractors",
      "air cooled engines"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "prevent rusting in plant breeding",
      "increase area of contact of air for speedy cooling",
      "reduce weight for crop improvement",
      "strengthen the cylinder in variety development"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Diesel engine",
      "Oil engine",
      "Railway engine and steam engine"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "main filter in plant breeding",
      "overflow valve for crop improvement",
      "priming pump through bleeding holes of injection pump",
      "fuel lift pump in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "centrifugal or impeller type",
      "diaphragm type",
      "piston type",
      "gear type or vane type"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "low cost only",
      "conductivity in plant breeding",
      "lightness for crop improvement",
      "high compressive strength and low expansion"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "overheating in plant breeding",
      "dirt accumulation for crop improvement",
      "leakage of gases from engine cylinder",
      "friction in variety development"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "lubricating parts in plant breeding",
      "providing uniform rotary motion by virtue of its inertia",
      "cooling the engine in variety development",
      "pumping fuel for crop improvement"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "difficult starting, noise and exhaust smoke",
      "better fuel economy",
      "reduced power output",
      "easy starting in plant breeding"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "it creates noise in plant breeding as recommended by ICAR guidelines",
      "it wastes water for crop improvement",
      "it increases fuel consumption only as recommended by ICAR guidelines",
      "neither overheating nor over-cooling is desirable for satisfactory performance"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Has independent lubricating oil circuit",
  ...
  },
  {
    ...
    "options": [
      "increased efficiency in plant breeding",
      "engine knocking and loss of power",
      "better cooling for crop improvement",
