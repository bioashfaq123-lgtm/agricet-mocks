...
export const englishCommunicationQuestions: Question[] = [
  {
    id: "ec001",
  ...
  },
  {
    ...
    options: ["city", "mountain", "Monday", "teacher"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["father-in-laws", "fathers-in-laws", "fathers-in-law", "father-in-lawes"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["a, an, the", "a and an", "the only", "an and the"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The field is ploughed by the farmer.", "The field ploughs the farmer.", "The farmer is ploughed by the field.", "The field was ploughed by farmer."],
    correct: 0,
  ...
  },
  {
    ...
    options: ["She said that she is busy.", "She said that she was busy.", "She said that I was busy.", "She said that she will be busy."],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Old", "Historic", "Modern/Recent", "Traditional"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Informal/personal letter", "Formal/official letter", "Circular letter", "Notice"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Names a person or thing", "Shows action", "Modifies (describes) a noun or pronoun", "Joins two clauses"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["What", "When", "Whether", "Where"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Read every word carefully", "Quickly get the general idea/overview of a text", "Study a text in great detail", "Read aloud to an audience"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Any verb can be used with any subject", "Singular subject takes singular verb; plural subject takes plural verb", "All verbs are the same form", "The verb must agree with the object"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Dear Friend,", "Dear Sir/Madam,", "Hello,", "Hi there,"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Homonyms", "Synonyms", "Homophones", "Antonyms"],
    correct: 2,
