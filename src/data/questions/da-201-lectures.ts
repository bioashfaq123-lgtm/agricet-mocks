...
export const da201LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["It promotes biological N fixation through root nodule bacteria, reducing fertiliser N requirement", "It increases seed size in crop production in agriculture", "It controls pod borer attack in field conditions under field conditions", "It improves germination speed for agricultural purposes for crop production"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Only furadan granules in soil in field conditions", "No control needed as damage is minimal", "Ploughing only in crop production", "HaNPV (nuclear polyhedrosis virus) spray or chemical insecticides like indoxacarb/emamectin"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Only once at germination", "Branching/bud formation and flowering (head opening) stages", "At physiological maturity", "Only at sowing (pre-sowing irrigation)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A standard early sunflower variety adapted to Telangana conditions", "A late-maturing variety not suited for peninsular India", "An open-pollinated high oleic acid variety", "A safflower hybrid in crop production"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Fertiliser application", "Ploughing before sowing", "Irrigation", "Machine harvesting and manual weeding/intercultivation"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Spraying with systemic insecticide at head formation", "Seed treatment only", "No control as damage is minor", "Burning the field after harvest"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["IARI, New Delhi", "UAS, Dharwad", "Gujarat Agricultural University (GAU), Anand", "PJTSAU, Hyderabad"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Punjab and Haryana as a rabi crop in crop production", "Tamil Nadu paddy fallows in field conditions in agriculture", "Gujarat as an irrigated crop for agricultural purposes under field conditions", "Tribal and upland areas of Chhattisgarh, Odisha, and Jharkhand as a kharif/pre-rabi crop"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Essential oils (terpenes)", "Capsanthin (pigment)", "Capsaicin and dihydrocapsaicin (capsaicinoids)", "Ascorbic acid (vitamin C)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Burning crop residues only in crop production", "Chemical nematicide (carbofuran) soil treatment and biocontrol with Paecilomyces lilacinus", "Overhead irrigation for agricultural purposes in agriculture", "Applying urea in excess in field conditions"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Bidi tobacco has no nicotine", "Bidi tobacco is exclusively grown in Andhra Pradesh only", "Bidi tobacco uses very large leaves for wrapping bidis; cured by sun/air", "Bidi tobacco is the same as FCV but with different packaging"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Loss of oil content", "Sprouting of seeds in storage", "Seed coat cracking", "Aflatoxin production due to Aspergillus flavus"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Saline soils", "Areas subjected to waterlogging after planting", "Dry soil conditions only", "Farms with drip irrigation"],
    correct: 1,
