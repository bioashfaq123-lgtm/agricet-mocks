...
export const da122LectureQuestions: Question[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["2.0% N, 1.0% P₂O₅, 2.0% K₂O", "0.5% N, 0.2% P₂O₅, 0.5% K₂O", "0.1% N, 0.05% P₂O₅, 0.1% K₂O", "1.0% N, 0.5% P₂O₅, 1.0% K₂O"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mixed with night soil and decomposed in sealed chambers", "Placed in pits and kept anaerobic throughout decomposition", "Stacked in heaps and turned 2–3 times during 3–5 months of decomposition", "Burned partially and then mixed with soil"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["5–10 t ha⁻¹", "100–150 t ha⁻¹", "1–2 t ha⁻¹", "25–50 t ha⁻¹"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Buffalo dung", "They are identical in composition", "Sheep dung (not cattle)", "Cow dung"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Composting stabilises nutrients, reduces pathogens, weed seeds, and produces a uniform product", "Composting reduces the organic matter content of the final product", "Composting increases the volume of material applied per hectare", "Composting increases the C:N ratio of the material"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Fixation of N by 2:1 clay minerals", "Ammonia (NH₃) volatilisation from urine decomposition", "Leaching of nitrate (NO₃⁻) into groundwater", "Denitrification loss as N₂ gas"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Humid areas with high rainfall and good natural drainage", "Large commercial composting operations", "Dry areas where moisture conservation is important for decomposition", "Urban municipal solid waste composting"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["25–35°C", "40–50°C", "80–90°C", "55–65°C (55–70°C)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Aerate the pile to maintain aerobic conditions and uniform decomposition", "Add mineral fertilizers to the compost", "Remove excess moisture from the compost", "Kill earthworms that may be competing with microbes"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["2–3% N, 1.5–2% P₂O₅, 1.5–2% K₂O", "0.5% N, 0.2% P, 0.5% K", "0.1% N, 0.05% P, 0.1% K", "5% N, 4% P₂O₅, 5% K₂O"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Produces seeds with 40% protein content used as livestock feed", "Fixes 80–100 kg N ha⁻¹ through Rhizobium symbiosis, grows fast, and tolerates waterlogging", "Fixes nitrogen through association with Azospirillum only", "Is a legume that requires no water for growth"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["At 50% flowering stage when biomass and nitrogen content are maximum", "At full seed maturity (all pods developed)", "At 10–15 days after germination (seedling stage)", "After the crop has dried completely (dry matter stage)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["300–400 kg N ha⁻¹", "40–80 kg N ha⁻¹", "10–20 kg N ha⁻¹", "150–200 kg N ha⁻¹"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Directly absorbs atmospheric nitrogen into its fronds", "Acts as a green manure only without any N fixation", "Produces growth hormones that stimulate rice tillering", "Harbours Anabaena azollae (a BGA) in its leaf cavities that fixes N₂"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["20–25 t ha⁻¹", "1–2 t ha⁻¹", "50–100 t ha⁻¹", "5–7.5 t ha⁻¹"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["2–3 years", "1–2 weeks", "45–60 days", "6–12 months"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["50–100 worms m⁻²", "500–1000 worms m⁻² of bed area", "10–20 worms m⁻²", "10,000 worms m⁻²"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["20–30 kg N ha⁻¹ yr⁻¹", "100–150 kg N ha⁻¹ yr⁻¹", "200–300 kg N ha⁻¹ yr⁻¹", "1–2 kg N ha⁻¹ yr⁻¹"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Forms enclosed nodules on cereal roots like Rhizobium", "Is a strict endophyte living inside plant tissues", "Lives freely in bulk soil without any plant association", "Lives in close association with plant roots (rhizosphere) without forming nodules"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Increasing soil pH to solubilise P in acid soils", "Producing organic acids (gluconic, citric) that dissolve insoluble Ca-P and Fe-P compounds", "Fixing atmospheric P₂ gas and converting it to plant-available forms", "Forming root nodules that absorb soil P directly"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Root dipping", "Soil drenching", "Seed treatment (seed inoculation)", "Foliar spray"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["100 kg ha⁻¹", "10 kg ha⁻¹", "500 kg ha⁻¹", "100 g ha⁻¹"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Applied to moist acid soil and immediately incorporated", "Applied in granular form to dry soil", "Applied in the evening during cool weather", "Applied to flooded alkaline or calcareous soil surface in hot conditions"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Add micronutrients (Zn, B) from neem seeds to the soil", "Reduce urease activity and slow nitrification, improving N use efficiency by 5–10%", "Reduce urea theft for non-agricultural purposes by making it bitter", "Improve neem tree cultivation by providing a market for neem oil"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Neutral but with S toxicity", "Neutral", "Physiologically acid", "Strongly alkaline"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["16% N and 20% P₂O₅", "18% N and 46% P₂O₅", "46% N and 18% P₂O₅", "10% N and 10% P₂O₅"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["P mineralisation", "P fixation (retention)", "P leaching", "P volatilisation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0.05% P in dry matter", "0.2–0.3% P in dry matter", "5.0% P in dry matter", "1.0–2.0% P in dry matter"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["All pulse crops regardless of Cl sensitivity", "Rice and wheat (tolerant of Cl⁻)", "Cotton and sunflower (require high Cl for fibre quality)", "Chlorine-sensitive crops: tobacco, potato, tomato, grapes, and many fruits"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["13% N, 44% K₂O (no P)", "0% N, 60% K₂O", "13% N, 0% K₂O", "18% N, 46% K₂O"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Root crops like potato and sugar beet", "Rice and wheat under high N application", "Grasses and forages where K content far exceeds plant requirements", "Legumes that preferentially absorb K over N"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Rice", "Groundnut", "Potato and banana", "Wheat"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Exchangeable K adsorbed on CEC sites", "Non-exchangeable (fixed) K in clay interlayers", "Structural K in primary minerals (feldspars, micas)", "Solution K (K⁺ in soil water)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["36 kg MOP ha⁻¹", "120 kg MOP ha⁻¹", "60 kg MOP ha⁻¹", "100 kg MOP ha⁻¹"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Increases N₂ fixation in legume nodules", "Increases chlorophyll content by being part of the porphyrin ring", "Increases protein content by providing an N source", "Improves sugar content, starch quality, oil content, fibre strength, and fruit colour"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["< 1000 kg K₂O ha⁻¹", "< 10 kg K₂O ha⁻¹", "< 110–150 kg K₂O ha⁻¹", "< 400 kg K₂O ha⁻¹"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["USA and Australia", "Bangladesh and Sri Lanka", "China and Pakistan", "Canada (Saskatchewan), Russia, Belarus, and Jordan"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["K₂CO₃ (potassium carbonate) — approximately 5–10% K₂O equivalent", "KCl (muriate of potash) from soil salts", "K₂SO₄ from organic sulphur compounds", "KNO₃ (potassium nitrate) from plant nitrogen"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["17% N, 17% P₂O₅, 17% K₂O in equal proportions", "17 kg N, 17 kg P, 17 kg K per bag", "17% N, 17% P, 17% S", "17% urea, 17% SSP, 17% MOP"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Must be fully water-soluble with no chloride residue", "Must contain organic matter", "Must be acidic to pH < 4", "Must be slow-release only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Components must be liquid for uniform mixing", "Temperature must be maintained at exactly 25°C during blending", "All fertilizer materials must have identical chemical composition", "Component fertilizers must have similar particle size to prevent segregation during handling"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["0:0:60 (potash only)", "10:26:26 (high P+K complex)", "28:0:0 or high-N urea-based grade", "14:35:14 (high P for root growth)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["14:35:14 (conventional granular complex)", "19:19:19 (fully water-soluble NPK complex)", "17:17:17 (standard granular NPK)", "20:20:0 (nitrophosphate)"],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["Zinc sulphate heptahydrate (ZnSO₄·7H₂O) containing 21% Zn", "Zinc EDTA chelate containing 12% Zn", "Zinc oxide (ZnO) containing 80% Zn", "Zinc carbonate containing 52% Zn"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["2.5 kg ha⁻¹", "10 kg ha⁻¹", "100 kg ha⁻¹", "25 kg ha⁻¹"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Iron (Fe)", "Copper (Cu)", "Boron (B)", "Zinc (Zn)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Have no advantage over chemical NPK alone", "Reduce the effectiveness of Rhizobium nodulation due to chemical interference", "Cause nutrient toxicity due to excess supply", "Improve nutrient use efficiency, reduce fertilizer requirement, and increase yield sustainably"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Composting residues only — never incorporating directly", "Incorporating or mulching crop residues to return nutrients and organic carbon to the soil", "Burning all crop residues to prevent pest and disease carryover", "Removing all residues from the field for use as animal feed only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Burn wheat straw before rice transplanting to clear field rapidly", "Apply extra urea to decompose residue without decomposer organisms", "Incorporate wheat straw with sufficient time for decomposition, or use in-situ decomposers/bio-inoculants", "Remove all wheat straw for commercial sale only"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Department of Fertilizers, Ministry of Chemicals and Fertilizers", "ICAR (Indian Council of Agricultural Research)", "Food Safety and Standards Authority of India (FSSAI)", "Reserve Bank of India (RBI)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Subsidy for organic fertilizer purchase only", "Free fertilizer distribution to all farmers", "Export of surplus fertilizers to neighboring countries", "Micro-irrigation (drip/sprinkler) enabling precision fertigation and reducing fertilizer wastage"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["High in pH", "Poor in texture", "A productive soil", "Rich in micronutrients"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["60-10-60", "120-20-120", "85-15-90", "175-35-175"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["To dig", "Work with soil", "To fertilise crops", "Animal excreta"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Both manures and fertilizers are quick acting", "Manures improve physical properties, fertilizers generally do not", "Manures are bulky, fertilizers are non-bulky", "Manures are organic, fertilizers are inorganic"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["12-15 tonnes", "2-3 tonnes", "5-6 tonnes", "8-10 tonnes"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Too many microorganisms attack the manure", "Animals eat the manure", "Too much water is added", "Direct exposure to sunshine and rainfall causes dryness and rapid oxidation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Industrial waste", "Only animal excreta", "Municipal garbage only", "Agricultural waste, crop residues, weeds, and farmyard waste"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Hydrogen", "Carbon dioxide", "Methane (CH4)", "Nitrogen"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Aporrectodea caliginosa", "Eisenia fetida (Red wriggler)", "Lumbricus terrestris", "Pheretima posthuma"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Available in large quantities", "Faster nutrient release, better plant growth hormones, and more beneficial microorganisms", "Cheaper to produce", "Lower nutrient content"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Pongamia", "Gliricidia", "Sesbania (Dhaincha)", "Neem"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Dhaincha (Sesbania)", "Pillipesara", "Gliricidia", "Crotalaria"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Mahua cake", "Neem cake, castor cake", "Mustard cake, linseed cake, groundnut cake, coconut cake", "Cotton cake, sunflower cake"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["P and Ca", "K and Ca", "N and P", "N and K"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Control weeds", "Fix nitrogen and mobilise phosphorus", "Produce organic matter", "Improve soil texture"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Symbiotic fixer", "Free-living fixer", "Phosphorus mobilizer", "Associative fixer"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Free-living", "Symbiotic", "Obligate", "Associative"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Absorbers", "Solubilizers", "Leachers", "Fixers"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["28-30%", "16-18%", "10-12%", "46-48%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Urea", "Gypsum (CaSO4)", "Muriate of potash", "Ammonium nitrate"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Zinc deficiency", "Iron deficiency", "Boron deficiency", "Manganese deficiency"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["17-17-17 (N-P-K)", "20-20-0 (N-P-K)", "11-52-0 (N-P-K)", "18-46-0 (N-P-K)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["17 kg each of N, P, K per bag", "17 tons per hectare", "17% organic matter", "17% N, 17% P2O5, 17% K2O"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Applying fertilizers before planting only", "Split application, placement near root zone, and matching supply with crop demand", "Applying all fertilizer at once in one split", "Using only urea as nitrogen source"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Applying fertilizer in bands near seeds", "Placing fertilizer in holes near plant base", "Spreading fertilizer uniformly over the soil surface", "Spraying liquid fertilizer on leaves"],
    correct: 0,
  ...
  },
  {
    ...
    lectureNo: 29,
    question: "Integrated Nutrient Management (INM) is defined as:",
    options: ["Use of chemical fertilizers only", "Combined use of organic manures, biofertilizers and chemical fertilizers for sustainable crop production", "Use of only biofertilizers", "Application of only organic manures"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Ammonium sulphate (21%)", "Urea (46%)", "Ammonium nitrate (34%)", "Calcium ammonium nitrate (25%)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Water soluble P", "Citric acid soluble P", "Citric acid insoluble P", "All of the above"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Boron", "Copper", "Iron", "Zinc"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Synthetic chemical pesticides and fertilizers", "Biofertilizers", "Green manures", "Compost and vermicompost"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["To increase soil salinity", "To reduce crop yields", "To eliminate all chemical fertilizer use", "To maintain or improve soil health while meeting crop nutrient demands economically"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Blood of slaughtered animals", "Droppings (excreta) of sea birds/bats", "Fish waste", "Crop residues"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Only food processing waste", "Municipal waste including rubbish, street sweepings, and market wastes", "Only crop residues", "Industrial waste"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Granite stone lining (non-absorbent)", "Plastic sheets", "Cement", "Clay bricks"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Resistant to all pests", "Long duration crop", "Drought-tolerant", "Fast-growing, leguminous, high biomass-producing, and easy to decompose"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Phosphate absorbers", "Symbiotic N fixers", "Phosphate solubilizers", "Free-living N fixers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Deep placement of fertilizer", "Foliar application of fertilizer", "Broadcasting fertilizer", "Application of fertilizer through irrigation water"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Calcium and Sulphur", "Magnesium and Sulphur", "Zinc and Sulphur", "Iron and Sulphur"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Manufacturing in factories only", "Mechanical mixing (blending) of individual fertilizers on the farm", "Using ore minerals directly", "Chemical reaction of individual fertilizer components"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Availability and transportation of bulky organic manures is a major challenge", "It improves soil health", "It eliminates the need for chemical fertilizers", "It reduces crop yields"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Partially aerobic conditions", "Anaerobic conditions", "Aerobic conditions", "Dry conditions"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Increase alkalinity of soil", "Kill soil microorganisms", "Speed up conversion of urea to nitrate", "Slow down nitrification, preventing N loss through leaching and denitrification"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Calcium nitrate and other nitrate forms", "Ammonium nitrate", "Ammonium sulphate", "Urea"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Lower nitrogen content", "More expensive", "Requires more time to decompose", "Can be applied to already standing crops (e.g., transplanted paddy) without losing a season"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Dissolves phosphates", "Lives in soil permanently", "Works only with legume roots", "Photosynthesises and fixes N2 through heterocysts (specialised cells)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Two or more plant nutrients", "Organic matter along with nutrients", "All three major nutrients (NPK)", "Only one plant nutrient element"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Soil type", "Moisture content and temperature of the composting mass", "Altitude", "Wind speed"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-1-i,   B-3-iii, C-2-ii,  D-4-iv", "A-2-ii,  B-4-iv,  C-3-iii, D-1-i", "A-3-iii, B-2-ii,  C-1-i,   D-4-iv", "A-4-iv,  B-1-i,   C-4-iv,  D-2-ii"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A-3-iii, B-4-iv, C-1-i,    D-2-ii", "A-2-ii, B-3-iii, C-4-iv,   D-1-i", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-4-i,  B-1-ii,  C-2-iii,  D-3-iv"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-4-iv,  C-2-ii,   D-3-iii", "A-4-iv, B-2-ii,  C-3-iii,  D-1-i", "A-3-iii, B-1-i,  C-2-ii,   D-4-iv", "A-2-ii, B-3-iii, C-1-i,   D-4-iv"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-4-iv, B-3-iii, C-4-iv,   D-1-i", "A-3-iii, B-1-i,   C-2-ii,   D-4-iv", "A-2-ii, B-4-iv,  C-1-i,    D-3-iii", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-2-ii, B-3-iii, C-1-i,   D-4-iv", "A-3-iii, B-1-i,  C-4-iv,  D-2-ii", "A-4-iv, B-4-iv,  C-2-ii,  D-1-i"],
    correct: 0,
