...
export const da121LectureQuestions: Question[] = [
  {
    ...
    "options": [
      "Colour of the soil profile",
      "Chemical composition of bedrock",
      "Clay content of parent material",
  ...
  },
  {
    ...
    "options": [
      "Thermal weathering by temperature change",
      "Physical (mechanical) weathering",
      "Chemical weathering through hydrolysis",
      "Biological weathering by lichens"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Magnesium carbonate and sulphates",
      "Potassium and sodium silicates",
      "Iron (Fe2O3) and aluminium (Al2O3) oxides",
      "Silica (SiO2) and calcium carbonate"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Unweathered bedrock",
      "Maximum biological activity and organic matter",
      "Illuviation (accumulation) of leached materials from above",
      "Partially weathered parent material with original rock structure"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Southern plateau districts (Ranga Reddy, Mahabubnagar)",
      "High altitude forest areas of Adilabad",
      "River delta areas of Krishna and Godavari",
      "North Telangana districts (Nizamabad, Karimnagar)"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Soil profile development increases with time under similar other factors",
      "Time has no significant effect on soil properties",
      "Older soils always have deeper profiles than younger soils",
      "Soils formed in 100 years are identical to those formed in 10,000 years"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Secondary carbonate accumulation for soil management",
      "Maximum microbial activity in soil science",
      "Loss of silicate clay, Fe, and Al by leaching (eluviation)",
      "Accumulation of organic matter and clay"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Porosity = (Particle density – Bulk density) × 100",
      "Porosity = (Bulk density / Particle density) × 100",
      "Porosity = (Organic matter% / Bulk density) × 100",
  ...
  },
  {
    ...
    "options": [
      "Reaches its maximum swelling in soil science",
      "Can be rolled into a 3 mm thread without crumbling",
      "Flows like a liquid under its own weight",
      "Becomes too dry to be moulded for soil management"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Munsell Colour Chart (hue, value, chroma)",
      "Visual comparison with standard soil maps",
      "Spectrophotometer absorbance at 660 nm",
      "Colorimeter readings in nm wavelength"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Prismatic occurs in surface soils, columnar in deep subsoil",
      "Columnar has rounded tops, prismatic has flat tops",
      "Both have identical appearance and occur in the same horizons",
      "Prismatic has rounded tops, columnar has flat tops"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Mass of moist soil per unit volume at field capacity",
      "Mass of dry soil per unit volume of soil solids only",
      "Mass of soil particles per unit volume of water displaced",
  ...
  },
  {
    ...
    "options": [
      "Depth of groundwater table only in soil science",
      "Plant species growing in the field",
      "Soil colour, organic matter, moisture content, and slope aspect",
      "Soil pH and electrical conductivity for soil management"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "The soil dries completely at 105°C in an oven in soil science",
      "The soil is saturated and excess water is allowed to drain for 2–3 days",
      "The soil is dried at 15 bar suction for soil management",
      "The soil is at wilting point after plant uptake in soil fertility"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Saturation percentage – Field capacity",
      "Total pore space – Gravitational water",
      "Field capacity – Permanent wilting point",
      "Hygroscopic coefficient – Permanent wilting point"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Logarithm of soil moisture tension expressed in cm of water column",
      "Water potential expressed in pascals for soil management",
      "Negative logarithm of soil pH in soil science",
      "Ratio of field capacity to particle density"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Moves through macropores under gravity and drains out of the root zone",
      "Is held tightly by clay particles and unavailable to plants",
      "Is retained at field capacity for plant use",
      "Is adsorbed as a monolayer on soil surfaces"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Heavy clay soil",
      "Gravel soil in soil science",
      "Medium loam to silt loam soil",
      "Coarse sandy soil"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Electrical conductivity of soil extract in soil science",
      "Oxygen diffusion rate (ODR) or percentage of air-filled pores",
      "CO₂ concentration in irrigation water for soil management",
      "Total nitrogen gas in soil pores"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Bulk density to water infiltration rate",
      "Soil moisture content to soil matric potential (suction)",
      "Soil organic matter to moisture content",
      "Clay percentage to capillary rise height"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "High pH inhibits oxygen availability in soil science",
      "Water fills all pores, displacing air and restricting O₂ diffusion",
      "Clay particles swell and block nutrient uptake",
      "Excess nitrogen gas is produced by denitrification"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Soil matric potential (tension/suction) for irrigation scheduling",
      "Soil bulk density in situ",
  ...
  },
  {
    ...
    "options": [
      "Higher O₂ and lower CO₂ than the atmosphere",
      "Higher N₂ and lower Ar than the atmosphere",
      "Lower O₂ and higher CO₂ than the atmosphere",
      "Same composition as atmospheric air at all times"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Saturated flow is always slower than unsaturated flow",
      "Water movement in soil is independent of pore size distribution",
  ...
  },
  {
    ...
    "options": [
      "Percentage of CEC occupied by Ca²⁺ and Mg²⁺ only",
      "Total amount of lime required to neutralise soil acidity",
      "Ratio of basic to acidic cations in soil water",
      "Percentage of CEC occupied by basic cations (Ca²⁺, Mg²⁺, K⁺, Na⁺)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "pH in KCl is higher for alkaline soils but lower for acid soils",
      "Both measurements always give identical values",
      "pH in KCl is always higher by 0.5–1.0 units",
      "pH in water is generally higher than pH in KCl by 0.5–1.0 units"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Store water against drainage forces in soil science",
      "Fix nitrogen from the atmosphere for soil management",
      "Maintain constant temperature despite external changes in soil fertility"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Adsorption of anions from soil solution in soil science",
      "Oxidation of organic matter for soil management",
      "Protonation of OH groups at mineral edges in irrigated crop production systems",
      "Isomorphous substitution of higher-valence cations by lower-valence cations in clay lattice"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "ESP = (Na in soil water / Total cations) × 100",
      "ESP = (Na²⁺ / Ca²⁺) ratio × 100",
      "ESP = (Exchangeable Na / CEC) × 100",
      "ESP = (Electrical conductivity × pH) / 100"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Montmorillonite clay under alkaline conditions in soil science",
      "Calcium carbonate at high pH in soil fertility",
      "Organic matter at neutral pH for soil management",
      "Variable-charge surfaces of iron/aluminium oxides and kaolinite edges at low pH"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Buffer pH (SMP or Woodruff buffer) reflecting reserve acidity",
      "Soil pH in water alone for soil management",
      "Total nitrogen content of the soil",
      "Electrical conductivity of saturation extract in soil science"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Phosphorus fixation capacity of the soil",
      "Sodium toxicity risk to crops and soil sodicity development",
      "Irrigation water requirement for crops",
      "Solubility of calcium carbonate in irrigation water"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Dry, hot conditions with very low microbial activity",
      "Warm temperature, adequate moisture, neutral pH, and good aeration",
      "Low temperature, waterlogged, acidic conditions",
      "Cold, high-altitude conditions with slow microbial turnover"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Improves soil aggregation, water-holding capacity, and aeration",
      "Increases bulk density, improving soil compaction for machine traffic",
      "Increases soil pH, reducing need for lime application",
      "Reduces macropore formation, preventing preferential water flow"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Is insoluble in both acid and alkali",
      "Is insoluble in dilute acid but soluble in alkali",
      "Is soluble in both acid and alkali",
      "Is soluble in dilute acid but precipitates in alkali"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Positive charges that adsorb anions in soil science",
      "Neutral surfaces with no charge contribution for soil management",
      "Variable (pH-dependent) negative charges from carboxyl (–COOH) and phenolic (–OH) groups",
      "Permanent negative charges from Si-Al lattice substitution in soil fertility"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Soil organic carbon by wet oxidation with K₂Cr₂O₇",
      "Available phosphorus by Bray-P1 extraction",
      "Soil pH by electrometric method",
      "Soil total nitrogen by Kjeldahl digestion"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Application of fertilizers increasing crop residue production for soil management",
      "Rain priming microbial activity in dry soils in soil science",
      "Addition of fresh organic matter stimulating decomposition of existing stable humus",
      "Temperature increase accelerating nitrification in soil fertility"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Waterlogged peat with very slow decomposition in soil science",
      "Well-mixed, intimate incorporation of organic matter with mineral soil, neutral to slightly acid pH",
      "Thin organic layer with high fungal biomass and low earthworm activity",
      "Thick, acidic, undecomposed litter with sharp boundary from mineral soil for soil management"
    ],
    "correct": 1,
    "explanation": "Mull humus (from deciduous forests) is well-decomposed, intimately mixed with mineral soil by earthworm activity, with near-neutral pH and high microbial activity — ideal."
  },
  {
    "id": "d121l_075",
    "subject": "da-121",
    ...
    "options": [
      "Integration of FYM, green manures, and reduced tillage",
      "Burning crop residues after harvest",
      "Applying urea at high rates to stimulate crop growth",
      "Deep ploughing to mix subsoil with surface soil"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Molecular N₂ gas directly from soil air",
      "Nitrate (NO₃⁻) and ammonium (NH₄⁺) ions",
      "Nitrite (NO₂⁻) and nitrous oxide (N₂O)",
      "Organic amino acids only"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Uniform yellowing (chlorosis) starting from older (lower) leaves, proceeding upward",
      "Purpling of leaves due to anthocyanin accumulation",
      "Interveinal chlorosis starting from youngest leaves in soil science",
      "Brown scorched leaf margins and tips for soil management"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "It is part of the ATP molecule, providing energy for photosynthesis",
      "It fixes atmospheric CO₂ in the Calvin cycle",
      "It is a structural component of chlorophyll molecule",
      "It activates > 60 enzymes and regulates stomatal opening, improving water use efficiency"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Nitrate (NO₃⁻) in soil water",
      "Organic nitrogen in soil organic matter",
      "Ammonium (NH₄⁺) ions in soil solution",
      "Fixed ammonium in clay interlayers"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Yellow-green chlorosis of young leaves in soil science",
      "Interveinal chlorosis with green veins for soil management",
      "Brown necrotic spots on leaf margins in soil fertility",
      "Purple or reddish discolouration of leaves and stems due to anthocyanin accumulation"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Excess K application causing toxicity symptoms in soil science",
      "Uptake of K in excess of plant needs without beneficial effect on yield",
      "K accumulation in roots at the expense of shoots for soil management",
      "K loss from soil by leaching beyond crop requirement in soil fertility"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Alkalinity, salinity and acidity",
      "Soil colour and texture only",
      "Slope and aspect only",
      "Temperature only"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "NH₃ gas through volatilisation",
      "Organic N immobilisation by microbes",
      "NO₃⁻ leaching into groundwater",
      "N₂ and N₂O gases under anaerobic conditions"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Older (lower) leaves, showing marginal and tip scorch (brown scorching)",
      "Flowers and fruits, causing poor fruit set",
      "Young, newly expanded leaves at the shoot apex",
      "Root tips, causing stunted root growth"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Root interception only in soil science",
      "Diffusion (due to very low concentration and small diffusion coefficient)",
      "Mass flow in soil solution (convective flow)",
      "Active pumping by root hairs only for soil management"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "NH₄⁺ converting to NO₃⁻ through biological nitrification in soil science",
      "NH₄⁺ being trapped in the interlayer spaces of 2:1 clay minerals (illite, vermiculite)",
      "NH₄⁺ reacting with soil organic matter to form recalcitrant N",
      "NH₄⁺ volatilising as NH₃ from the soil surface for soil management"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Iron and aluminium phosphates (Fe-P and Al-P)",
      "Calcium phosphates (Ca-P) such as hydroxyapatite",
      "Soluble monocalcium phosphate [Ca(H₂PO₄)₂]"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Marginal scorch of older leaves for soil management",
      "Purple discolouration of older leaves in soil science",
      "Death of growing points (meristems), curling and scorching of young leaf tips",
      "Interveinal chlorosis of mature leaves in soil fertility"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Waterlogged soils with high Fe²⁺ toxicity in soil science",
      "Acid soils below pH 5.5 with high Fe²⁺",
      "Sandy soils with excessive leaching of iron for soil management",
      "Neutral to alkaline soils (pH > 7) where Fe³⁺ becomes insoluble"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "S deficiency appears on younger (upper) leaves first since S is relatively immobile in phloem",
      "S deficiency starts on older leaves like N deficiency in soil science",
      "S deficiency causes purple discolouration unlike N for soil management",
      "S deficiency causes tip burn while N deficiency causes interveinal chlorosis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Blind seed disease",
      "Heart rot in soil science",
      "Brown heart (Hollow stem / Browning)",
      "Whiptail for soil management"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Application of zinc chelate (Zn-EDTA) at 2 kg ha⁻¹ in soil science",
      "Liming the soil to pH 7.0 for soil management",
      "Foliar spray of 0.5% ZnSO₄ alone in soil fertility",
      "Soil application of ZnSO₄ at 25 kg ha⁻¹ or seedling root dip in 2% ZnO suspension"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Marsh spot",
      "Reclamation disease (or Wither tip)",
      "Grey speck",
      "Khaira disease"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Phosphate transport across root cell membranes",
      "Photosystem II water-splitting (oxygen evolution) reaction",
  ...
  },
  {
    ...
    "correct": 2,
    "explanation": "The standard sampling depth testing is 0–15 cm (or 0–20 cm) for most annual crops, as this represents the primary rooting zone receiving fertilizers and amendments."
  },
  {
    "id": "d121l_107",
    "subject": "da-121",
    ...
    "options": [
      "Laboratory analysis of plant tissue alone in soil science",
      "Blanket (fixed) recommendations irrespective of soil test values",
      "Targeted yield approach correlating soil test values with crop response to fertilizers",
      "Farmer experience and traditional practices for soil management"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Walkley-Black wet oxidation with K₂Cr₂O₇",
      "Kjeldahl digestion with H₂SO₄",
      "Colorimetric analysis with Griess reagent"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Calculating rainfall patterns for irrigation planning",
      "Identifying spatial variability and guiding site-specific fertilizer recommendations",
      "Estimating soil erosion rates in watersheds",
      "Determining soil pH for liming recommendations only"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Seed variety recommendations and sowing dates in soil science",
      "Crop insurance premium rates and subsidy eligibility",
      "Rainfall forecast and irrigation scheduling advice for soil management",
      "Soil test values and fertilizer recommendations for 12 nutrient parameters"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Olsen method (NaHCO₃ extraction) in soil science",
      "Boiling water extraction for soil management",
      "DTPA extraction with atomic absorption spectrophotometry",
      "Alkaline permanganate (KMnO₄) method by Subbiah and Asija"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "There is a soil nutrient level above which crop response to added nutrient is unlikely",
      "All soils require the same amount of fertilizer for maximum yield",
      "Nutrients in soil and fertilizer are equally efficient at all levels",
      "Crop yield depends only on the most limiting nutrient"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Soil pH and nutrient availability in soil science",
      "Crop yield and irrigation water applied for soil management",
      "Crop yield and quantity of a limiting nutrient applied (law of diminishing returns)",
      "Soil texture and water holding capacity in soil fertility"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Estimate crop maturity and harvest date in soil science",
      "Identify disease infections from leaf discolouration for soil management",
      "Assess water stress in rice paddies in soil fertility",
      "Determine real-time N status of the crop for split application decisions"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "ECe < 4 dS m⁻¹, pH > 8.5, ESP > 15",
      "ECe > 8 dS m⁻¹, pH < 7, ESP > 30",
      "ECe > 4 dS m⁻¹, pH > 8.5, ESP < 15",
      "ECe > 4 dS m⁻¹, pH < 8.5, ESP < 15"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Agricultural lime (CaCO₃) to increase pH",
      "Gypsum (CaSO₄·2H₂O) to replace Na⁺ with Ca²⁺ on exchange sites",
      "Sulphur (S) to directly neutralise Na⁺",
      "MOP (muriate of potash) to replace Na⁺ with K⁺"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Osmotic stress reducing water uptake ('physiological drought')",
      "Increase in soil pH reducing nutrient availability",
      "Specific ion toxicity of Cl⁻ and Na⁺ only",
      "Destruction of root mycorrhizal associations"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "ECe > 4 dS m⁻¹, ESP < 15, pH < 8.5",
      "ECe < 4 dS m⁻¹, ESP > 15, pH > 8.5",
      "ECe < 4 dS m⁻¹, ESP < 15, pH < 8.5",
      "ECe > 4 dS m⁻¹, ESP > 15, pH 8.0–8.5"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Fe²⁺ (ferrous iron toxicity only)",
      "SO₄²⁻ (sulphate) ions for soil management",
      "H⁺ ion alone in soil science",
      "Al³⁺ and Mn²⁺ ions (aluminium and manganese toxicity)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Amount of lime needed to neutralise soil acidity in soil science",
      "Fraction of applied irrigation water that must pass through the root zone to prevent salt accumulation",
      "Electrical conductivity threshold for crop selection for soil management",
      "Rate of salt movement from subsoil to surface by capillary rise"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Rice (tolerant of submergence; leaching effect)",
      "Groundnut (sensitive to excess moisture)",
      "Cotton (medium-sensitive)"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Electrical conductivity of irrigation water in soil science",
      "Exchangeable sodium that must be replaced to reduce ESP to a target level",
      "Organic carbon content of the soil in soil fertility",
      "Total salt content of the soil for soil management"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Sodic (alkali) soils with hard Na-clay crusts",
      "Waterlogged peat soils",
      "Laterite soils of Western Ghats",
      "Acid soils in humid forests"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Rice = Barley (equally most tolerant) > Beans > Cotton",
      "Groundnut > Wheat > Maize > Cotton (most to least tolerant)",
      "Barley > Wheat > Rice > Sugarbeet (most to least tolerant)",
      "Sugarbeet > Barley > Cotton > Wheat > Rice > Beans (approximate tolerance order)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Microbial oxidation of S produces H₂SO₄ which reacts with CaCO₃ to release Ca²⁺ for Na⁺ replacement",
      "S directly precipitates Na⁺ as Na₂SO₄ in soil science",
      "S provides sulphur nutrition to crops growing in alkaline soils for soil management",
      "S raises soil pH, improving structure in soil fertility"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Gujarat, Rajasthan, Haryana, Punjab, Maharashtra coastal areas",
      "West Bengal and Assam (high rainfall areas)",
      "Himachal Pradesh and Uttarakhand (hill states)",
      "Kerala and Karnataka humid zones"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Rainfall erosivity factor in soil science",
      "Soil erodibility factor (resistance of soil to erosion and transport)",
      "Crop and management factor for soil management",
      "Slope length and steepness factor in soil fertility"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Wind removal of fine particles from the soil surface in soil fertility",
      "Removal of soil in distinct channels cut by concentrated water flow in soil science",
      "Large-scale mass movement of soil on steep slopes for soil management",
      "Relatively uniform removal of a thin layer of soil over a broad area by raindrop splash and surface runoff"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Threshold rainfall intensity triggering erosion in soil science",
      "Maximum tolerable soil temperature for crop growth for soil management",
      "Total organic matter needed to maintain soil fertility",
      "Maximum rate of soil erosion (in t ha⁻¹ yr⁻¹) that still permits sustained crop productivity"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Planting trees along ridgelines to break wind velocity",
      "Constructing earthen embankments along contour lines to impede downslope water flow",
      "Deep ploughing to break impervious hardpan layers",
      "Applying chemical soil stabilisers to the surface"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Rills form in sandy soils while gullies form only in clay soils in irrigated crop production systems",
      "Rills are small, shallow channels that can be removed by normal tillage; gullies are large, deep channels that cannot",
      "Rills are deeper (> 30 cm) and cannot be obliterated by normal tillage",
      "Rill erosion occurs only on flat land, gully erosion only on steep slopes"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Increasing soil moisture to above field capacity in soil science",
      "Reducing wind velocity near the soil surface and trapping drifting soil particles",
      "Acidifying soil pH to increase cohesion for soil management",
      "Providing organic matter through leaf fall to bind soil particles"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Relief factor based on land slope",
      "Runoff coefficient of the watershed in soil science",
      "Root density factor reducing erosion for soil management",
      "Rainfall erosivity (based on rainfall kinetic energy × intensity)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Flat to gently sloping land (< 1%)",
      "Sandy desert soils with low clay content",
      "Moderately to steeply sloping cultivated lands (> 5%)",
      "Heavy-textured waterlogged valley soils"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Construction of concrete check dams in soil science",
      "Deep ploughing to bury eroded material",
      "Application of chemical soil conditioners for soil management",
      "Establishment of grass cover, contour grass strips (vegetative barriers)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Raindrops compact the soil surface, directly causing erosion in soil science",
      "Raindrops create macropores that increase infiltration for soil management",
      "Raindrops dissolve clay and carry it in suspension immediately",
      "Raindrops detach soil particles on impact, making them available for transport by runoff"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Protecting soil surface from raindrop impact, reducing runoff, and improving infiltration",
      "Compacting the surface to prevent wind erosion in soil science",
      "Adding nitrogen to the soil through biological fixation",
      "Increasing soil pH to reduce erosion for soil management"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Planting crops in single rows perpendicular to slope direction in irrigated crop production systems",
      "Alternating strips of erosion-permitting (row crops) and erosion-resisting (grasses/legumes) crops along contours",
      "Removing all vegetation in strips to allow rainwater infiltration",
      "Growing a single crop in a wide strip across the entire field in irrigated crop production systems"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Individual farm plot only in soil science in irrigated crop production systems",
      "Individual tree planting programs for soil management",
      "An entire natural drainage unit (catchment) treating land and water resources holistically",
      "State-level policy for irrigation allocation in soil fertility"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Bare fallow between crops",
      "Contour tillage and planting (across the slope)",
      "Burning crop residues before sowing",
      "Deep ploughing along the slope direction"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Estimating soil texture by particle size analysis",
  ...
  },
  {
    ...
    "options": [
      "Gravitational water has drained away (typically 1-3 days after saturation)",
      "Complete air drying",
      "All water has drained from soil",
  ...
  },
  {
    ...
    "options": [
      "Nitrates are converted back to gaseous nitrogen (N2) by microorganisms",
      "Ammonium is converted to nitrate",
      "Organic nitrogen is converted to ammonium",
      "Atmospheric nitrogen is fixed into soil"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Increases soil pH significantly",
      "Does not decompose at all",
      "Decomposes slowly and may cause temporary nitrogen immobilization",
      "Decomposes rapidly releasing nitrogen"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Living soil microorganisms",
      "Stable, dark-coloured, colloidal end product of organic matter decomposition",
      "Fresh undecomposed plant material",
  ...
  },
  {
    ...
    "options": [
      ...
      "Only reduce soil aeration",
      "Have large surface area and carry negative charges attracting cations"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Release anions into solution",
      "Exchange or substitute cations between soil solution and soil particles",
  ...
  },
  {
    ...
    "options": [
      ...
      "Fe, Mn, Zn, Cu, B (micronutrients become less available)",
      "Manganese and zinc only"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Volcanic activity",
      "Intensive leaching in high rainfall areas leaving Fe and Al oxides",
      "Wind deposition"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "The plant cannot complete its life cycle without it and no other element can substitute for it",
      "It must be produced by the plant itself",
      "Its absence causes no visible deficiency",
      "It must be present in large quantities"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Yellowing (chlorosis) starting from older/lower leaves",
      "Brown scorching of leaf margins",
  ...
  },
  {
    ...
    "options": [
      ...
      "Purple or reddish coloration of leaves (due to anthocyanin accumulation)",
      "Tip burn"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Brown scorching/burning of leaf tips and margins (tip burn)",
      "Purple coloration",
  ...
  },
  {
    ...
    "options": [
      ...
      "Only the roots",
      "Older mature leaves",
      "Young tissues and growing points (meristematic tissues)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Yellowing starting from old leaves",
      "Marginal burning of leaves",
      "Purple coloration",
      "Interveinal chlorosis on young leaves (veins remain green, between veins turn yellow)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Brown leaf tips",
      "Death of growing points, malformation of fruits and hollow heart in crops like cauliflower",
      "Interveinal chlorosis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Measuring crop yield in soil science",
      "Diagnosing soil nutrient status and making fertilizer recommendations",
      "Predicting pest outbreaks for soil management",
      "Weather forecasting in soil fertility"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Applying maximum possible nutrients",
      "Applying uniform fertiliser to entire farm",
      "Tailoring nutrient application based on specific soil and crop needs of each location"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      ...
      "Excessive use of agrochemicals, industrial waste, and heavy metals",
      "Water movement",
      "Wind action"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Acidity due to mineral weathering",
      "Acidity due to hydrogen ions in soil solution",
      "Acidity due to exchangeable cations on colloids",
      "Acidity created by microorganisms"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Calcium carbonate",
      "Sodium chloride and sodium sulphate salts",
      "Iron oxide",
      "Aluminium sulphate"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Himalayan foothills and river plains",
      "Coastal areas only",
      "Rajasthan desert",
      "Deccan Plateau"
    ],
  ...
  },
  {
    ...
    "options": [
      "Interveinal chlorosis on young leaves with grey or tan spots",
      "Necrotic tips",
      "Yellowing from older leaves",
      "Purple coloration"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Yellowing and withering of young leaves (die-back of shoots, reclamation disease)",
  ...
  },
  {
    ...
    "options": [
      ...
      "Describe soil color using hue, value and chroma",
  ...
  },
  {
    ...
    "options": [
      "The rate at which water evaporates from soil",
      "The rate at which water enters the soil from surface",
      "The rate at which roots absorb water",
      "The rate of water movement below the root zone"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Sandy texture",
      "Compaction, reduced porosity and poor root growth",
      "Good porosity and aeration"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Only soil pH",
      "Only drainage",
      "Soil structure, water holding capacity, CEC, and microbial activity"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Green plants absorb more sunlight",
      "Ocean temperatures decrease",
      "The sun's radiation becomes more intense",
      "Greenhouse gases trap long-wave radiation from Earth's surface, preventing heat loss to space"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "It measures crop potential only",
      "It predicts the weather",
      "It helps determine the existing nutrient levels and avoid over/under application",
      "It tells us only about soil texture"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Clay-dominated alkaline soils",
      "Sandy soils",
      "Black cotton soils",
      "Highly weathered tropical soils with iron and aluminium oxides"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Hydrogen and aluminium ions only",
  ...
  },
  {
    ...
    "options": [
      ...
      "Wilting point and oven-dry",
      "Saturation and hygroscopic coefficient"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Saturation and field capacity",
      "Field capacity and permanent wilting point",
      "Maximum water-holding capacity and saturation"
    ],
    "correct": 2,
