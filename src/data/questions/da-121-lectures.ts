...
export const da121LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["Adsorption of anions from soil solution in soil science", "Oxidation of organic matter for soil management", "Protonation of OH groups at mineral edges in irrigated crop production systems", "Isomorphous substitution of higher-valence cations by lower-valence cations in clay lattice"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Individual farm plot only in soil science in irrigated crop production systems", "Individual tree planting programs for soil management", "An entire natural drainage unit (catchment) treating land and water resources holistically", "State-level policy for irrigation allocation in soil fertility"],
    correct: 2,
