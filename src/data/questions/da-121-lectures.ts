...
export const da121LectureQuestions: Question[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["Clay content of parent material", "Climate (temperature and precipitation)", "Colour of the soil profile", "Chemical composition of bedrock"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Physical (mechanical) weathering", "Chemical weathering through hydrolysis", "Biological weathering by lichens", "Thermal weathering by temperature change"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Oxisols", "Spodosols", "Vertisols", "Mollisols"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Granite and gneiss rocks", "Basalt (Deccan trap) rock", "Alluvial sediments from rivers", "Coastal marine deposits"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Silica (SiO2) and calcium carbonate", "Iron (Fe2O3) and aluminium (Al2O3) oxides", "Potassium and sodium silicates", "Magnesium carbonate and sulphates"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Maximum biological activity and organic matter", "Illuviation (accumulation) of leached materials from above", "Partially weathered parent material with original rock structure", "Unweathered bedrock"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Transported soil (alluvial)", "Residual soil (sedentary)", "Colluvial soil", "Aeolian soil"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Calcification", "Podzolization", "Lessivage (Argilluviation)", "Gleization"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["North Telangana districts (Nizamabad, Karimnagar)", "Southern plateau districts (Ranga Reddy, Mahabubnagar)", "River delta areas of Krishna and Godavari", "High altitude forest areas of Adilabad"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Older soils always have deeper profiles than younger soils", "Soil profile development increases with time under similar other factors", "Time has no significant effect on soil properties", "Soils formed in 100 years are identical to those formed in 10,000 years"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Colluvial soil", "Lacustrine soil", "Aeolian soil", "Marine soil"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Entisols", "Vertisols", "Inceptisols", "Aridisols"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Accumulation of organic matter and clay", "Loss of silicate clay, Fe, and Al by leaching (eluviation)", "Secondary carbonate accumulation", "Maximum microbial activity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vertisols", "Oxisols", "Entisols or Inceptisols", "Spodosols"],
    correct: 2,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["< 0.002 mm", "< 0.02 mm", "0.002–0.05 mm", "0.05–0.10 mm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1.0–1.2 Mg m⁻³", "1.3–1.5 Mg m⁻³", "2.6–2.7 Mg m⁻³", "3.0–3.5 Mg m⁻³"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Platy structure", "Granular (crumb) structure", "Massive structure", "Single grain structure"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Can be rolled into a 3 mm thread without crumbling", "Flows like a liquid under its own weight", "Becomes too dry to be moulded", "Reaches its maximum swelling"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["25–50%", "50–70%", "70–85%", "85–90%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Colorimeter readings in nm wavelength", "Munsell Colour Chart (hue, value, chroma)", "Spectrophotometer absorbance at 660 nm", "Visual comparison with standard soil maps"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sandy soil", "Sandy loam", "Clay soil", "Loamy sand"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Shrinkage limit apparatus", "Casagrande cup (liquid limit device)", "Tensile strength meter", "Proctor compaction test"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Prismatic has rounded tops, columnar has flat tops", "Columnar has rounded tops, prismatic has flat tops", "Prismatic occurs in surface soils, columnar in deep subsoil", "Both have identical appearance and occur in the same horizons"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Gravel (> 2 mm)", "Coarse sand (0.5–2 mm)", "Clay (< 0.002 mm)", "Fine silt (0.002–0.02 mm)"],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "Depth of groundwater table only",
  ...
  },
  {
    ...
    options: ["Sandy clay loam", "Loam", "Clay loam", "Silt loam"],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      "The soil dries completely at 105°C in an oven",
      "The soil is dried at 15 bar suction",
      "The soil is at wilting point after plant uptake"
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: ["–0.033 MPa (1/3 bar)", "–0.1 MPa (1 bar)", "–1.5 MPa (15 bar)", "–3.0 MPa (30 bar)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["–0.033 MPa", "–0.3 MPa", "–1.5 MPa", "–3.1 MPa"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Coarse sandy soil", "Medium loam to silt loam soil", "Heavy clay soil", "Gravel soil"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "CO₂ concentration in irrigation water",
  ...
  },
  {
    ...
    options: [
      "0 to –0.033 MPa",
      "–0.033 MPa to –1.5 MPa (0.33 to 15 bar)",
      "–1.5 MPa to –3.1 MPa",
      "Greater than –3.1 MPa (31 bar)"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "High pH inhibits oxygen availability"
    ],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["mg kg⁻¹", "cmol(+) kg⁻¹ (centimoles of charge per kg)", "mmol L⁻¹", "meq per 100 g (equivalent to cmol(+) kg⁻¹)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["10⁻⁷ mol L⁻¹", "10⁻¹⁴ mol L⁻¹", "10⁻¹ mol L⁻¹", "7 mol L⁻¹"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Iron (Fe)", "Manganese (Mn)", "Phosphorus (P)", "Zinc (Zn)"],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      "Montmorillonite has larger particle size and thus more surface area",
      "Montmorillonite is a 2:1 lattice clay with isomorphous substitution and expandable layers",
      "Kaolinite is a 1:1 clay that adsorbs more cations due to its rigid structure",
      "Montmorillonite occurs in acid soils with higher H⁺ concentration"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Store water against drainage forces",
      "Maintain constant temperature despite external changes",
  ...
  },
  {
    ...
    options: ["Above 7.5 (alkaline)", "Between 6.5–7.0 (neutral)", "Below 5.5 (acidic)", "At exactly pH 7.0"],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      "Montmorillonite clay under alkaline conditions",
      "Variable-charge surfaces of iron/aluminium oxides and kaolinite edges at low pH",
      "Organic matter at neutral pH",
      "Calcium carbonate at high pH"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["pH 4.0–5.5", "pH 5.5–6.5", "pH > 7.0 (alkaline)", "pH 6.0–6.5"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["4.0–5.0", "5.5–7.5", "7.5–9.0", "9.0–11.0"],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["20–30%", "45–55%", "70–80%", "10–15%"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5:1", "10–12:1", "25–30:1", "50–60:1"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Humin", "Humic acid", "Fulvic acid", "Hymatomelanic acid"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["10–12:1", "20–25:1", "40–80:1", "100–150:1"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Nitrification", "Denitrification", "Ammonification (mineralisation)", "Nitrogen fixation"],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      "Permanent negative charges from Si-Al lattice substitution",
      "Variable (pH-dependent) negative charges from carboxyl (–COOH) and phenolic (–OH) groups",
      "Positive charges that adsorb anions",
      "Neutral surfaces with no charge contribution"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Application of fertilizers increasing crop residue production",
      "Rain priming microbial activity in dry soils",
      "Temperature increase accelerating nitrification"
    ],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      "Thick, acidic, undecomposed litter with sharp boundary from mineral soil",
      "Well-mixed, intimate incorporation of organic matter with mineral soil, neutral to slightly acid pH",
      "Waterlogged peat with very slow decomposition",
  ...
  },
  {
    ...
    options: [
      ...
      "Nitrogen mineralisation or immobilisation upon decomposition",
      "Potassium leaching from the profile",
  ...
  },
  {
    ...
    options: [
      "Interveinal chlorosis starting from youngest leaves",
      "Uniform yellowing (chlorosis) starting from older (lower) leaves, proceeding upward",
      "Brown scorched leaf margins and tips",
  ...
  },
  {
    ...
    options: ["4.0–5.0", "5.5–6.5", "7.5–8.5", "9.0–10.0"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Yellow-green chlorosis of young leaves",
  ...
  },
  {
    ...
    options: [
      "Excess K application causing toxicity symptoms",
      "Uptake of K in excess of plant needs without beneficial effect on yield",
      "K accumulation in roots at the expense of shoots",
      "K loss from soil by leaching beyond crop requirement"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["< 0.01 mg P L⁻¹", "0.2–0.3 mg P L⁻¹", "5–10 mg P L⁻¹", "50–100 mg P L⁻¹"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["< 0.1%", "0.4–0.5%", "2.0–3.0%", "5.0–6.0%"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "NH₄⁺ volatilising as NH₃ from the soil surface",
      "NH₄⁺ converting to NO₃⁻ through biological nitrification"
    ],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: [
      "Interveinal chlorosis of mature leaves",
      "Death of growing points (meristems), curling and scorching of young leaf tips",
      "Marginal scorch of older leaves",
      "Purple discolouration of older leaves"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Waterlogged soils with high Fe²⁺ toxicity",
      "Sandy soils with excessive leaching of iron"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Khaira disease", "White bud", "Reclamation disease", "Whiptail"],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      "S deficiency starts on older leaves like N deficiency",
      "S deficiency appears on younger (upper) leaves first since S is relatively immobile in phloem",
      "S deficiency causes purple discolouration unlike N",
  ...
  },
  {
    ...
    options: ["Heart rot", "Brown heart (Hollow stem / Browning)", "Whiptail", "Blind seed disease"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Whiptail", "Heart rot", "Grey speck", "Khaira disease"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Wheat", "Peas", "Cotton", "Groundnut"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Foliar spray of 0.5% ZnSO₄ alone",
      "Soil application of ZnSO₄ at 25 kg ha⁻¹ or seedling root dip in 2% ZnO suspension",
      "Application of zinc chelate (Zn-EDTA) at 2 kg ha⁻¹",
      "Liming the soil to pH 7.0"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Grey speck", "Reclamation disease (or Wither tip)", "Marsh spot", "Khaira disease"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["ATP (adenosine triphosphate)", "Chlorophyll (porphyrin ring)", "Cell wall pectin", "Phytochrome"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5.0 mg kg⁻¹", "2.0 mg kg⁻¹", "0.6 mg kg⁻¹", "0.1 mg kg⁻¹"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["0.01 mg L⁻¹", "0.5 mg L⁻¹", "100–300 mg L⁻¹", "500 mg L⁻¹"],
    correct: 2,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["0–5 cm", "0–15 cm (or 0–20 cm)", "0–30 cm", "0–60 cm"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Farmer experience and traditional practices",
      "Laboratory analysis of plant tissue alone"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["< 1 mg kg⁻¹", "< 5 mg kg⁻¹ (medium or lower)", "< 25 mg kg⁻¹", "< 50 mg kg⁻¹"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "0.5M NaHCO₃ at pH 8.5",
      "0.03N NH₄F + 0.025N HCl",
      "1N NH₄OAc at pH 7",
      "0.1N H₂SO₄"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["< 50 kg K₂O ha⁻¹", "< 110–150 kg K₂O ha⁻¹", "< 300 kg K₂O ha⁻¹", "< 500 kg K₂O ha⁻¹"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Rainfall forecast and irrigation scheduling advice",
      "Seed variety recommendations and sowing dates"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Iron (Fe), Manganese (Mn), Zinc (Zn), and Copper (Cu) micronutrients",
  ...
  },
  {
    ...
    options: [
      "Identify disease infections from leaf discolouration",
      "Determine real-time N status of the crop for split application decisions",
      "Estimate crop maturity and harvest date",
      "Assess water stress in rice paddies"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Gypsum requirement (GR)", "Lime requirement (LR)", "Sulphur requirement", "Buffer capacity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["H⁺ ion alone", "Al³⁺ and Mn²⁺ ions (aluminium and manganese toxicity)", "Fe²⁺ (ferrous iron toxicity only)", "SO₄²⁻ (sulphate) ions"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Amount of lime needed to neutralise soil acidity",
      ...
      "Electrical conductivity threshold for crop selection"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wheat (sensitive to waterlogging)", "Rice (tolerant of submergence; leaching effect)", "Cotton (medium-sensitive)", "Groundnut (sensitive to excess moisture)"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Total salt content of the soil",
  ...
  },
  {
    ...
    options: ["Acid soils in humid forests", "Sodic (alkali) soils with hard Na-clay crusts", "Waterlogged peat soils", "Laterite soils of Western Ghats"],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "S directly precipitates Na⁺ as Na₂SO₄",
      "Microbial oxidation of S produces H₂SO₄ which reacts with CaCO₃ to release Ca²⁺ for Na⁺ replacement",
      "S raises soil pH, improving structure",
      "S provides sulphur nutrition to crops growing in alkaline soils"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Removal of soil in distinct channels cut by concentrated water flow",
      "Relatively uniform removal of a thin layer of soil over a broad area by raindrop splash and surface runoff",
      "Large-scale mass movement of soil on steep slopes",
      "Wind removal of fine particles from the soil surface"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Maximum tolerable soil temperature for crop growth",
      "Maximum rate of soil erosion (in t ha⁻¹ yr⁻¹) that still permits sustained crop productivity",
      "Threshold rainfall intensity triggering erosion",
  ...
  },
  {
    ...
    options: [
      ...
      "Rills form in sandy soils while gullies form only in clay soils",
  ...
  },
  {
    ...
    options: [
      "Increasing soil moisture to above field capacity",
      ...
      "Acidifying soil pH to increase cohesion"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      ...
      "Root density factor reducing erosion",
      "Runoff coefficient of the watershed",
  ...
  },
  {
    ...
    options: ["Deflation", "Abrasion", "Saltation", "Deposition"],
    correct: 0,
  ...
  },
  {
    ...
    options: [
      "Application of chemical soil conditioners",
  ...
  },
  {
    ...
    options: [
      "Raindrops compact the soil surface, directly causing erosion",
      "Raindrops detach soil particles on impact, making them available for transport by runoff",
      "Raindrops create macropores that increase infiltration",
  ...
  },
  {
    ...
    options: [
      "Increasing soil pH to reduce erosion",
      ...
      "Compacting the surface to prevent wind erosion"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Growing a single crop in a wide strip across the entire field",
      ...
      "Planting crops in single rows perpendicular to slope direction"
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      "Individual farm plot only",
      "An entire natural drainage unit (catchment) treating land and water resources holistically",
      "State-level policy for irrigation allocation",
      "Individual tree planting programs"
    ],
    correct: 1,
