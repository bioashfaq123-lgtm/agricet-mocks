...
export const da121LectureQuestions: Question[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["Climate (temperature and precipitation)", "Chemical composition of bedrock", "Clay content of parent material", "Colour of the soil profile"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Spodosols", "Mollisols", "Vertisols", "Oxisols"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Basalt (Deccan trap) rock", "Coastal marine deposits", "Alluvial sediments from rivers", "Granite and gneiss rocks"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Magnesium carbonate and sulphates", "Iron (Fe2O3) and aluminium (Al2O3) oxides", "Potassium and sodium silicates", "Silica (SiO2) and calcium carbonate"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Unweathered bedrock", "Illuviation (accumulation) of leached materials from above", "Maximum biological activity and organic matter", "Partially weathered parent material with original rock structure"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Colluvial soil", "Residual soil (sedentary)", "Aeolian soil", "Transported soil (alluvial)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Podzolization", "Gleization", "Lessivage (Argilluviation)", "Calcification"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Time has no significant effect on soil properties", "Soil profile development increases with time under similar other factors", "Older soils always have deeper profiles than younger soils", "Soils formed in 100 years are identical to those formed in 10,000 years"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vertisols", "Inceptisols", "Aridisols", "Entisols"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Spodosols", "Vertisols", "Oxisols", "Entisols or Inceptisols"],
    correct: 3,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["0.002–0.05 mm", "0.05–0.10 mm", "< 0.002 mm", "< 0.02 mm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["1.3–1.5 Mg m⁻³", "1.0–1.2 Mg m⁻³", "2.6–2.7 Mg m⁻³", "3.0–3.5 Mg m⁻³"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Porosity = [1 – (Bulk density / Particle density)] × 100", "Porosity = (Bulk density / Particle density) × 100", "Porosity = (Organic matter% / Bulk density) × 100", "Porosity = (Particle density – Bulk density) × 100"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["85–90%", "25–50%", "70–85%", "50–70%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Loamy sand", "Sandy soil", "Sandy loam", "Clay soil"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Tensile strength meter", "Casagrande cup (liquid limit device)", "Shrinkage limit apparatus", "Proctor compaction test"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Columnar has rounded tops, prismatic has flat tops", "Prismatic occurs in surface soils, columnar in deep subsoil", "Both have identical appearance and occur in the same horizons", "Prismatic has rounded tops, columnar has flat tops"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Clay (< 0.002 mm)", "Coarse sand (0.5–2 mm)", "Fine silt (0.002–0.02 mm)", "Gravel (> 2 mm)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Activity of earthworms", "Repeated tillage of dry soil", "Addition of organic matter", "Root exudates from plants"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["–3.0 MPa (30 bar)", "–0.033 MPa (1/3 bar)", "–0.1 MPa (1 bar)", "–1.5 MPa (15 bar)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Field capacity – Permanent wilting point", "Total pore space – Gravitational water", "Saturation percentage – Field capacity", "Hygroscopic coefficient – Permanent wilting point"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Electrical conductivity of soil moisture", "Total dissolved salts in soil water", "Soil bulk density in situ", "Soil matric potential (tension/suction) for irrigation scheduling"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Gravimetric water content", "Moisture equivalent", "Pore saturation percentage", "Volumetric water content"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Saturated flow is always slower than unsaturated flow", "Water moves from high water potential to low water potential", "Water movement in soil is independent of pore size distribution", "Water moves from low water potential to high water potential"],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["meq per 100 g (equivalent to cmol(+) kg⁻¹)", "mmol L⁻¹", "cmol(+) kg⁻¹ (centimoles of charge per kg)", "mg kg⁻¹"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Manganese (Mn)", "Iron (Fe)", "Zinc (Zn)", "Phosphorus (P)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Percentage of CEC occupied by Ca²⁺ and Mg²⁺ only", "Percentage of CEC occupied by basic cations (Ca²⁺, Mg²⁺, K⁺, Na⁺)", "Ratio of basic to acidic cations in soil water", "Total amount of lime required to neutralise soil acidity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["pH in water is generally higher than pH in KCl by 0.5–1.0 units", "Both measurements always give identical values", "pH in KCl is always higher by 0.5–1.0 units", "pH in KCl is higher for alkaline soils but lower for acid soils"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Montmorillonite is a 2:1 lattice clay with isomorphous substitution and expandable layers", "Montmorillonite occurs in acid soils with higher H⁺ concentration", "Montmorillonite has larger particle size and thus more surface area", "Kaolinite is a 1:1 clay that adsorbs more cations due to its rigid structure"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Phosphorus fixation capacity of the soil", "Solubility of calcium carbonate in irrigation water", "Irrigation water requirement for crops", "Sodium toxicity risk to crops and soil sodicity development"],
    correct: 3,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["10–15%", "20–30%", "45–55%", "70–80%"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Humic acid", "Fulvic acid", "Hymatomelanic acid", "Humin"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Warm temperature, adequate moisture, neutral pH, and good aeration", "Dry, hot conditions with very low microbial activity", "Low temperature, waterlogged, acidic conditions", "Cold, high-altitude conditions with slow microbial turnover"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["10–12:1", "40–80:1", "20–25:1", "100–150:1"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Soil pH by electrometric method", "Available phosphorus by Bray-P1 extraction", "Soil organic carbon by wet oxidation with K₂Cr₂O₇", "Soil total nitrogen by Kjeldahl digestion"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Potassium leaching from the profile", "Phosphorus fixation in the soil", "Nitrogen mineralisation or immobilisation upon decomposition", "Water infiltration rate"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Burning crop residues after harvest", "Integration of FYM, green manures, and reduced tillage", "Applying urea at high rates to stimulate crop growth", "Deep ploughing to mix subsoil with surface soil"],
    correct: 1,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["Molecular N₂ gas directly from soil air", "Organic amino acids only", "Nitrite (NO₂⁻) and nitrous oxide (N₂O)", "Nitrate (NO₃⁻) and ammonium (NH₄⁺) ions"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["It is part of the ATP molecule, providing energy for photosynthesis", "It activates > 60 enzymes and regulates stomatal opening, improving water use efficiency", "It is a structural component of chlorophyll molecule", "It fixes atmospheric CO₂ in the Calvin cycle"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["NH₃ gas through volatilisation", "Organic N immobilisation by microbes", "N₂ and N₂O gases under anaerobic conditions", "NO₃⁻ leaching into groundwater"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["5.0–6.0%", "2.0–3.0%", "< 0.1%", "0.4–0.5%"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Flowers and fruits, causing poor fruit set", "Older (lower) leaves, showing marginal and tip scorch (brown scorching)", "Young, newly expanded leaves at the shoot apex", "Root tips, causing stunted root growth"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Organic phosphate esters", "Calcium phosphates (Ca-P) such as hydroxyapatite", "Iron and aluminium phosphates (Fe-P and Al-P)", "Soluble monocalcium phosphate [Ca(H₂PO₄)₂]"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reclamation disease", "Khaira disease", "White bud", "Whiptail"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Khaira disease", "Whiptail", "Heart rot", "Grey speck"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reclamation disease (or Wither tip)", "Marsh spot", "Grey speck", "Khaira disease"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Cell wall pectin", "ATP (adenosine triphosphate)", "Chlorophyll (porphyrin ring)", "Phytochrome"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["2.0 mg kg⁻¹", "0.1 mg kg⁻¹", "0.6 mg kg⁻¹", "5.0 mg kg⁻¹"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["100–300 mg L⁻¹", "500 mg L⁻¹", "0.5 mg L⁻¹", "0.01 mg L⁻¹"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["0.01 mg kg⁻¹", "5.0 mg kg⁻¹", "0.5 mg kg⁻¹", "2.0 mg kg⁻¹"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Lysine and arginine", "Cysteine and methionine", "Glycine and alanine", "Proline and hydroxyproline"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Phosphate transport across root cell membranes", "Protein synthesis in ribosomes", "Photosystem II water-splitting (oxygen evolution) reaction", "Nitrogen fixation in root nodules"],
    correct: 2,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["0–30 cm", "0–60 cm", "0–5 cm", "0–15 cm (or 0–20 cm)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["< 5 mg kg⁻¹ (medium or lower)", "< 25 mg kg⁻¹", "< 50 mg kg⁻¹", "< 1 mg kg⁻¹"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["1N NH₄OAc at pH 7", "0.1N H₂SO₄", "0.5M NaHCO₃ at pH 8.5", "0.03N NH₄F + 0.025N HCl"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["< 500 kg K₂O ha⁻¹", "< 300 kg K₂O ha⁻¹", "< 50 kg K₂O ha⁻¹", "< 110–150 kg K₂O ha⁻¹"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Ion exchange chromatography", "Kjeldahl digestion with H₂SO₄", "Walkley-Black wet oxidation with K₂Cr₂O₇", "Colorimetric analysis with Griess reagent"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Nutrients in soil and fertilizer are equally efficient at all levels", "All soils require the same amount of fertilizer for maximum yield", "There is a soil nutrient level above which crop response to added nutrient is unlikely", "Crop yield depends only on the most limiting nutrient"],
    correct: 2,
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    options: ["8 dS m⁻¹", "4 dS m⁻¹", "2 dS m⁻¹", "1 dS m⁻¹"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lime requirement (LR)", "Gypsum requirement (GR)", "Buffer capacity", "Sulphur requirement"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Specific ion toxicity of Cl⁻ and Na⁺ only", "Increase in soil pH reducing nutrient availability", "Osmotic stress reducing water uptake ('physiological drought')", "Destruction of root mycorrhizal associations"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["ECe > 4 dS m⁻¹, ESP > 15, pH 8.0–8.5", "ECe < 4 dS m⁻¹, ESP > 15, pH > 8.5", "ECe < 4 dS m⁻¹, ESP < 15, pH < 8.5", "ECe > 4 dS m⁻¹, ESP < 15, pH < 8.5"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Rice (tolerant of submergence; leaching effect)", "Wheat (sensitive to waterlogging)", "Groundnut (sensitive to excess moisture)", "Cotton (medium-sensitive)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Waterlogged peat soils", "Sodic (alkali) soils with hard Na-clay crusts", "Laterite soils of Western Ghats", "Acid soils in humid forests"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sugarbeet > Barley > Cotton > Wheat > Rice > Beans (approximate tolerance order)", "Groundnut > Wheat > Maize > Cotton (most to least tolerant)", "Barley > Wheat > Rice > Sugarbeet (most to least tolerant)", "Rice = Barley (equally most tolerant) > Beans > Cotton"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Planting trees along ridgelines to break wind velocity", "Applying chemical soil stabilisers to the surface", "Deep ploughing to break impervious hardpan layers", "Constructing earthen embankments along contour lines to impede downslope water flow"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Flat to gently sloping land (< 1%)", "Sandy desert soils with low clay content", "Heavy-textured waterlogged valley soils", "Moderately to steeply sloping cultivated lands (> 5%)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Bare fallow between crops", "Deep ploughing along the slope direction", "Burning crop residues before sowing", "Contour tillage and planting (across the slope)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["3000 years", "12000 years", "5000 years", "9000 years"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["20% water + 20% air", "25% water + 25% air", "30% water + 30% air", "10% water + 10% air"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["0.2-2.0 mm", "0.002-0.02 mm", "< 0.002 mm", "0.02-0.2 mm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["0.002 mm", "0.00002 mm", "0.0002 mm", "0.02 mm"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Sand, silt and clay in the soil", "Organic matter, minerals, water and air", "Macro and micro aggregates", "Nitrogen, phosphorus and potassium"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Estimating soil texture by particle size analysis", "Measuring soil pH", "Determining soil organic matter", "Measuring soil moisture"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Granular/Crumb", "Platy", "Columnar", "Blocky"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Total volume (including pore space)", "Particle volume", "Organic matter volume", "Water volume"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["1.0-1.2 g/cm³", "3.5 g/cm³", "2.65 g/cm³", "1.5-1.8 g/cm³"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Gravitational water has drained away (typically 1-3 days after saturation)", "All water has drained from soil", "Complete air drying", "Plants wilt permanently"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["0.33 bar", "15 bar", "1 bar", "0.1 bar"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Nitrobacter", "Nitrosomonas", "Thiobacillus", "Clostridium"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Nitrates are converted back to gaseous nitrogen (N2) by microorganisms", "Ammonium is converted to nitrate", "Atmospheric nitrogen is fixed into soil", "Organic nitrogen is converted to ammonium"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Decomposes rapidly releasing nitrogen", "Does not decompose at all", "Decomposes slowly and may cause temporary nitrogen immobilization", "Increases soil pH significantly"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Living soil microorganisms", "Stable, dark-coloured, colloidal end product of organic matter decomposition", "Clay minerals in soil", "Fresh undecomposed plant material"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["cmol(p+)/kg (or meq/100g)", "% by weight", "mg/100g of soil", "ppm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Iron", "Aluminium (Al) and Manganese (Mn)", "Calcium", "Magnesium"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Manganese and zinc only", "Nitrogen and phosphorus", "Fe, Mn, Zn, Cu, B (micronutrients become less available)", "Potassium and calcium"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["8 dS/m", "4 dS/m", "12 dS/m", "2 dS/m"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Saline soils", "Sodic/alkaline soils", "Acid soils", "Sandy soils"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sodic soils", "Waterlogged soils", "Acid soils", "Saline soils"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Entisols", "Vertisols (regur soils)", "Laterite soils", "Alfisols"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Intensive leaching in high rainfall areas leaving Fe and Al oxides", "Volcanic activity", "Deposition of river sediments", "Wind deposition"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["The plant cannot complete its life cycle without it and no other element can substitute for it", "It must be produced by the plant itself", "It must be present in large quantities", "Its absence causes no visible deficiency"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Interveinal chlorosis", "Tip burn", "Purple or reddish coloration of leaves (due to anthocyanin accumulation)", "Yellowing of older leaves"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Brown scorching/burning of leaf tips and margins (tip burn)", "Purple coloration", "White striping on leaves", "Yellow spots on young leaves"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Yellowing starting from old leaves", "Interveinal chlorosis on young leaves (veins remain green, between veins turn yellow)", "Purple coloration", "Marginal burning of leaves"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Interveinal chlorosis", "Brown leaf tips", "Death of growing points, malformation of fruits and hollow heart in crops like cauliflower", "Purple leaf coloration"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Methane (CH4)", "Water vapour", "Carbon dioxide (CO2)", "Nitrous oxide (N2O)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Iron oxide", "Sodium chloride and sodium sulphate salts", "Calcium carbonate", "Aluminium sulphate"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Himalayan foothills and river plains", "Coastal areas only", "Deccan Plateau", "Rajasthan desert"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["P2O5", "H2PO4- and HPO4²-", "H3PO4", "Organic phosphate"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Phosphorus deficiency", "Nitrogen deficiency (yellowing)", "Potassium deficiency", "Iron deficiency"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Clostridium", "Rhizobium", "Anabaena", "Azotobacter"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Classify soil texture", "Describe soil color using hue, value and chroma", "Measure soil temperature", "Measure soil moisture"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Green plants absorb more sunlight", "Ocean temperatures decrease", "Greenhouse gases trap long-wave radiation from Earth's surface, preventing heat loss to space", "The sun's radiation becomes more intense"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["High copper content", "Low organic matter", "Presence of iron oxide (Fe2O3)", "High manganese content"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Organic matter and microbial activity", "Sand particles", "Inorganic salts", "Soil temperature"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It measures crop potential only", "It predicts the weather", "It tells us only about soil texture", "It helps determine the existing nutrient levels and avoid over/under application"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sandy soils", "Clay-dominated alkaline soils", "Black cotton soils", "Highly weathered tropical soils with iron and aluminium oxides"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Iron and manganese", "Basic cations (Ca2+, Mg2+, K+, Na+)", "Sodium only", "Hydrogen and aluminium ions only"],
    correct: 3,
