...
export const da111LectureQuestions: Question[] = [
  ...
  },
  {
    ...
    options: ["Four or multiples of four per flower", "Five or multiples of five per flower", "Three or multiples of three per flower", "Two or multiples of two per flower"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Anther to stigma of a different plant of the same species", "Anther to stigma of the same flower or same plant", "Anther to stigma of flowers of a different species", "Wind-dispersed pollen to stigmas of distant plants"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Eggs of flowers on a different plant of the same species", "Eggs of other flowers on the same individual plant", "Eggs of flowers on a completely different species", "Its own stigma within the same individual flower"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mango and guava pollinated by honeybees and other insects", "Citrus and banana pollinated by birds and insects", "Sunflower and mustard pollinated by bees primarily", "Maize, wheat and paddy pollinated by wind"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Physical separation of the anthers far from the stigma", "Early maturation of pistil before pollen is ready to shed", "Preventing functional self-pollen from fertilizing the ovule", "Pollen being shed only when flowers remain closed entirely"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Without meiosis or fertilization — asexually from seeds", "By fusion of somatic protoplasts of two plants", "By vegetative means through runners and stolons", "Only after normal fertilization of the egg by sperm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Modified leaves (scale leaves) surrounding a central bud", "Modified roots storing starch for vegetative growth", "Modified stems with spirally arranged buds for budding", "Underground stems with swollen internodes and nodes"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Oryza sativa (rice) in paddy field experiments", "Pisum sativum (garden pea) plants in his garden", "Princess variety of Phaseolus vulgaris (beans)", "Zea mays (maize) in long-term Illinois selection experiment"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Crossing many parents in a diallel cross for combining ability", "Backcrossing repeatedly to the recurrent parent for trait introgression", "Recording ancestry of individual plants through each generation", "Growing selected plants in bulk without individual plant records"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["F1 parent — crossed again with one of its original parents", "Male parent — contributing only the pollen in each generation", "Donor parent — contributing the desirable trait gene only", "Recurrent or recepient parent — crossed repeatedly to restore genotype"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Crossing two inbred lines to exploit maximum hybrid vigor", "Intercrossing several selected inbred lines or clones freely", "Backcrossing the F1 to the recurrent parent five times", "Selecting superior plants from within a landrace population"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Combining several superior varieties or ecotypes by open pollination", "Intercrossing two inbred lines to produce a single-cross F1 hybrid", "Crossing one parent as female with two males in a three-way cross", "Selecting the best pure line from a variable land race population"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Inbreeding depression with loss of vigor and fertility", "Immediate stabilization of all desirable quantitative traits", "Increased genetic variability useful for further selection", "Maximum heterozygosity and strong hybrid vigor"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Reduce plant height for better harvest index and lodging resistance", "Create homozygous parents for producing uniform hybrid seed", "Increase genetic variability for future selection in the program", "Develop varieties that can be maintained by open pollination"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The performance of the line itself in pure stand yield trials", "Average performance of all crosses involving that particular line", "The performance of specific cross combinations involving the line", "Specific dominance interaction between two particular inbred lines"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The recurrent parent repeatedly for backcross breeding", "Only the two best parents selected for final hybrid", "Every other parent in all possible combinations", "Only one specific tester line to determine GCA"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Backcrossing each candidate to its original open-pollinated parent", "A specific tester (inbred line) to cross with each candidate line", "Every possible cross combination among all candidate lines", "A broad-based tester (open-pollinated variety) crossed with each line"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Seeds from F1 hybrids can be saved and replanted maintaining yield", "Higher and more uniform yield due to heterosis exploitation", "Lower seed cost as hybrid seed can be produced by farmers", "Greater genetic diversity in the crop providing more stability"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["10⁻¹² (one in a trillion organisms) per generation", "10⁻³ (one in a thousand organisms) per generation", "10⁻⁹ (one in a billion organisms) per generation", "10⁻⁶ (one in a million organisms) per generation"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Intercalating between DNA bases causing frame-shift mutations", "Breaking both strands of the DNA double helix molecule", "Inhibiting DNA replication enzymes preventing chromosome division", "Alkylating guanine bases causing GC to AT transitions"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Prevents spindle fiber formation during cell division causing polyploidy", "Doubles the chromosome number by inhibiting DNA replication", "Promotes chromosome pairing between homoeologous chromosomes", "Fuses two protoplasts to combine their complete genome sets"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Aneuploidy with addition or deletion of single chromosomes", "Multiple copies of the same genome of one species", "Random doubling of one chromosome within a single species", "Genomes of two different species through hybridization"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Cytoplasmic traits like male sterility in hybrid crop breeding", "Simply-inherited qualitative traits like disease resistance and protein quality", "Multiple traits simultaneously in all major crop species equally", "Complex quantitative traits like yield potential and drought tolerance"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Golden yellow — issued by the producing agency", "White — issued by the Seed Certification Agency", "Blue (azure blue, ISI shade 104) — issued by certification agency", "Opal green — for truthfully labelled seed category"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["White — issued by the seed certification agency", "Blue — as for certified seed production class", "Opal green — for truthfully labelled seed category", "Golden yellow — issued by the producing agency"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["35 days before or after the surrounding maize crop", "14 days before or after the surrounding maize crop", "7 days before or after the surrounding maize crop", "21 days before or after the surrounding maize crop"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Apomictic crops like mango and citrus fruit trees", "Self-pollinated crops like paddy and wheat varieties", "Cross-pollinated crops like maize and pearl millet", "Vegetatively propagated crops like potato and sugarcane"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["6-8% moisture for long-term hermetic storage", "10-13% moisture for short-term storage in gunny bags", "13-15% moisture for medium-term storage in warehouses", "3-5% moisture for ultra-long-term gene bank storage"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Large seeds and small seeds by mechanical size grading", "Live seeds and dead seeds based on viability testing", "Pure seeds, other crop seeds, weed seeds and inert matter", "Different variety types based on seed coat color and shape"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["80% minimum germination for certified paddy seed", "85% minimum germination for certified paddy seed", "75% minimum germination for certified paddy seed", "70% minimum germination for certified paddy seed"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Preventing accurate measurement of seed moisture content", "Causing artificially low germination percentages in fresh seed tests", "Making seeds germinate faster than expected at standard temperature", "Increasing seed germination rate well beyond the expected standard"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Setting up seed testing laboratories in each village panchayat", "Converting all villages to exclusive seed production zones", "Training selected farmers to produce quality seed in their villages", "Establishing government-owned seed processing plants in villages"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Agriculture Commissioner, Government of India", "Director General of ICAR, New Delhi", "Deputy Director General (Crop Sciences), ICAR", "Production Commissioner, Ministry of Agriculture"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Rights only to public sector breeders at state agricultural universities", "Exclusive rights to government agencies to control all seed trade", "Patent-like intellectual property rights to breeders for new varieties", "Unrestricted access to all plant genetic resources by anyone"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Officially released and notified by Government for certification", "Protected under PPV&FR Act with exclusive breeders' rights", "Released informally by a breeder without official procedures", "Grown traditionally by farmers for more than 50 years"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Used for direct human consumption as staple food product", "Free from all pesticide treatments to ensure complete safety", "Produced in large quantities compared to grain production", "Certified or truthfully labelled to meet quality standards"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-2-ii, B-3-iii, C-1-i,   D-4-iv", "A-1-i,  B-4-iv,  C-2-ii,   D-3-iii", "A-3-iii, B-1-i,  C-4-iv,   D-2-ii", "A-4-iv, B-2-ii,  C-3-iii,  D-1-i"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["A-3-iii, B-2-ii,  C-4-i,   D-1-iv", "A-4-iv,  B-1-i,   C-3-iii,  D-2-ii", "A-2-iii, B-3-ii,  C-1-i,   D-4-iv", "A-1-i,   B-4-iv,  C-2-iii,  D-3-ii"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Dockage from a seed lot to prepare the seed for marketing", "All moisture from the seed before it is placed in storage", "Dormancy from freshly harvested seed lots before sowing", "Genetic impurities from the variety by rouging the seed field"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["The specific gravity separator used for heavy seeds", "The air screen cleaner that uses screens and aspiration", "The spiral separator used for round flowing seeds", "The magnetic separator used for sticky rough seeds"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Indented cylinder separator working on length", "Disc separator working on the seed length", "Specific gravity separator working on weight", "Spiral separator working on the seed shape"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Surface texture, rough versus smooth seeds", "Colour difference between seed varieties", "Length using indents on a cylinder", "Shape and rolling ability, round versus flat"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Roll mill, also called the velvet roll or dodder mill", "Disc separator that works on seed length", "Specific gravity separator that works on weight", "Electronic colour separator for discoloured seeds"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Father of plant breeding", "Father of genetics", "Father of seed testing", "Father of botany"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cotton and sunflower", "Soybean and groundnut", "Maize and sorghum", "Paddy and wheat"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Red and white rice varieties", "Viable seeds from dead seeds", "Dormant from non-dormant seeds", "Hybrid from inbred maize lines"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Wheat", "Soybean", "Paddy", "Cotton"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Recalcitrant seeds", "Dormant seeds", "Orthodox seeds", "Hard-coated seeds"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Paddy", "Wheat", "Cotton", "Soybean and groundnut"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["2,3,5-triphenyl tetrazolium chloride", "Ethyl methane sulphonate", "Sodium hydroxide solution", "Gibberellic acid (GA3)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Physical, chemical and biological sterility", "True, functional and induced male sterility", "Complete, partial and temporary sterility", "Natural, hybrid and mutant sterility"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Onion and garlic only", "Tomato, brinjal and barley", "Bajra, maize, wheat, jowar and sunflower", "Only wheat and barley"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Paddy", "Wheat", "Sorghum", "Onion"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["20 families", "5 families", "10 families", "50 families"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["To grow", "To change", "To divide", "To select"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mendel in the garden pea", "Shull in maize", "Muller (1927) in Drosophila and Stadler (1928) in barley", "Johannsen in beans"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Colchicine treatment of the seed", "Ethyl methane sulphonate soaking", "Ultraviolet irradiation of seedlings", "Fast neutron irradiation of HC-6"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Detasseling", "Emasculation by hand", "Rouging of off-types", "Bagging of flowers"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["25-30 degrees C", "45-53 degrees C", "60-70 degrees C", "80-90 degrees C"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Wheat", "Rice", "Cotton", "Lucerne"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["White", "Golden yellow", "Blue", "Red"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Secale cereale (rye)", "Hordeum vulgare (barley)", "Avena sativa (oat)", "Oryza sativa (rice)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Catharanthus roseus", "Colchicum autumnale of the family Liliaceae", "Oenothera lamarkiana", "Datura stramonium"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Five rows of the improved variety", "Twenty rows of the improved variety", "Ten rows of the improved variety", "Two rows of the improved variety"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["One season", "Two seasons", "Five seasons", "Three seasons"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Johannsen (1903)", "Kadam (1942)", "Shull (1914)", "Harrington (1972)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["15 cm x 7.5 cm", "15 cm x 10 cm", "12 cm x 6 cm", "10 cm x 5 cm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["3 metres", "50 metres", "1000 metres", "180 metres"],
    correct: 3,
