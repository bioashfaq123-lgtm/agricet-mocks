...
export const seedTechnologyQuestions: Question[] = [
  {
    ...
    options: ["Dry filter paper in seed technology", "Soil as per seed technology and quality control standards", "Moist blotter/sand at specified temperature for specified days", "Water as per seed technology and quality control standards"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Golden yellow", "White", "Green (Azure blue)", "Blue"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Only germination percentage in seed technology", "Sum total of properties that determine the level", "Seed size only for seed quality", "Seed moisture content in seed processing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Insect damage", "Nematodes in seed technology", "Seed-borne and soil-borne fungal diseases", "Rodents for seed quality"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Hand emasculation and controlled pollination or use of CMS/male sterility", "Natural pollination as per seed technology and quality control standards", "Insect pollination only for seed quality", "Wind pollination as per seed technology and quality control standards"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["300 m", "200 m", "100 m", "400 m"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Pure seeds, other crop seeds, weed seeds, and inert matter", "Only clean seeds in seed technology", "Good seeds from bad seeds for seed quality", "Large seeds from small seeds in seed processing"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Germination capacity in seed technology", "Seed size, seed rate calculation, and seed quality", "Moisture content for seed quality", "Seed age in seed processing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Seed color change as per seed technology and quality control standards", "Chemical analysis as per seed technology and quality control standards", "Seed weight measurement as per seed technology and quality control standards", "Reduction of colorless TZ salt to red formazan by dehydrogenase enzymes in living tissue"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Increases seed germination as per seed technology and quality control standards", "Makes plant unable to produce functional pollen, eliminating need for hand emasculation", "Improves seed storage as per seed technology and quality control standards", "Controls insect pests as per seed technology and quality control standards"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Seed vigor by exposing seeds to high temperature and humidity stress conditions", "Physical purity as per seed technology and quality control standards", "Germination percentage as per seed technology and quality control standards", "Seed moisture as per seed technology and quality control standards"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["22.5 cm", "15 cm", "30 cm", "45 cm"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Adding fertilizers as per seed technology and quality control standards", "Harvesting seeds as per seed technology and quality control standards", "Removal of off-type plants, diseased plants, weedy plants from the seed crop", "Seed treatment as per seed technology and quality control standards"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Oven drying method at 130°C for 1 hour or 103°C for 17 hours", "Visual inspection as per seed technology and quality control standards", "Weighing seeds as per seed technology and quality control standards", "Colour change as per seed technology and quality control standards"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Blue", "Golden yellow", "Green", "White"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["That the seed meets minimum standards for genetic purity, physical purity, germination and health", "Maximum profit for farmers as per seed technology and quality control standards", "Free seed distribution as per seed technology and quality control standards", "Hybrid seed production only as per seed technology and quality control standards"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Maximum seed size as per seed technology and quality control standards", "Harvesting time as per seed technology and quality control standards", "Yellow color of plant for seed quality", "Maximum dry weight, maximum germination, and formation of black layer in maize"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["High oxygen as per seed technology and quality control standards", "Reduced oxygen and increased CO₂ or nitrogen to extend shelf life", "High humidity as per seed technology and quality control standards", "Normal air as per seed technology and quality control standards"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["100-125 kg/ha", "50-75 kg/ha", "10-15 kg/ha", "200 kg/ha"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Soil conductivity in seed technology", "Moisture content for seed quality", "Seed vigor - leachate from seeds with damaged", "Nutrient content in seed processing"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sampling the heaviest seeds", "Sampling from top of bag only", "Random sampling using ISTA rules", "Sampling from 5 bags only"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Original lot directly in seed technology", "Composite sample after thorough mixing and quartering", "Top layer of the bag", "Any convenient location for seed quality"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reduces germination as per seed technology and quality control standards", "Reduces seed quality for seed quality as recommended by ICAR guidelines", "Prevents premature germination under unsuitable conditions and aids seed dispersal", "Causes storage problems in seed processing"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Seeds are certified by agency in seed technology", "Seller truthfully declares on the label the contents, variety", "Seeds are only government certified for seed quality", "Hybrid seeds only in seed processing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Refrigeration as per seed technology and quality control standards", "Ventilated storage as per seed technology and quality control standards", "Chemical fumigation as per seed technology and quality control standards", "Airtight containers that create low O₂ and high CO₂ atmosphere to protect seeds"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Room temperature in seed technology", "-18°C to -20°C (long-term storage for 100+ years)", "0°C to 5°C for seed quality", "10°C to 15°C in seed processing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Germination purity", "True purity", "Genetic purity", "Physical or analytical purity"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Cold, wet soil conditions that seeds face during early spring planting", "Hot season conditions as per seed technology and quality control standards", "Drought conditions as per seed technology and quality control standards", "Flooding conditions as per seed technology and quality control standards"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Only state governments in seed technology", "ICAR only in seed processing in the context of integrated farming systems", "Seed companies only for seed quality in irrigated crop production systems", "GEAC (Genetic Engineering Approval/Appraisal Committee) under Ministry of Environment"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Only seed size as per seed technology and quality control standards", "Weather conditions only as per seed technology and quality control standards", "Only plant spacing as per seed technology and quality control standards", "Germination %, field emergence %, seed size (1000 seed weight), plant density, and spacing"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Produce seeds as per seed technology and quality control standards", "Analyze seed quality (germination, purity, moisture, health) and issue seed analysis reports", "Store seeds as per seed technology and quality control standards", "Distribute seeds as per seed technology and quality control standards"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Soil erosion affecting seed production as per seed technology and quality control standards", "Pest damage to seeds as per seed technology and quality control standards", "Seed quality deterioration as per seed technology and quality control standards", "Loss of genetic diversity of traditional crop varieties due to replacement by modern varieties"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["50% in seed technology", "70% for seed quality", "As specified by variety (usually 80-95%)", "100% in seed processing"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["National Standards for Agriculture Integration", "National Seed Association of India", "National Seed Agency of India", "National System for Agriculture Inputs"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["They have highest yields in seed technology as recommended by ICAR guidelines", "They have adapted to local conditions, farmer-managed, and repository of genetic diversity", "They are government developed for seed quality", "They are easier to certify in seed processing"],
    correct: 1,
