...
export const da241Questions: Question[] = [
  {
    ...
    options: ["Planning and execution of agricultural land development and irrigation projects", "Management of farm machinery and mechanization of field operations", "Study of plant genetics and crop improvement through hybridization and biotechnology", "Allocation of scarce resources in agricultural production, marketing, and consumption"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["The science and art of organising, operating, and managing a farm for maximum profit", "Discipline of planning and executing government agricultural policy and schemes", "Practice of record-keeping and bookkeeping in agricultural farm establishments", "Study of soil microbiology and nutrient cycles for improving crop productivity"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Fixed cost", "Opportunity cost", "Variable cost", "Marginal cost"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Fixed cost", "Variable cost", "Imputed cost", "Sunk cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Gross income", "Gross margin", "Total revenue", "Net profit (farm income)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Central government based on CACP recommendations", "Farmer producer organisations based on aggregated production cost survey data", "NABARD after evaluating crop production costs in consultation with state governments", "State Agriculture Departments after consulting district-level farmer advisory bodies"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Late 1960s and 1970s", "1980s liberalisation decade", "1990s economic reforms period", "Early 1950s post-independence period"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Export surplus agricultural produce exclusively to international markets", "Generate maximum returns for equity shareholders through agricultural commodity trading", "Compete aggressively with private agri-companies to capture market share", "Provide mutual benefit and economic protection to members"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Agricultural Price Monitoring Committee", "Agricultural Produce Market Committee", "Agricultural Products Management Corporation", "Agri-Produce Marketing Council"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Commercial banks through priority sector lending to rural borrowers", "Insurance companies offering premium-financed agricultural credit facilities", "Primary Agriculture Credit Society (PACS)", "Reserve Bank of India through direct rural credit windows"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Construction of field channels, check dams, and irrigation infrastructure", "Redistribution of land from large landowners to landless poor", "Physical levelling and grading of agricultural land for uniform irrigation", "Improvement of soil fertility through organic manures, lime, and micronutrient application"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Offering crop insurance coverage to farmers against natural calamity risks", "Promoting export of agricultural commodities through international marketing assistance", "Providing retail banking services to farmers through brick-and-mortar branches", "Providing credit for agriculture and rural development"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Export price subsidy provided by government to enable farmers to compete globally", "Government ensuring a minimum guaranteed price to prevent price fall below a certain level", "Open market price determined by equilibrium of agricultural demand and supply forces", "State government imposing a statutory ceiling above which no farmer can legally sell"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["An agreement between farmers and buyers specifying quality, price, and quantity before production", "A legal arrangement where cultivators pay rent for using land owned by absentee landlords", "A system where farmers jointly pool resources and cultivate land as a collective enterprise", "A scheme where government operates farms directly using agricultural department staff"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Commercial farming", "Conventional farming", "Organic farming", "Contract farming"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Structural unemployment caused by mechanization replacing manual farm labour", "Workers engaged in farming whose removal would not reduce output", "Seasonal workers who are temporarily without employment between crop seasons", "Educated rural youth unable to find white-collar employment in urban areas"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["To generate revenue for the government through commodity taxation and trade margins", "To provide food grains at subsidised prices to the poor", "To export surplus food grains to international markets and earn foreign exchange", "To control domestic food price inflation by imposing statutory ceilings on traders"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Highly elastic (> 1) — demand changes more than price change", "Unit elastic (= 1) — demand changes equal to price change", "Inelastic (< 1) — demand changes less than price change", "Perfectly elastic (= infinity) — any price rise causes demand to fall to zero"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cultivating the maximum possible number of crop species on available farm land", "Organizing and operating a farm for maximum continuous profit consistent with sustainable use of resources", "Formulating and implementing national government agricultural policy and extension schemes", "Selling farm produce at the highest achievable market price each season"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Government subsidy advantage given to farmers in backward agricultural districts", "Specializing in production of goods with lower opportunity cost — basis of trade between regions", "Growing only those crops where absolute production costs are lowest across all regions", "Cultivating whichever crop commands the highest prevailing market price each season"],
    correct: 1,
  ...
  },
  {
    ...
    subject: "da-241",
    question: "APMC stands for:",
    options: ["Agricultural Price Monitoring Commission", "Agricultural Produce Management Corporation", "Agricultural Produce Marketing Committee", "Agricultural Production Management Council"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Variable costs + Fixed costs (interest on capital, depreciation, rent, family labour value)", "Only hired labour cost excluding all machinery, irrigation, and overhead charges", "Seed cost and fertilizer cost only — other inputs are provided free by government", "Only machinery and equipment cost excluding land rent and family labour value"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Sugarcane", "Cotton", "Wheat", "Rice"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Total gross receipts from crop and livestock sales before deducting any costs", "Government subsidy and PM-KISAN income received by the farmer household", "Net income after subtracting imputed family labour value and opportunity cost of land", "Gross income minus all explicit paid-out costs (A2 costs)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["30–50%", "10–20%", "70–80%", "90–100%"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["2012", "2005", "1998–99", "1991"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Complete loan waiver for crop loans taken from cooperative banks and RRBs", "Free certified seeds of improved varieties distributed to all registered farmers", "Free irrigation water through canal distribution during kharif and rabi seasons", "Crop insurance at low premium rates with government subsidy on insurance premium"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Rising food prices are always accompanied by proportional increases in household income", "As income rises, proportion of income spent on food decreases (food expenditure share falls)", "Total household food expenditure decreases in absolute terms as income rises", "As income rises, the proportion of income spent on food items increases substantially"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Refinancing banks for agricultural credit, rural development, and watershed projects", "Direct lending to farmers through branch-level credit disbursement operations", "Operating the e-NAM digital platform for online trading of agricultural commodities", "Fixing MSP for all notified crops based on CACP cost of production data"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Government regulations require mandatory discounting of all future agricultural returns", "Money received in future is worth less than money received today (time value of money)", "Future agricultural income is always uncertain and should be eliminated from calculations", "Inflation consistently increases the purchasing value of money received in the future"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Model APMC Act (2003), Model Contract Farming Act (2018), and Farm Laws (2020 — later withdrawn)", "WTO Agreement on Agriculture requiring mandatory removal of state trading restrictions", "RBI monetary policy framework for agricultural credit and rural market development", "State governments acting independently based on their own agricultural marketing legislation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["2010–11", "2005–06", "2012–13", "2007–08"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Non-trade distorting subsidies (R&D, extension, food security stockholding, disaster relief) — exempt from reduction", "Direct payments under production-limiting programmes subject to Blue Box conditions", "Price support payments tied directly to production output with AMS reduction obligations", "Trade-distorting production subsidies that must be reduced under Amber Box commitments"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["The wage that family labour could have earned in the best alternative employment", "The statutory government minimum wage applicable in the particular state and season", "Only the physical fatigue and health cost borne by family members doing farm work", "Zero — as family labour involves no direct cash outflow from the farm household"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Total production cost at different output levels for a given set of input prices", "Combinations of two inputs that produce the same level of output (equal product curve)", "All combinations of two products that generate the same level of total revenue", "Market equilibrium between agricultural commodity demand and supply quantities"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Calculate fair market value of agricultural land based on productivity and location factors", "Estimate subsidy component in concessional loans for small and marginal farmers", "Determine the blended interest rate on various sources of funds (owned capital + borrowed capital) for investment decisions", "Estimate expected crop yield based on soil fertility, climate, and varietal potential"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Stabilize crop prices at MSP level throughout the year through government procurement", "Provide universal input subsidy to cover seed, fertilizer, and irrigation costs equally", "Provide financial support to farmers suffering crop loss due to natural calamities, pests, and diseases", "Guarantee farmer profit regardless of market prices prevailing during any season"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Total revenue equals total cost — no profit, no loss", "Variable costs exactly equal fixed costs with zero contribution to overhead", "Net profit is at its maximum possible level with optimal input combination", "Government support price becomes exactly equal to the prevailing wholesale market price"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Mandating compulsory groundwater recharge structures in all high water-table priority zones", "Subsidising flood irrigation through expanded canal network construction in drought-prone regions", "'Har Khet Ko Pani, More Crop Per Drop' — expanding irrigation coverage and improving water use efficiency", "Providing free canal water to all agricultural holdings through nationalized irrigation systems"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Population grows arithmetically in a linear progression while food production grows geometrically", "Population grows geometrically (exponentially) while food production grows arithmetically (linearly), leading to food shortages", "Technological progress in agriculture ensures food production always exceeds population growth", "Population and food supply both grow at an identical rate maintaining permanent equilibrium"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Eliminate all government price support and allow purely market-determined agricultural prices", "Maximise farmers' income by maintaining consistently high food prices throughout the year", "Provide all food items completely free to consumers by eliminating retail food prices", "Balance interests of producers (remunerative prices) and consumers (affordable food prices) through MSP and public distribution"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Finance Commission", "NABARD", "CACP", "Planning Commission of India"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["All farmers to automatically receive MSP as floor price guaranteed by government", "Only government agencies and FCI to purchase commodities at predetermined future prices", "Buyers and sellers to agree today on price, quantity, and delivery date for future delivery of a commodity", "Banks to provide pre-season revolving credit facilities to farmers on future crop collateral"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Subsidised distribution of seeds, fertilizers, and pesticides to all registered farmers", "Free electricity for agricultural irrigation pumps up to 9 HP connected load", "Investment support of ₹10,000 per acre per year to land-owning farmers (two instalments of ₹5,000)", "Comprehensive crop insurance coverage without any farmer premium payment required"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["International forward export contracts for agricultural commodity shipments", "Government procurement contracts for MSP-based purchase of notified agricultural commodities", "Physical spot delivery contracts with immediate settlement at current cash prices", "Futures and options contracts for standardized agricultural and non-agricultural commodities"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Harmonising crop production methods and quality standards across all member nations", "Increasing agricultural import tariff barriers to protect domestic farmers from foreign competition", "Mandating all WTO member nations to adopt certified organic farming production standards", "Reducing domestic support subsidies, export subsidies, and import tariff barriers through multilateral negotiations"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Channel all subsidies exclusively through fertilizer manufacturers and input supply chains", "Provide technology-based crop advisory services through mobile and digital platforms", "Increase total government fiscal expenditure on agricultural development and infrastructure", "Eliminate leakages by transferring subsidies directly to beneficiaries' bank accounts, bypassing intermediaries"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Subsidy on seeds, fertilizers, irrigation electricity, and credit interest — amounting to crores annually", "Government paying only certified seed costs for approved varieties to registered farmers", "Government paying fertilizer costs only through direct benefit transfer to bank accounts", "Government paying all farming costs including labour, machinery, and harvesting charges"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Amount of loan — small loans below ₹1 lakh, medium loans ₹1–10 lakh, large loans above ₹10 lakh", "Repayment period — short-term (up to 15 months), medium-term (15 months–5 years), long-term (5–20 years)", "Collateral offered — personal guarantee, hypothecation of crop, or mortgage of land property", "Type of crop financed — food grain loans, cash crop loans, and horticultural crop loans"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Government legally regulates only tenant farming arrangements while ignoring sharecropping", "Tenant pays fixed rent (cash or crop) while sharecropper splits the produce with landowner in agreed ratio", "No meaningful practical difference — both result in identical contractual land use terms", "Tenant legally owns the land after cultivating for five consecutive years; sharecropper remains landless"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Growth in output relative to growth in ALL inputs combined — indicator of technological progress", "Agricultural labour productivity measured as output per person employed in crop work", "Farm machinery productivity measured as output per machine-hour of mechanized operations", "Crop yield per unit land area without accounting for labour or capital inputs used"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Gear ratio of farm tractor affecting fuel efficiency and field power output", "Ratio of crop yield between kharif and rabi seasons on the same land", "Ratio of cultivated land area to total farm labour employed per season", "Ratio of borrowed capital to owned capital — indicates financial risk"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Personal savings and family accumulated funds from non-agricultural income sources", "Private finance companies, chit funds, and unregulated money lenders at market interest", "Commercial banks, cooperative banks, RRBs, NABARD, and microfinance institutions (institutional sources)", "Moneylenders, landlords, commission agents, and relatives (non-institutional)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Find the optimal combination of farm enterprises (crops, livestock) to maximize income subject to resource constraints", "Calculate soil macronutrient requirements for optimal crop production and fertility maintenance", "Determine prevailing market price trends for planning agricultural commodity procurement", "Forecast seasonal monsoon rainfall patterns and estimate impact on kharif crop yields"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Facilitate enrolment in Pradhan Mantri Fasal Bima Yojana crop insurance scheme", "Provide concessional institutional credit through cooperative bank linkage programmes", "Enable direct cash transfers of PM-KISAN income support into farmer bank accounts", "Document land ownership rights — contains details of land holdings, survey numbers, and ownership"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Industrial development in peri-urban zones near major agricultural production belts", "Creating food security reserve zones to ensure year-round food availability in emergencies", "Maintaining strategic import buffer stocks for essential agricultural goods in shortage", "Developing clusters of commodity production with facilities for processing, packaging, and export of specific commodities"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["14 crops", "All agricultural crops", "23 crops", "5 crops"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["15–18% in 2023", "40% in 2023", "5% in 2023", "30% in 2023"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Alfred Marshall", "Paul Samuelson", "Adam Smith", "Mrs. Joan Robinson"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["NABARD Board", "Agricultural Prices Commission", "State Level Bankers Committee (SLBC)", "District Level Technical Committee (DLTC)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-2-ii, B-1-i,  C-4-iv,  D-3-iii", "A-1-iii, B-3-i, C-2-iv,  D-4-ii", "A-3-i,  B-4-ii,  C-1-iii,  D-2-iv", "A-1-i,  B-2-ii,  C-3-iii,  D-4-iv"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-3-iii, B-4-iv, C-1-i,  D-2-ii", "A-4-iv, B-3-iii, C-2-ii, D-1-i", "A-2-ii, B-1-i,  C-4-iv,  D-3-iii"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["A-1-i,  B-2-ii,  C-3-iii,  D-4-iv", "A-2-ii, B-3-iii, C-1-i,  D-4-iv", "A-3-iii, B-1-i, C-2-ii, D-4-iv", "A-1-ii, B-2-iii, C-3-i,  D-4-iv"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["I repay", "I promise", "I believe", "I borrow"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Kharif 1954", "Kharif 1960", "Kharif 1970", "Kharif 1966"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Check arithmetical accuracy of ledger postings", "Record daily transactions", "List all farm assets", "Calculate net profit"],
    correct: 0,
...

  {
    ...
    options: ["Daily sunshine for crops", "Seeds stored for planting next season", "Water flowing in river", "Services of labourer on a specific day"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fixed input production", "Constant returns production", "Short run production", "Long run production"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["At minimum MC", "At maximum AVC", "At minimum AVC", "At zero output"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Perfect competition", "Monopoly", "Pure oligopoly", "Monopolistic competition"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["TR = P / Q", "TR = Q - P", "TR = P x Q", "TR = P + Q"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Reduction of farm risks", "Flow of regular income", "Better utilization of farm resources", "Effective supervision of all enterprises"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Stage IV", "Stage I", "Stage II", "Stage III"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A-3, B-2, C-4, D-1", "A-2, B-3, C-1, D-4", "A-1, B-2, C-3, D-4", "A-2, B-4, C-1, D-3"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Market price crashes", "Government policy changes", "Natural calamities", "Oversupply of farm produce"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Principle of democratic governance", "Principle of limited liability", "Principle of voluntary membership", "Principle of profit sharing"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Total revenue minus fixed costs", "Fixed costs minus variable costs", "Marginal cost minus marginal revenue", "Price per unit minus variable costs per unit"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Net worth of farm is negative and person is indebted", "Net worth of farm is positive (capital is surplus)", "Farm has equal assets and liabilities", "Farm is at break-even point"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Loan eligibility depends on land ownership", "Crop is treated as security", "Loans include both cash and kind components", "Finance is fixed based on cost of cultivation"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Regulatory functions", "Agricultural subsidies", "Price support", "Cooperative training"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["More than two but few sellers", "Only two buyers", "Only two sellers", "Only one seller"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["The minimum price below which the seller will refuse to sell", "The price set by government for farm produce", "The average price in the market", "The maximum price a buyer is willing to pay"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["D1Y/D1X > D2Y/D2X", "D1Y/D1X + D2Y/D2X = 0", "D1Y/D1X < D2Y/D2X", "D1Y/D1X = D2Y/D2X = DnY/DnX"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["10 animals", "25 animals", "5 animals", "2 animals"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Land Mortgage Bank", "Primary Agricultural Credit Society", "Consumer Cooperative", "District Cooperative Central Bank"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Equal each time (constant returns)", "Less and less (diminishing returns to variable factor)", "More and more (increasing returns)", "Zero immediately after initial increase"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["IFFCO establishment at Kandla", "Introduction of single window system of credit", "Setting up of NCDC", "Replication of Anand Pattern for milk"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Large number of buyers and sellers", "Free entry and exit of firms", "Perfect mobility of resources and Perfect knowledge", "Homogeneous product"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Equitable mortgage", "Fixed deposit mortgage", "Simple mortgage", "Chattel mortgage"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Variety (local/improved/HYV), season, and type of crop (irrigated/rainfed)", "Only the total land holding size", "The market price of the crop", "Credit history of the farmer only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Maximum and positive", "Declining but still positive", "Zero at start and positive throughout", "Negative (less than zero)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Primary Agricultural Credit Societies (PACS)", "National Cooperative Development Corporation", "District Cooperative Central Banks", "State Cooperative Banks"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["To explain means and methods for changing to optimum resource use", "To determine conditions for optimum resource use", "To determine extent of deviation from optimum use", "To maximize food exports"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Unlimited for primary societies and limited for central societies", "Limited for all types of cooperative societies", "Limited for primary societies and unlimited for central societies", "Equal for all types"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Monopoly markets", "Perfect competition markets (farm commodities)", "Monopolistic competition markets", "Oligopoly markets"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Establishment costs (plant construction costs)", "Implicit costs (owned resources)", "Variable costs (working costs, operating costs)", "Social costs (externalities)"],
    correct: 0,
