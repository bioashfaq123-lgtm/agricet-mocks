...
export const da241Questions: Question[] = [
  {
    ...
    "options": [
      "Allocation of scarce resources in agricultural production, marketing, and consumption",
      "Management of farm machinery and mechanization of field operations",
      "Study of plant genetics and crop improvement through hybridization and biotechnology",
      "Planning and execution of agricultural land development and irrigation projects"
    ],
    "correct": 0,
  ...
  },
  {
    "id": "d241_003",
    "subject": "da-241",
    "question": "The cost of production that does not change with the level of output is called:",
    "options": [
      "Opportunity cost",
      "Fixed cost",
      "Variable cost",
    ...
    "correct": 1,
    "explanation": "Fixed costs (overhead costs) do not change with the level of output in the short run. Examples: land rent, depreciation, interest on fixed capital, insurance. They remain constant whether production is high or low."
  },
  {
    "id": "d241_004",
    "subject": "da-241",
    "question": "The cost that varies with the level of agricultural output is called:",
    "options": [
      "Fixed cost",
      "Imputed cost",
      "Variable cost",
    ...
    "correct": 2,
    "explanation": "Variable costs (operating costs) change directly with the level of production. Examples: seed cost, fertilizer cost, labour wages, irrigation charges, pesticide costs. They increase as production increases."
  },
  {
    "id": "d241_005",
    "subject": "da-241",
    "question": "The income remaining after deducting all costs from total revenue is called:",
    "options": [
    ...
    "correct": 0,
    "explanation": "Net profit (farm income) = Total revenue – Total costs (fixed + variable). It represents the actual earnings of the farmer. When net profit is positive, farming is profitable; when negative, it results in a loss."
  },
  {
    "id": "d241_006",
    "subject": "da-241",
    "question": "The benefit-cost ratio is considered economically viable when it is:",
    "options": [
      "Less than 1",
      "Greater than 1",
      "Equal to 0",
    ...
    "correct": 1,
    "explanation": "Benefit-Cost Ratio (BCR) = Total benefits / Total costs. BCR > 1 means the project is economically viable (benefits exceed costs). BCR = 1 means break-even. BCR < 1 means the project is not viable."
  },
  {
    "id": "d241_007",
    "subject": "da-241",
  ...
  },
  {
    ...
    "options": [
      "Export surplus agricultural produce exclusively to international markets",
      "Generate maximum returns for equity shareholders through agricultural commodity trading",
      "Provide mutual benefit and economic protection to members",
      "Compete aggressively with private agri-companies to capture market share"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Commercial banks through priority sector lending to rural borrowers",
      "Primary Agriculture Credit Society (PACS)",
      "Insurance companies offering premium-financed agricultural credit facilities",
      "Reserve Bank of India through direct rural credit windows"
    ],
    "correct": 1,
  ...
  },
  {
    "id": "d241_013",
    "subject": "da-241",
    "question": "Kisan Credit Card (KCC) scheme was launched in:",
    "options": [
      "1991",
      "2004",
      "1988",
    ...
    "correct": 3,
    "explanation": "The Kisan Credit Card (KCC) scheme was launched in 1998 to provide short-term credit to farmers for their agricultural needs (seeds, fertilizers, pesticides) in a flexible and timely manner through a revolving credit facility."
  },
  {
    "id": "d241_014",
    "subject": "da-241",
  ...
  },
  {
    ...
    "options": [
      ...
      "The combined fixed and variable cost of agricultural operations",
      "The total explicit cash expenditure incurred in production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Promoting export of agricultural commodities through international marketing assistance",
      "Providing retail banking services to farmers through brick-and-mortar branches",
      "Offering crop insurance coverage to farmers against natural calamity risks"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Growing multiple crops and enterprises to reduce risk and increase income",
      "Cultivating a single profitable commodity crop on all available farm land every season",
      "Replacing manual operations entirely with mechanized equipment for greater efficiency",
      "Maintaining only livestock enterprises while eliminating all crop cultivation"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Export price subsidy provided by government to enable farmers to compete globally",
      "Open market price determined by equilibrium of agricultural demand and supply forces",
      "Government ensuring a minimum guaranteed price to prevent price fall below a certain level",
      "State government imposing a statutory ceiling above which no farmer can legally sell"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "A legal arrangement where cultivators pay rent for using land owned by absentee landlords",
      "An agreement between farmers and buyers specifying quality, price, and quantity before production",
      "A system where farmers jointly pool resources and cultivate land as a collective enterprise",
      "A scheme where government operates farms directly using agricultural department staff"
    ],
    "correct": 1,
  ...
  },
  {
    "id": "d241_024",
    "subject": "da-241",
    "question": "The elasticity of demand for food grains is generally:",
    "options": [
      "Zero",
    ...
    "correct": 3,
    "explanation": "Demand for food grains is price inelastic (< 1) because food is a necessity. Even if prices rise, people cannot reduce consumption significantly. This is why price stabilization by government is important for food security."
  },
  {
    "id": "d241_025",
    "subject": "da-241",
  ...
  },
  {
    "id": "d241_026",
    "subject": "da-241",
    "question": "Which type of farming uses less external inputs and relies on internal resources?",
    "options": [
      "Organic farming",
    ...
    "correct": 0,
    "explanation": "Organic farming avoids synthetic fertilizers, pesticides, and GMOs. It relies on organic manures, compost, biofertilizers, and biological pest control. It produces chemical-free food at premium prices and improves soil health."
  },
  {
    "id": "d241_027",
    "subject": "da-241",
    ...
    "options": [
      "Structural unemployment caused by mechanization replacing manual farm labour",
      "Seasonal workers who are temporarily without employment between crop seasons",
      "Workers engaged in farming whose removal would not reduce output",
      "Educated rural youth unable to find white-collar employment in urban areas"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "The total sale proceeds of a firm",
      "The revenue per unit of output sold",
      "The net addition to total revenue from selling an additional unit"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Government procurement of foodgrains at minimum support prices only",
      "Exclusive licensing of agricultural commodity exports through government agencies",
      "Direct purchase of agricultural produce from individual farm households only",
      "All activities from production to final consumption including processing, storage, transport, and sale"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Highly elastic (> 1) — demand changes more than price change",
      "Unit elastic (= 1) — demand changes equal to price change",
      "Perfectly elastic (= infinity) — any price rise causes demand to fall to zero",
      "Inelastic (< 1) — demand changes less than price change"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Cultivating the maximum possible number of crop species on available farm land",
      "Formulating and implementing national government agricultural policy and extension schemes",
      "Organizing and operating a farm for maximum continuous profit consistent with sustainable use of resources",
      "Selling farm produce at the highest achievable market price each season"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Government subsidy advantage given to farmers in backward agricultural districts",
      "Growing only those crops where absolute production costs are lowest across all regions",
      "Specializing in production of goods with lower opportunity cost — basis of trade between regions",
      "Cultivating whichever crop commands the highest prevailing market price each season"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Only hired labour cost excluding all machinery, irrigation, and overhead charges",
      "Variable costs + Fixed costs (interest on capital, depreciation, rent, family labour value)",
      "Seed cost and fertilizer cost only — other inputs are provided free by government",
      "Only machinery and equipment cost excluding land rent and family labour value"
    ],
    "correct": 1,
  ...
  },
  {
    "id": "d241_038",
    "subject": "da-241",
    "question": "The 'Fair and Remunerative Price' (FRP) is fixed for which commodity?",
    "options": [
      "Rice",
      "Cotton",
      "Wheat",
    ...
    "correct": 3,
    "explanation": "Fair and Remunerative Price (FRP) is fixed by the Central Government for sugarcane under the Sugarcane (Control) Order, 1966, based on CACP recommendations. Sugar mills are legally bound to pay FRP to farmers for cane supplied. State Advised Price (SAP) is higher in some states."
  },
  {
    "id": "d241_039",
    "subject": "da-241",
    ...
    "options": [
      "Total gross receipts from crop and livestock sales before deducting any costs",
      "Gross income minus all explicit paid-out costs (A2 costs)",
      "Net income after subtracting imputed family labour value and opportunity cost of land",
      "Government subsidy and PM-KISAN income received by the farmer household"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Value added tax and cess levied by state government on agricultural commodity trade",
      "Net profit earned by farmers per quintal after deducting input and land costs",
      "Direct subsidy provided by government to compensate farmers for low market prices",
      "Difference between price paid by consumer and price received by farmer — includes transportation, processing, and trader margins"
    ],
    "correct": 3,
  ...
  },
  {
    "id": "d241_041",
    "subject": "da-241",
    "question": "The 'Producer's share in consumer rupee' for foodgrains in India is approximately:",
    "options": [
      "70–80%",
      "10–20%",
      "30–50%",
    ...
    "correct": 2,
    "explanation": "Producer's share in consumer rupee for foodgrains in India is typically 30–50%, meaning farmers receive only 30–50% of the final retail price consumers pay. The rest goes to traders, processors, transporters, and retailers. Reforms aim to increase farmers' share."
  },
  {
    "id": "d241_042",
    "subject": "da-241",
    "question": "The Kisan Credit Card (KCC) scheme was launched in which year?",
    "options": [
      "1998–99",
      "2005",
      "2012",
    ...
    "correct": 0,
    "explanation": "KCC scheme was launched in 1998–99 based on recommendations of the R.V. Gupta Committee. It provides flexible revolving credit to farmers for crop cultivation, post-harvest expenses, and allied activities at subsidized interest rates (4–7%). KCC has been extended to fisheries and animal husbandry."
  },
  {
    "id": "d241_043",
    "subject": "da-241",
  ...
  },
  {
    ...
    "options": [
      "Every rupee of farm income generates additional income in the rest of the economy through backward and forward linkages",
      "Government spending on agriculture subsidies multiplies to create rural non-farm employment in the agricultural economy",
      "Crop price inflation compounds annually to generate multiple times the original farm income in rural economic context",
      "Agricultural income is progressively reduced by taxes causing decline in rural purchasing power for farm income analysis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Rising food prices are always accompanied by proportional increases in household income",
      "As income rises, the proportion of income spent on food items increases substantially",
      "Total household food expenditure decreases in absolute terms as income rises",
      "As income rises, proportion of income spent on food decreases (food expenditure share falls)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Fixing MSP for all notified crops based on CACP cost of production data",
      "Direct lending to farmers through branch-level credit disbursement operations",
      "Operating the e-NAM digital platform for online trading of agricultural commodities",
      "Refinancing banks for agricultural credit, rural development, and watershed projects"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Money received in future is worth less than money received today (time value of money)",
      "Government regulations require mandatory discounting of all future agricultural returns",
      "Future agricultural income is always uncertain and should be eliminated from calculations",
      "Inflation consistently increases the purchasing value of money received in the future"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Reserve Bank of India through Banking Regulation Act and cooperative banking norms",
      "State Cooperative Acts and the Multi-State Cooperative Societies Act (2002) — registered under respective state/central laws",
      "Department of Financial Services, Ministry of Finance through commercial banking framework",
      "Securities Exchange Board of India through commodity derivatives market regulations"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Elasticity of production lies between one and zero"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Zero — as family labour involves no direct cash outflow from the farm household",
      "The statutory government minimum wage applicable in the particular state and season",
      "Only the physical fatigue and health cost borne by family members doing farm work",
      "The wage that family labour could have earned in the best alternative employment"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Adding more of one input (e.g., fertilizer) while keeping others constant eventually adds less and less to output",
      "Returns from farming decrease each successive year regardless of input management",
      "Total crop yield continuously decreases each year even when all inputs are increased",
      "Cultivating more land beyond a threshold always results in lower average crop yields"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Total production cost at different output levels for a given set of input prices",
      "All combinations of two products that generate the same level of total revenue",
      "Combinations of two inputs that produce the same level of output (equal product curve)",
      "Market equilibrium between agricultural commodity demand and supply quantities"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Maximizing simultaneous production output of all crops across all farming regions",
      "Perfectly equal distribution of agricultural income among all rural farming households",
      "Optimal government pricing policy that minimizes consumer prices while maximizing farm income"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Calculate fair market value of agricultural land based on productivity and location factors",
      "Estimate subsidy component in concessional loans for small and marginal farmers",
      "Estimate expected crop yield based on soil fertility, climate, and varietal potential",
      "Determine the blended interest rate on various sources of funds (owned capital + borrowed capital) for investment decisions"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Efficient price discovery mechanisms similar to commodity exchange trading of agricultural assets",
      "Unrestricted lease markets with legally enforceable tenancy contracts and clear land titles",
      "Complete government ownership and control over all agricultural land and associated tenancy",
      "Imperfections — fragmented holdings, tenancy restrictions, ceilings on land ownership, and incomplete titles limiting land mobility"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Stabilize crop prices at MSP level throughout the year through government procurement",
      "Provide financial support to farmers suffering crop loss due to natural calamities, pests, and diseases",
      "Provide universal input subsidy to cover seed, fertilizer, and irrigation costs equally",
      "Guarantee farmer profit regardless of market prices prevailing during any season"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Three-tier: Primary Agricultural Credit Societies (PACS) at village — District Central Cooperative Banks (DCCBs) — State Cooperative Banks (SCBs)",
      "Four-tier system with national, state, district, and village level cooperative banking units in rural economic context",
      "Two-tier system of commercial banks and NABARD providing all agricultural credit in the agricultural economy",
      "Single-tier structure with primary cooperative societies directly linked to NABARD for refinancing for farm income analysis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Variable costs exactly equal fixed costs with zero contribution to overhead",
      "Total revenue equals total cost — no profit, no loss",
      "Net profit is at its maximum possible level with optimal input combination",
      "Government support price becomes exactly equal to the prevailing wholesale market price"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Mandating compulsory groundwater recharge structures in all high water-table priority zones",
      "Subsidising flood irrigation through expanded canal network construction in drought-prone regions",
      "Providing free canal water to all agricultural holdings through nationalized irrigation systems",
      "'Har Khet Ko Pani, More Crop Per Drop' — expanding irrigation coverage and improving water use efficiency"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Population grows arithmetically in a linear progression while food production grows geometrically",
      "Population and food supply both grow at an identical rate maintaining permanent equilibrium",
      "Technological progress in agriculture ensures food production always exceeds population growth",
      "Population grows geometrically (exponentially) while food production grows arithmetically (linearly), leading to food shortages"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "All farmers to automatically receive MSP as floor price guaranteed by government",
      "Buyers and sellers to agree today on price, quantity, and delivery date for future delivery of a commodity",
      "Only government agencies and FCI to purchase commodities at predetermined future prices",
      "Banks to provide pre-season revolving credit facilities to farmers on future crop collateral"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Reducing cultivated area in favour of high-value horticultural crops for export markets",
      "Facilitating agricultural commodity imports to supplement domestic production shortfalls in the agricultural economy",
      "Increasing production of rice, wheat, pulses, coarse cereals, and nutri-cereals through area expansion and productivity improvement",
      "Strengthening government procurement and distribution network for public food security in rural economic context"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Reduction in marketing costs for given level of service, OR increase in output (service) for given cost",
      "Number of government-regulated APMC mandis established per district across the state",
      "Volume of produce sold at the highest price across all mandis during peak harvest season",
      "Number of licensed traders and commission agents registered in the regulated market"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Concerned only with international trade",
      "Macroeconomic — dealing with the whole economy",
      "Concerned only with national policy",
      "Microeconomic — dealing with the individual farm"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Futures and options contracts for standardized agricultural and non-agricultural commodities",
      "Government procurement contracts for MSP-based purchase of notified agricultural commodities",
      "Physical spot delivery contracts with immediate settlement at current cash prices",
      "International forward export contracts for agricultural commodity shipments"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "One share one vote",
      "One man one vote",
      "Votes proportional to capital",
      "Voting only by office bearers"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "28 weavers and artisans in England",
      "Merchants in France"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Amount of loan — small loans below ₹1 lakh, medium loans ₹1–10 lakh, large loans above ₹10 lakh",
      "Collateral offered — personal guarantee, hypothecation of crop, or mortgage of land property",
      "Repayment period — short-term (up to 15 months), medium-term (15 months–5 years), long-term (5–20 years)",
      "Type of crop financed — food grain loans, cash crop loans, and horticultural crop loans"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Tenant pays fixed rent (cash or crop) while sharecropper splits the produce with landowner in agreed ratio",
      "Government legally regulates only tenant farming arrangements while ignoring sharecropping",
      "No meaningful practical difference — both result in identical contractual land use terms",
      "Tenant legally owns the land after cultivating for five consecutive years; sharecropper remains landless"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Crop yield per unit land area without accounting for labour or capital inputs used",
      "Agricultural labour productivity measured as output per person employed in crop work",
      "Farm machinery productivity measured as output per machine-hour of mechanized operations",
      "Growth in output relative to growth in ALL inputs combined — indicator of technological progress"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Gear ratio of farm tractor affecting fuel efficiency and field power output",
      "Ratio of crop yield between kharif and rabi seasons on the same land",
      "Ratio of borrowed capital to owned capital — indicates financial risk",
      "Ratio of cultivated land area to total farm labour employed per season"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Personal savings and family accumulated funds from non-agricultural income sources",
      "Private finance companies, chit funds, and unregulated money lenders at market interest",
      "Moneylenders, landlords, commission agents, and relatives (non-institutional)",
      "Commercial banks, cooperative banks, RRBs, NABARD, and microfinance institutions (institutional sources)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Large traders deliberately withhold stocks to artificially create price rises through hoarding in the agricultural economy",
      "Agricultural production is seasonal (concentrated supply at harvest) but consumption is year-round, causing price dips at harvest and rises off-season",
      "Differential GST rates on agricultural commodities create periodic seasonal price fluctuations in rural economic context",
      "Government revises MSP rates on a seasonal basis creating alternating price cycles for farm income analysis"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Forecast seasonal monsoon rainfall patterns and estimate impact on kharif crop yields",
      "Calculate soil macronutrient requirements for optimal crop production and fertility maintenance",
      "Determine prevailing market price trends for planning agricultural commodity procurement",
      "Find the optimal combination of farm enterprises (crops, livestock) to maximize income subject to resource constraints"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Document land ownership rights — contains details of land holdings, survey numbers, and ownership",
      "Provide concessional institutional credit through cooperative bank linkage programmes",
      "Enable direct cash transfers of PM-KISAN income support into farmer bank accounts",
      "Facilitate enrolment in Pradhan Mantri Fasal Bima Yojana crop insurance scheme"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Only through ICAR scientists visiting farms periodically for crop technology demonstration in rural economic context",
      "Exclusively through Doordarshan agricultural programmes and All India Radio rural broadcasts in the agricultural economy",
      "Multiple channels: KVK (farm science centres), state agriculture department extension workers, ATMAs, NGOs, private sector, digital advisory",
      "Solely through state-employed agriculture officers posted at block and mandal headquarters for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    "id": "d241_100",
    "subject": "da-241",
    "question": "The 'land utilization statistics' of India show that net sown area is approximately:",
    "options": [
      "50 million ha",
      "140 million ha",
      "200 million ha",
  ...
  },
  {
    ...
    "options": [
      "Personal savings of farmers in the agricultural economy",
      "Total credit needs of the agricultural sector and lending by institutions",
      "Day-to-day farm expenditure for farm income analysis",
      "Financial management of individual farm units in rural economic context"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "List all farm assets",
      "Record daily transactions",
      "Check arithmetical accuracy of ledger postings",
  ...
  },
  {
    ...
    "options": [
      "Minor resource substitution is needed in the agricultural economy",
      "Only pest management is revised in rural economic context",
      "Only one enterprise needs improvement for farm income analysis",
      "Major changes are contemplated in the entire farm organization"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Daily sunshine for crops",
      "Services of labourer on a specific day",
      "Water flowing in river",
      "Seeds stored for planting next season"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "At the end of Stage II in rural economic context",
      "At maximum TPP in the agricultural economy",
      "At the end of Stage I (where MPP = APP)",
      "At the beginning of Stage III for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Average product multiplied by price in the agricultural economy",
      "Total product divided by total input in rural economic context",
      "Additional quantity of output resulting from one additional unit of input",
      "Minimum product at any input level for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Producers and consumers societies",
      "Credit and non-credit societies",
      "Rural and urban societies",
      "Central and primary societies"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Physical possession is with borrower but legal ownership with lending institution",
      "Crop is pledged as security to pawn brokers",
      "Agricultural produce is kept under bank control in the agricultural economy",
      "Mortgage of immovable property is created in rural economic context"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Reducing government taxes in the agricultural economy",
      "Production of food/cash/fodder crops, maintaining soil fertility, increasing income, improving resource distribution",
      "Concentrating on one profitable enterprise only in rural economic context",
      "Eliminating all farm risks for farm income analysis"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Land Improvement Act 1919",
      "Indian Cooperative Act 1919"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Cost of production in the agricultural economy in agriculture",
      "Demand forces mainly (supply is fixed in the very short term)",
      "Government regulation in rural economic context",
      "Supply forces only for farm income analysis for crop production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Effective supervision of all enterprises",
  ...
  },
  {
    ...
    "options": [
      "Use of capital, labour, land and management resources in the farming industry",
      "International trade in farm commodities in the agricultural economy",
      "Marketing of agricultural produce only in rural economic context",
      "Government subsidy allocation for farm income analysis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "The price prevailing in the market on that day (based on verbal understanding)",
      "A fixed price set in advance in the agricultural economy",
      "Price determined by open auction in rural economic context",
      "A price set by commission agent alone for farm income analysis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Indian Famine Commission and Edward Law Committee (1901)",
      "Mac Lagan Committee in rural economic context",
      "Venkatappaiah Committee in the agricultural economy",
      "Gorwala Committee (AIRCSC) for farm income analysis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "A trial balance sheet of income and expenses in the agricultural economy",
      "A cash book recording only cash transactions in rural economic context",
      "A daily diary of all transactions for farm income analysis",
      "The main book containing classified record of all transactions with separate accounts"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Replication of Anand Pattern for milk cooperatives and strengthening processing cooperatives",
      "Setting up of SFDA and MFAL in the agricultural economy",
      "Establishing new cooperative credit societies in rural economic context",
      "Introducing single window system of credit for farm income analysis"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Only ARDC with RBI in the agricultural economy in agriculture",
      "ARDC, Agricultural Credit Department (ACD) and Rural Planning and Credit Cell (RPCC) of RBI",
      "All commercial banks' agricultural divisions in rural economic context",
      "State cooperative banks for farm income analysis for crop production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The daily cash receipts and payments in the agricultural economy",
      "The total profit or loss at end of year from nominal accounts",
      "The value of farm assets and liabilities in rural economic context",
      "The estimated future farm income for farm income analysis"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Net worth of farm is negative and person is indebted",
      "Farm is at break-even point",
      "Farm has equal assets and liabilities",
      "Net worth of farm is positive (capital is surplus)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Crop is treated as security",
      "Loan eligibility depends on land ownership",
      "Loans include both cash and kind components",
      "Finance is fixed based on cost of cultivation"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The price set by government for farm produce",
      "The minimum price below which the seller will refuse to sell",
  ...
  },
  {
    ...
    "options": [
      "An industry cluster sharing common infrastructure in the agricultural economy",
      "Industry-wide technology improvement in rural economic context",
      "Splitting workers to specialize in tasks in a motor vehicle factory",
      "A pharmaceutical company sharing research with a university (external)"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Establishment costs (plant construction)",
      "Variable costs (raw materials, labour, power, maintenance)",
      "Fixed costs (land rent, taxes, depreciation)"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Is the main permanent record for debtors and creditors",
      "Records only cash transactions in the agricultural economy",
      "Records original entries from diary in classified debit/credit form in order of dates",
      "Records only annual summary of income and expenses in rural economic context"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "They require no security in rural economic context",
      "They can never be repaid in the agricultural economy in agriculture",
      "They are given for activities that take a long time to generate income for repayment (5-20+ years)",
      "They are provided free of interest for farm income analysis for crop production"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Prices of raw materials are always low in the agricultural economy",
      "Processing is subsidized by government in rural economic context",
      "Processing firms enjoy monopsony/oligopsony positions and this creates disincentives for producers",
      "Consumers pay less for processed goods for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "The product is homogeneous and the firm cannot influence market price, taking it as given",
      "There are only a few buyers in the agricultural economy in agriculture",
      "Government regulates the price strictly in rural economic context",
      "The firm is very large for farm income analysis for crop production"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Only agricultural credit in the agricultural economy in agriculture",
      "Only dairy cooperatives in rural economic context",
      "Animal husbandry, forestry, horticulture, pisciculture and livestock, industrial goods, handicrafts and services",
      "Only sugar cooperatives for farm income analysis for crop production"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "All of: land utilization, crop production, livestock, labour, machinery, feed, store register and farm inventory records",
      "Only labour and machinery records in the agricultural economy in agriculture",
      "Only crop production records in rural economic context",
      "Only livestock production records for farm income analysis for crop production"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Mac Lagan Committee in the agricultural economy",
      "Nariman Committee in rural economic context",
      "Venkatappaiah Committee (AIRCRC) for farm income analysis",
      "Gadgil Committee (National Credit Council Study Group)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Open auction is conducted for each sample in the agricultural economy",
      "All produce is mixed and sold at one price in rural economic context",
      "Prices are settled by finger-pressing under cloth for farm income analysis",
      "Commission agent takes samples to buyers' shops instead of buyers coming to commission agent"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Only export promotion in the agricultural economy in agriculture",
      "Determine conditions for optimum resource use, assess deviation from optimum",
      "Only profit maximization for farmers in rural economic context",
      "Only food security planning for farm income analysis for crop production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Rs. 1000 crores from ARDC for farm income analysis",
      "Rs. 100 crores (from GOI only) in the agricultural economy",
      "Rs. 200 crores from commercial banks in rural economic context",
      "Rs. 500 crores equally from Government of India and RBI"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Increasing farm production and reducing poverty in the agricultural economy in agriculture",
      "Linking cooperatives with commercial banks in rural economic context",
      "Treating crop as security instead of land, and fixing finance based on cost of cultivation",
      "Providing subsidized credit and free inputs for farm income analysis for crop production"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "A-1-i, B-2-ii, C-3-iii, D-4-iv",
      "A-3-i, B-4-ii, C-2-iii, D-1-iv",
      "A-2-i, B-1-ii, C-4-iii, D-3-iv",
      "A-1-ii, B-2-i, C-3-iv, D-4-iii"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      ...
      "Adding more fixed factors in the agricultural economy",
      "Changing the technology used in rural economic context",
      "Intensive use of fixed resources through variable inputs"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Orchard establishment loan in the agricultural economy",
      "Tractor purchase loan for farm income analysis",
      "Land leveling loan in rural economic context",
      "Crop production loan for seeds and fertilizers"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Import duties on agricultural machinery in the agricultural economy in agriculture",
      "Costs borne by society such as environmental degradation, pollution, new diseases from irrigation",
      "Government subsidies to agriculture in rural economic context",
      "Private costs of firms for farm income analysis for crop production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Less and less (diminishing returns to variable factor)",
      "Equal each time (constant returns)",
      "More and more (increasing returns)",
      "Zero immediately after initial increase"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "IFFCO establishment at Kandla",
      "Setting up of NCDC",
      "Introduction of single window system of credit",
      "Replication of Anand Pattern for milk"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Only crop yields per acre in the agricultural economy in agriculture",
      "Use and incomes from farm, return to scale, leasing, production possibilities, farming efficiency, credit use, risks",
      "Only technology adoption in rural economic context",
      "Only macroeconomic policies affecting agriculture for farm income analysis for crop production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "Excessive profits and poor governance in the agricultural economy in agriculture",
      "Lack of cooperative network and poor infrastructure in rural economic context",
      "Illiteracy among members, misappropriation of funds, rampant nepotism, undue delays in sanctioning loans, irregularity in repayment",
      "Excessive government interference and high interest rates for farm income analysis for crop production"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Only consumer cooperative development in the agricultural economy in agriculture",
      "Involvement of cooperatives in rural development, development of credit system, extending cooperatives to farming/industry/housing/marketing, training",
      "Only price support for agricultural commodities in rural economic context",
      "Only agricultural credit expansion for farm income analysis for crop production"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      "The difference between original purchase price and current price of the same asset",
      "The depreciation charged each year in rural economic context",
      "The cost of maintaining farm equipment for farm income analysis",
      "The original purchase price of an asset in the agricultural economy"
    ],
    "correct": 0,
  ...
  },
  {
    ...
    "options": [
      "Costs that remain fixed regardless of output in rural economic context",
      "Costs subsidized by government in the agricultural economy",
      "Costs expressed at constant prices (deflated by general price index to remove inflation effect)",
      "Costs that are increasing over time for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Summarizing accounts at year end in the agricultural economy in agriculture",
      "Checking arithmetical accuracy of ledger in rural economic context",
      "Recording original diary entries in classified debit/credit form in date order for posting to ledger",
      "Recording only cash transactions for farm income analysis for crop production"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Only the total land holding size",
      "Variety (local/improved/HYV), season, and type of crop (irrigated/rainfed)",
      "The market price of the crop",
      "Credit history of the farmer only"
    ],
    "correct": 1,
  ...
  },
  {
    ...
    "options": [
      ...
      "Zero at start and positive throughout",
  ...
  },
  {
    ...
    "options": [
      "To explain means and methods for changing to optimum resource use",
      "To determine conditions for optimum resource use",
      "To maximize food exports",
      "To determine extent of deviation from optimum use"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "After price fluctuations settle"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "Fixed costs can be separated from variable costs only in short run",
      "Fixed and variable costs are always equal in the agricultural economy",
      "All costs are social in nature in rural economic context",
      "Separable costs can exclusively be attributed to production of specific output, while joint costs cannot"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Unlimited for primary societies and limited for central societies",
      "Limited for all types of cooperative societies",
      "Equal for all types",
      "Limited for primary societies and unlimited for central societies"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Minor adjustments in irrigation are required in rural economic context",
      "Simple improvements are needed for one enterprise in the agricultural economy",
      "Major changes are contemplated in the existing organization of entire farm business",
      "Only one resource needs to be substituted for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      ...
      "Perfect competition markets (farm commodities)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Social costs (externalities)",
      "Implicit costs (owned resources)",
      "Variable costs (working costs, operating costs)",
      "Establishment costs (plant construction costs)"
    ],
    "correct": 3,
  ...
  },
  {
    ...
    "options": [
      "Joint venture between farmer and bank in the agricultural economy",
      "Long-term investment in agricultural enterprises in rural economic context",
      "Temporary transfer of asset from one who has to other who has not",
      "Permanent transfer of money from lender to borrower for farm income analysis"
    ],
    "correct": 2,
  ...
  },
  {
    ...
    "options": [
      "A government office",
      "Merchandise, trade or a place of business",
      "A storage warehouse",
      "A unit of currency"
    ],
    "correct": 1,
