...
export const da241Questions: Question[] = [
  {
    ...
    options: ["Only crop production", "Allocation of scarce resources in agricultural production, marketing, and consumption", "Only farm machinery", "Only agricultural finance"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Growing more crops", "The science and art of organising, operating, and managing a farm for maximum profit", "Only irrigation management", "Record keeping in farming"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Variable cost", "Fixed cost", "Marginal cost", "Opportunity cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fixed cost", "Variable cost", "Sunk cost", "Imputed cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Gross income", "Net profit (farm income)", "Total revenue", "Gross margin"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["State government", "NABARD", "Central government based on CACP recommendations", "Farmers' organisations"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["1950s", "Late 1960s and 1970s", "1980s", "1990s"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Earn profit for shareholders", "Provide mutual benefit and economic protection to members", "Compete with private companies", "Only export agricultural produce"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Agricultural Produce Market Committee", "Agricultural Products Management Corporation", "Agri-Produce Marketing Council", "Agricultural Price Monitoring Committee"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Commercial banks", "Primary Agriculture Credit Society (PACS)", "RBI", "Insurance companies"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Kisan Credit Card", "Pradhan Mantri Fasal Bima Yojana (PMFBY)", "MNREGA", "PM-KISAN"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["₹2,000", "₹4,000", "₹6,000", "₹12,000"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["The actual cost of production", "The value of the next best alternative forgone", "Fixed cost plus variable cost", "Marginal cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Output increases proportionately with all inputs", "As one variable input is increased while others remain constant, the marginal product eventually decreases", "Fixed costs always decrease with output", "More labour always gives more output"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Online banking for farmers", "National Agriculture Market — online trading of agricultural produce", "E-learning for farmers", "Digital land records"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Retail banking", "Providing credit for agriculture and rural development", "Insurance only", "Export promotion"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Growing only one crop repeatedly", "Growing multiple crops and enterprises to reduce risk and increase income", "Mechanizing all farm operations", "Only animal husbandry"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Government fixing maximum price", "Government ensuring a minimum guaranteed price to prevent price fall below a certain level", "Market-determined price", "Export price subsidy only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Greater than 1 (elastic)", "Equal to 1 (unit elastic)", "Less than 1 (inelastic)", "Zero"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Conventional farming", "Organic farming", "Contract farming", "Commercial farming"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["To maximize government revenue", "To provide food grains at subsidised prices to the poor", "To export surplus food", "To control inflation only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["RBI", "NABARD", "Commission for Agricultural Costs and Prices (CACP)", "NITI Aayog"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Only buying crops from farmers", "All activities from production to final consumption including processing, storage, transport, and sale", "Only export of crops", "Government procurement only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Highly elastic (> 1)", "Inelastic (< 1) — demand changes less than price change", "Perfectly elastic (= infinity)", "Unit elastic (= 1)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Government policies for farming", "Organizing and operating a farm for maximum continuous profit consistent with sustainable use of resources", "Growing the maximum number of crops", "Selling farm produce at the highest price"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Growing crops where absolute costs are lowest", "Specializing in production of goods with lower opportunity cost — basis of trade between regions", "Growing the crop with highest price", "Government subsidy advantage"],
    correct: 1,
  ...
  },
  {
    ...
    subject: "da-241",
    question: "APMC stands for:",
    options: ["Agricultural Produce Management Corporation", "Agricultural Produce Marketing Committee", "Agricultural Price Monitoring Commission", "Agricultural Production Management Council"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only seed and fertilizer cost", "Variable costs + Fixed costs (interest on capital, depreciation, rent, family labour value)", "Only hired labour cost", "Only machinery cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Profit of the farmer only", "Difference between price paid by consumer and price received by farmer — includes transportation, processing, and trader margins", "Government tax on produce", "Subsidy to farmers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["1991", "1998–99", "2005", "2012"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Agricultural income is reduced by taxes", "Every rupee of farm income generates additional income in the rest of the economy through backward and forward linkages", "Crop prices multiply annually", "Government multiplies agricultural subsidies"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["As income rises, proportion of income spent on food increases", "As income rises, proportion of income spent on food decreases (food expenditure share falls)", "Food prices always rise with income", "Total food expenditure decreases with income"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Direct lending to farmers at branch level", "Refinancing banks for agricultural credit, rural development, and watershed projects", "Fixing MSP for crops", "Operating e-NAM portal"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Trade between farmers at local markets", "The ratio of prices received by farmers (output prices) to prices paid by farmers (input prices)", "Government's trade policy for exports", "Trade agreements between countries"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["State governments without central guidance", "Model APMC Act (2003), Model Contract Farming Act (2018), and Farm Laws (2020 — later withdrawn)", "RBI monetary policy", "WTO agreements"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["RBI only", "State Cooperative Acts and the Multi-State Cooperative Societies Act (2002) — registered under respective state/central laws", "SEBI (Securities Exchange Board)", "Ministry of Commerce"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["2005–06", "2007–08", "2010–11", "2012–13"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Subsidies that directly distort trade (to be reduced)", "Non-trade distorting subsidies (R&D, extension, food security stockholding, disaster relief) — exempt from reduction", "Blue box subsidies limited by production", "Amber box subsidies tied to production"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Zero — family labour has no cost", "The wage that family labour could have earned in the best alternative employment", "Only physical fatigue cost", "Government's minimum wage rate only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Crop yield always decreases with more inputs", "Adding more of one input (e.g., fertilizer) while keeping others constant eventually adds less and less to output", "Returns from farming decrease every year", "More land always gives less output"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Maximizing production of all crops", "A resource allocation where no one can be made better off without making someone else worse off", "Equal distribution of agricultural income", "Government optimal pricing policy"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["₹2,000/year", "₹4,000/year", "₹6,000/year (₹2,000 every 4 months)", "₹10,000/year"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Calculate crop yield", "Determine the blended interest rate on various sources of funds (owned capital + borrowed capital) for investment decisions", "Fix land price", "Calculate subsidy amount"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Guarantee farmer profit regardless of market prices", "Provide financial support to farmers suffering crop loss due to natural calamities, pests, and diseases", "Fix crop prices", "Subsidize all farming inputs"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Single level: primary society only", "Three-tier: Primary Agricultural Credit Societies (PACS) at village — District Central Cooperative Banks (DCCBs) — State Cooperative Banks (SCBs)", "Two-tier: commercial banks and NABARD", "NABARD directly lending to farmers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Net profit is maximum", "Total revenue equals total cost — no profit, no loss", "Variable costs equal fixed costs only", "Government support price equals market price"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Free water for all farmers", "'Har Khet Ko Pani, More Crop Per Drop' — expanding irrigation coverage and improving water use efficiency", "Groundwater extraction promotion", "Flood irrigation subsidization"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Population grows arithmetically while food production grows geometrically", "Population grows geometrically (exponentially) while food production grows arithmetically (linearly), leading to food shortages", "Food production always exceeds population growth", "Population and food grow at the same rate"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Maximize farmers' income by keeping food prices high", "Balance interests of producers (remunerative prices) and consumers (affordable food prices) through MSP and public distribution", "Fix all food prices at zero for consumers", "Eliminate all price support"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Marketing of green-coloured vegetables only", "Selling eco-friendly, sustainably produced, and certified organic products at premium prices", "Selling crops at APMC green (organic) mandis", "Using green packaging only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["NABARD", "Planning Commission of India", "CACP", "Finance Commission"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Ministry of Rural Development", "ICAR (Indian Council of Agricultural Research) — India has 731 KVKs at district level", "State Agriculture Universities", "NABARD"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only crop production activities", "Crop cultivation + livestock + fishery + horticulture on the same farm for better income and sustainability", "Only animal husbandry with crop", "Government programs only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Increasing food import", "Increasing production of rice, wheat, pulses, coarse cereals, and nutri-cereals through area expansion and productivity improvement", "Government food distribution only", "Reducing farming area"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Provide health insurance to farmers", "Provide soil test-based fertilizer recommendations to improve nutrient use efficiency and reduce over-fertilization", "Map groundwater availability", "Assess crop damage for insurance"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Free seeds annually", "Annual income support of ₹13,500 per farmer (in addition to PM-KISAN ₹6,000)", "Free irrigation water", "Debt waiver for all loans"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Free seeds and fertilizers to all farmers", "Investment support of ₹10,000 per acre per year to land-owning farmers (two instalments of ₹5,000)", "Crop insurance without premium", "Free electricity for irrigation pumps"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only physical spot delivery of commodities", "Futures and options contracts for standardized agricultural and non-agricultural commodities", "Government procurement contracts only", "Only international export contracts"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Increasing agricultural trade barriers", "Reducing domestic support subsidies, export subsidies, and import tariff barriers through multilateral negotiations", "Standardizing crop production worldwide", "Promoting organic farming globally"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Government buying crops directly from individual farmers", "Aggregating small farmers into collectively organized entities for better market power, input access, and credit", "Eliminating all middlemen from markets", "Providing free machinery"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fix crop insurance premium", "Track changes in farm gate prices received by farmers over time — used in terms of trade analysis", "Fix MSP annually", "Calculate agricultural GDP"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Subsidy on seeds, fertilizers, irrigation electricity, and credit interest — amounting to crores annually", "Only seed subsidy", "Only fertilizer subsidy", "Government pays all farming costs"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Amount of loan only", "Repayment period — short-term (up to 15 months), medium-term (15 months–5 years), long-term (5–20 years)", "Type of crop grown", "Collateral provided"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["No difference — both are the same", "Tenant pays fixed rent (cash or crop) while sharecropper splits the produce with landowner in agreed ratio", "Tenant owns the land while sharecropper rents", "Government determines both arrangements"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only production stage", "All stages from production to consumption: inputs → production → harvest → storage → processing → marketing → retail → consumer", "Only marketing stages", "Government procurement only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Tractor gear ratio for fuel efficiency", "Ratio of borrowed capital to owned capital — indicates financial risk", "Crop yield ratio between seasons", "Land-to-labour ratio"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Moneylenders and landlords (non-institutional)", "Commercial banks, cooperative banks, RRBs, NABARD, and microfinance institutions (institutional sources)", "Friends and relatives only", "Black market lenders"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Farmers deliberately manipulate prices", "Agricultural production is seasonal (concentrated supply at harvest) but consumption is year-round, causing price dips at harvest and rises off-season", "Government changes MSP seasonally", "Weather affects consumer demand seasonally"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Estimate rainfall patterns", "Find the optimal combination of farm enterprises (crops, livestock) to maximize income subject to resource constraints", "Calculate soil nutrient requirements", "Determine fertilizer prices"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Provide agricultural credit", "Document land ownership rights — contains details of land holdings, survey numbers, and ownership", "Access crop insurance", "Receive PM-KISAN benefits"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5 crops", "14 crops", "23 crops", "All agricultural crops"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Only television and radio", "Multiple channels: KVK (farm science centres), state agriculture department extension workers, ATMAs, NGOs, private sector, digital advisory", "Only government agricultural officers", "Only ICAR scientists"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Expansion of cultivated area only", "HYV seeds + chemical fertilizers + assured irrigation — primarily wheat in Punjab, Haryana, UP", "Only organic farming improvement", "Land redistribution"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["40% in 2023", "30% in 2023", "15–18% in 2023", "5% in 2023"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["50 million ha", "100 million ha", "140 million ha", "200 million ha"],
    correct: 2,
