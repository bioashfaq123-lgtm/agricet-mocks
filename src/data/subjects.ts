...
export const SUBJECTS: Subject[] = [
  ...
  { id: "da-252", code: "DA-252", name: "Land Surveying, Water Engineering & Greenhouse Tech.", icon: "📐", color: "slate",   description: "Surveying, chain & compass survey, soil & water conservation, crop-water (Delta/Duty), irrigation methods, pumps, greenhouse technology", totalQuestions: 70, category: "Engineering" },
