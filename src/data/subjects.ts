...
export const SUBJECTS: Subject[] = [
  ...
  { id: "da-201", code: "DA-201", name: "Crop Production-II (Oilseeds & Commercial Crops)", icon: "🌻", color: "gold",    description: "Groundnut, castor, sunflower, sesame, safflower, cotton, sugarcane, tobacco, chilli, turmeric, coriander", totalQuestions: 200, category: "Core" },
