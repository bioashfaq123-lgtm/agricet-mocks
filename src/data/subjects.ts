...
export const SUBJECTS: Subject[] = [
  ...
  { id: "da-252", code: "DA-252", name: "Survey, Levelling & Field Measurements",     icon: "📐", color: "slate",   description: "Chain surveying, levelling, area calculation, contour mapping, land records", totalQuestions: 200, category: "Engineering" },
