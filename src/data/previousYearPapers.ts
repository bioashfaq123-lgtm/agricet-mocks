...
export const PREVIOUS_YEAR_PAPERS: PreviousYearPaper[] = [
  ...
  { id: "2023ap", year: 2023, title: "AP AGRICET 2023 – DA Question Paper with Key (ANGRAU)",    totalQuestions: 101, duration: 90,  badge: "🆕 NEW", description: "Official ANGRAU AGRICET 2023 question paper with answer key (Andhra Pradesh). 101 questions with green-coded correct answers.", available: true  },
