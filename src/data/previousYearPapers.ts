...
export const PREVIOUS_YEAR_PAPERS: PreviousYearPaper[] = [
  { year: 2025, title: "AGRICET 2025 – DA Official Question Paper", totalQuestions: 100, duration: 100, description: "Official AGRICET 2025 question paper for Diploma in Agriculture candidates (PJTSAU).", available: true },
  { year: 2024, title: "AGRICET 2024 – DA Question Paper with Key", totalQuestions: 100, duration: 100, description: "Complete 2024 question paper with official answer key (English script questions only).", available: true },
  { year: 2023, title: "AGRICET 2023 – DA Question Paper with Key", totalQuestions: 100, duration: 100, description: "Full 2023 question paper with detailed official answer key (English script questions only).", available: true },
