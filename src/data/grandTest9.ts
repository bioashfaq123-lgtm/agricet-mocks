...
export const GRAND_TEST_9: GrandTestQuestion[] = [
  // AGRONOMY (6)
  {
    ...
    options: ["Crop Evapotranspiration (ETc)", "ETc − Effective Rainfall", "ETc − Effective Rainfall − Soil Moisture contribution", "ETc + Percolation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["10–15%", "2,000–3,000 Rs/ha", "25–30%", "50% of input cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Solar radiation captured / Total solar radiation", "Dry matter produced / Photosynthetically Active Radiation (PAR) intercepted", "Crop yield / Solar constant", "Leaf area / Radiation intercepted"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["High soil temperature", "Osmotic stress reducing water uptake and specific ion toxicity (Na⁺, Cl⁻)", "Reduced soil aeration", "Low soil organic matter"],
    correct: 1,
  ...
  // KHARIF CROPS (7)
  {
    ...
    options: ["Tropical areas only", "Wide adaptability across latitudes and seasons without yield loss", "Only high-altitude areas", "Only short-day photoperiods"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5,000–10,000 plants/ha", "15,000–20,000 plants/ha", "30,000–50,000 plants/ha", "75,000–100,000 plants/ha"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Soybean", "Wheat", "Rice", "Cotton"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["It is the stage for transplanting", "Water and nutrient stress at this stage causes maximum spikelet sterility", "Weeding is done at this time", "It determines plant height"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Edible oil production", "Lubricants, pharmaceuticals, plastics, and biodiesel (non-edible)", "Vegetable ghee production", "Paint pigments"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Rainfall received / Crop yield", "Crop yield / Evapotranspiration", "Crop yield / Irrigation water applied", "Both B and C are correct definitions for different contexts"],
    correct: 3,
  ...
  // RABI CROPS (5)
  {
    ...
    options: ["Frost damage during germination", "Terminal heat stress during grain filling", "Excessive rainfall at maturity", "Lodging due to late growth"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Apiaceae", "Fabaceae", "Lamiaceae", "Asteraceae"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Kerala", "Rajasthan and Haryana", "Assam", "Tamil Nadu"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Dwarf wheat variety from IARI", "Disease-resistant variety", "Variety with 100 days maturity in plains", "Mexican semi-dwarf variety released for Indian conditions"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Whether or not a genotype produces a phenotype (penetrance)", "The degree to which a gene is expressed in phenotype among individuals carrying it", "The number of genes affecting a trait", "The ability of a gene to interact epistatically"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Aegilops squarrosa (Ae. tauschii)", "Triticum urartu", "Aegilops speltoides", "Triticum monococcum"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Inbreeding coefficient (F)", "Coefficient of kinship", "Heritability coefficient", "Correlation coefficient"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Norin-10 (Rht-B1b and Rht-D1b genes)", "Chinese Spring", "Emmer wheat", "Marquis wheat"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Werner Arber, Daniel Nathans, and Hamilton Smith (Nobel 1978)", "James Watson and Francis Crick", "Kary Mullis (Nobel 1993)", "Fred Sanger (Nobel 1958, 1980)"],
    correct: 0,
  ...
  // SEED TECHNOLOGY (4)
  {
    ...
    options: ["Only soil-borne pathogens after sowing", "Externally borne pathogens on the seed surface", "Both seed-borne and soil-borne pathogens", "Only storage fungi"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Seed moisture content", "Seed electrolyte leakage indicating membrane integrity (vigour test)", "Seed coat permeability to water", "Nutrient content of seeds"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Short-term storage of germplasm", "Long-term preservation of recalcitrant seeds, vegetatively propagated crops, and endangered species", "Standard quality seed storage", "Virus elimination from planting material"],
    correct: 1,
  ...
  // SOIL SCIENCE (5)
  {
    ...
    options: ["Non-saline soil", "Slightly saline (sensitive crops affected)", "Saline soil (most crops affected)", "Highly saline (only tolerant crops survive)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["SOC × 1.0", "SOC × 1.724 (Van Bemmelen factor)", "SOC × 2.5", "SOC × 0.5"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Hydrometer method", "Wet sieving method (wet aggregate stability test)", "Textural analysis", "Dry sieving only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Parent material and climate only", "Observable and measurable soil properties — diagnostic horizons and characteristics", "Vegetation and land use", "Country of origin"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Urea", "Ammonium nitrate", "Neem-coated urea / Sulphur-coated urea", "Ammonium sulphate"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Physical disruption of rock phosphate", "Production of organic acids (gluconic, citric, oxalic) that lower pH and release phosphate", "Producing phosphatase enzymes only", "Nitrogen fixation linked to phosphorus release"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Maximum fertiliser input for maximum yield", "Specific yield goal by applying fertiliser to make up the soil's nutrient deficit", "Only organic farming systems", "Generic fertiliser doses for all soils"],
    correct: 1,
  ...
  // ENTOMOLOGY (5)
  {
    ...
    options: ["Planting all non-Bt varieties", "Growing non-Bt refuge crop (5–20%) adjacent to Bt crop to maintain susceptible insects", "Using multiple pesticides together", "Rotating Bt with non-Bt every season"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Inhibiting acetylcholinesterase (AChE)", "Binding to nicotinic acetylcholine receptors (nAChR) causing overstimulation", "Disrupting cuticle synthesis", "Inhibiting mitochondrial respiration"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lepidoptera (moths/butterflies)", "Coleoptera (beetles)", "Diptera (flies)", "Hymenoptera (wasps/bees)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Moths and butterflies", "Flies (Calyptrate Diptera — house fly, blow fly)", "Beetles", "Wasps"],
    correct: 1,
  ...
  // CROP PESTS (5)
  {
    ...
    options: ["Infests grain stores", "Causes myiasis (flesh wounds) in livestock", "Attacks crop roots", "Pollinates mango flowers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Feeding on leaves", "Adults and larvae boring into pseudostem base and corm", "Sucking sap from young fruits", "Damaging flower buds"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chemical spray calendar irrespective of pest status", "Monitoring-based pest management using ETL thresholds, biocontrol agents, and resistant varieties", "Blanket application of insecticides at sowing", "Complete avoidance of all chemical inputs"],
    correct: 1,
  ...
  // FARM MACHINERY (6)
  {
    ...
    options: ["Cutting the crop", "Threshing — separating grain from straw by impact and rubbing action", "Cleaning chaff from grain", "Transporting grain to the tank"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["8 kN", "200 kN", "28.8 kN", "1000 N"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["(Red − NIR) / (Red + NIR)", "(NIR − Red) / (NIR + Red)", "(Green − Red) / (Green + Red)", "(Blue − NIR) / (Blue + NIR)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It determines soil type", "It affects flow rate through emitters and uniformity of water distribution", "It measures fertiliser solubility", "It determines pump efficiency"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Oven drying method", "Electrical resistance or capacitance method", "Near-infrared spectroscopy only", "Karl Fischer titration"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Field data collection", "Precision design and manufacturing of implement components", "GPS-based tractor guidance", "Crop monitoring from satellites"],
    correct: 1,
  ...
  // PLANT PATHOLOGY (9)
  {
    ...
    options: ["Gibberella fujikuroi (Fusarium moniliforme)", "Pyricularia oryzae", "Helminthosporium oryzae", "Xanthomonas oryzae pv. oryzae"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Affecting only roots", "Concentric ring 'target spot' lesions primarily on older leaves; caused by Alternaria solani", "White cottony sporulation on leaf undersides", "Symptoms appearing first on younger leaves"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Producing toxins that stimulate abnormal cell division", "Transferring Ti plasmid DNA into host cells using T-DNA", "Secreting growth hormones externally", "Blocking vascular tissue"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["J.E. Vanderplank", "H.H. Flor", "E.C. Stakman", "P.W. Brian"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Tilletia tritici", "Neovossia indica (Tilletia indica)", "Ustilago tritici", "Tilletia controversa"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Albugo candida", "Pythium ultimum", "Plasmodiophora brassicae", "Olpidium brassicae"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Multiple infection cycles occur in a season", "Only one infection cycle occurs per season (single cycle)", "Disease spreads through seeds only", "Disease occurs in alternate years"],
    correct: 1,
  ...
  // AGRICULTURAL ECONOMICS (7)
  {
    ...
    options: ["Absolute shortage of food production", "Failure of food entitlements (inability to acquire food due to exchange failures)", "Overpopulation", "Natural disasters alone"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Maximises GDP growth only", "Benefits all sections of society, reducing inequality", "Focuses only on urban development", "Excludes government intervention"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The slope of the regression line", "The proportion of total variation in Y explained by X", "The error term in regression", "The correlation coefficient squared"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reduces total yield", "Reduces income risk by spreading across crops with different market cycles", "Increases input costs", "Reduces soil fertility"],
    correct: 1,
  ...
  // SURVEYING (4)
  {
    ...
    options: ["Measuring soil temperature at depth", "Crop area estimation, yield forecasting, drought monitoring, and land use mapping", "Underground water mapping only", "Weather forecasting only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Level + Compass", "Theodolite + Electronic Distance Measurement (EDM)", "Compass + Ruler", "GPS + Camera"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Pipes under pressure", "Open channels (canals, streams)", "Soil water movement", "Sprinkler pipes"],
    correct: 1,
  ...
  // FORESTRY (5)
  {
    ...
    options: ["Cannot regenerate from stumps", "Regenerate vigorously from root stocks or stumps after cutting", "Require seed regeneration only", "Are shade tolerant saplings"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["National forests and state forests", "Reserved forests, Protected forests, and Village forests", "Commercial forests and conservation forests", "Dry forests and moist forests"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["10–15 years", "20–30 years", "60–80 years", "100+ years"],
    correct: 2,
  ...
  // HORTICULTURE (10)
  {
    ...
    options: ["Cucurbitaceae", "Solanaceae", "Apiaceae", "Malvaceae"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It produces seedless fruits", "Grapefruit is a natural hybrid of pummelo and sweet orange", "It is disease resistant", "It is used as a rootstock only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Calcium nitrate", "Magnesium sulphate (MgSO₄·7H₂O)", "Potassium chloride", "Ferrous sulphate"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mango produces multiple fruits per inflorescence", "A single seed contains more than one embryo (multiple seedlings per seed)", "Mango flowers twice a year", "Fruits have multiple seeds"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["It requires 2,500 mm annual rainfall", "It is adapted to arid/semi-arid regions with as little as 200–250 mm rainfall", "It grows only in coastal areas", "It requires high humidity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["100% CO₂", "Elevated CO₂ (5–20%) and reduced O₂ (2–5%) to slow respiration", "100% N₂ only", "Ozone gas"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reduce plant height", "Promote lateral shoot growth for increased flower production (bushy growth)", "Prevent diseases", "Improve root development"],
    correct: 1,
  ...
  // EXTENSION (6)
  {
    ...
    options: ["It provides crop loans", "It funds watershed development, land levelling, and farm pond construction as permissible activities", "It provides crop insurance", "It subsidises seeds and fertilisers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Technology transfer only", "Farmer-led innovation and community-based learning", "Input subsidy distribution", "Market linkage creation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sell agricultural machinery at subsidised rates", "Provide machinery hiring services to small and marginal farmers who cannot afford to buy", "Train farmers in machinery operation", "Repair and maintain government tractors"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["₹5,000/year to small farmers", "₹6,000/year direct income support in three equal instalments to all farmer families", "₹10,000/year to marginal farmers", "₹2,000/year to tenant farmers"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Theoretical knowledge only", "Development of specific skills, knowledge, and attitudes needed for effective job performance", "Duration-based training programmes", "Only on-farm demonstrations"],
    correct: 1,
  ...
  { id:"gt9_097", qNo:97, subject:"general-agriculture", question:"IPM (Integrated Pest Management) in India is promoted by:", options:["NABARD","DPPQS (Directorate of Plant Protection, Quarantine and Storage)","ICAR","State Agriculture Departments only"], correct:1, explanation:"The Directorate of Plant Protection, Quarantine and Storage (DPPQS) under the Ministry of Agriculture is the nodal agency promoting IPM in India through Central IPM Centres and training programmes." },
  ...
  { id:"gt9_099", qNo:99, subject:"general-agriculture", question:"India is the world's largest exporter of:", options:["Wheat","Soybeans","Rice (including non-basmati)","Maize"], correct:2, explanation:"India is the world's largest exporter of rice (both basmati and non-basmati), accounting for over 40% of global rice trade. Major importing countries include Bangladesh, Benin, Nepal, Ivory Coast and UAE." },
  { id:"gt9_100", qNo:100, subject:"general-agriculture", question:"'Agri-Stack' is India's initiative to build:", options:["A stack of agricultural warehouses","Digital public infrastructure (DPI) for agriculture including farmers' database, land records and crop sowing registry","A national cold chain network","Satellite-based crop monitoring system"], correct:1, explanation:"Agri-Stack is India's federated digital infrastructure for agriculture — a stack of databases including Farmers' Registry, Geo-referenced Village Maps, and Crop Sown Registry — enabling targeted service delivery and reducing farmer information asymmetry." },
];
