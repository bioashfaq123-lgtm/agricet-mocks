...
export const GRAND_TESTS: GrandTestMeta[] = [
  ...
  { id: "gtlive", title: "FREE Live Mock Test",  totalQuestions: 100, duration: 100, badge: "🔴 LIVE • 8 June",   difficulty: "Mixed",  description: "Official free live mock test for all AGRICET aspirants across Telangana — Monday, 8th June 2026, 8 PM to 9:40 PM.", subjects: 17 },
];
