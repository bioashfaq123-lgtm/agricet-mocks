...
export const GRAND_TEST_5: GrandTestQuestion[] = [
  // AGRONOMY (6)
  {
    ...
    options: ["Blackman (1919)", "Monsi and Saeki (1953)", "Watson (1947)", "De Wit (1965)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Boot stage and dough stage", "Tillering and heading", "Germination and grain filling", "Crown root initiation and flowering"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Percentage of weed biomass", "Absolute number of weeds", "Percentage of weed-free yield", "kg of weeds per hectare"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["30–35°C", "15–18°C", "20–25°C", "38–42°C"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Gross photosynthesis", "Litterfall", "Root exudates", "Respiration losses"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["120–150 days", "60–80 days", "90–100 days", "150–180 days"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["50–60 kg/ha", "80–100 kg/ha", "100–120 kg/ha", "20–25 kg/ha"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Cleistogamous", "Both chasmogamous and cleistogamous", "Chasmogamous", "Amphicarpous"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["15 × 10 cm", "30 × 20 cm", "25 × 25 cm", "20 × 15 cm"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Brace roots (prop roots)", "Fibrous root mass", "Tap root system", "Seminal roots"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Cowpea", "Sorghum", "Castor", "Bajra"],
    correct: 3,
  ...
  // RABI CROPS (5)
  {
    ...
    options: ["125 kg/ha", "50 kg/ha", "100 kg/ha", "75 kg/ha"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["0–5°C for 30–60 days", "5–10°C for 7–10 days", "−5 to 0°C for 20–30 days", "10–15°C for 15–20 days"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["December–January", "August–September", "October–November", "February–March"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Stemphylium blight", "Fusarium wilt", "Rust", "Powdery mildew"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Leguminosae (Fabaceae)", "Solanaceae", "Malvaceae", "Compositae"],
    correct: 0,
  ...
  // GENETICS (7)
  {
    ...
    options: ["W.S. Gosset", "R.A. Fisher", "G. Mendel", "Karl Pearson"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Salivary glands of Drosophila", "Liver cells of mammals", "Pollen grains of angiosperms", "Oocytes of Xenopus"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Both B and C are correct", "Two unlinked genes with independent assortment", "Complete dominance with no linkage", "Two linked genes with 50% recombination"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["H3 + H4 tetramer + 80 bp DNA", "H1 + 146 bp DNA", "H1, H2A, H2B, H3, H4 + 200 bp DNA", "H2A, H2B, H3, H4 each × 2 + 147 bp DNA"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Avery, MacLeod and McCarty", "Beadle and Tatum", "Morgan and Sturtevant", "Watson and Crick"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The presence of transposons", "The sex of the offspring", "The parental origin of the allele", "The number of gene copies"],
    correct: 2,
  ...
  // SEED TECHNOLOGY (4)
  {
    ...
    options: ["Sunflower", "Groundnut", "Onion", "Cotton"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Hydropriming", "Osmopriming", "Biopriming", "Matrix priming"],
    correct: 1,
  ...
  // SOIL SCIENCE (5)
  {
    ...
    options: ["Residual soils", "Alluvial soils", "Transported soils", "Colluvial soils"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Podzolization", "Eluviation", "Illuviation", "Lessivage"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["1.5 MPa", "0.33 MPa", "3.0 MPa", "0.1 MPa"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["C horizon", "O horizon", "A horizon", "B horizon"],
    correct: 1,
  ...
  // SOIL FERTILITY (5)
  {
    ...
    options: ["Soil organic carbon", "Available phosphorus in soil", "Soil pH", "Cation exchange capacity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Older leaves", "Stem nodes", "Young leaves (growing tips)", "Roots"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Blackman (1905)", "Boussingault (1838)", "Mitscherlich (1909)", "Liebig (1840)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Neutral", "Variable depending on soil type", "Alkaline", "Acidic"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Free-living N-fixer", "Symbiotic N-fixer", "Mycorrhizal fungus", "Associative N-fixer"],
    correct: 3,
  ...
  // ENTOMOLOGY (5)
  {
    ...
    options: ["Apiculture", "Economic entomology", "Forensic entomology", "Medical entomology"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Filter feeding", "Sucking liquid food", "Biting and chewing solid food", "Piercing and chewing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mites", "Lice", "Thrips", "Fleas"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Juvenile hormone", "Ecdysone (moulting hormone)", "Brain hormone (PTTH)", "Bursicon"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Pest causes visible damage", "Pest population starts increasing", "Cost of control equals value of crop loss", "50% of crop is damaged"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Chilo infuscatellus", "Sesamia inferens", "Diatraea saccharalis", "Eldana saccharina"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Dead heart symptom", "Hopperburn", "Leaf scald", "Silver shoot (onion shoot) symptom"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Acaricides", "Nematicides", "Fungicides", "Insecticides"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["30–40° BTDC", "45–60° BTDC", "15–25° BTDC", "5–10° BTDC"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Mould board plough", "Sub-soiler", "Chisel plough", "Disc plough"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Lift and control mounted implements", "Control engine speed", "Control steering", "Operate the brakes"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["ICAR, New Delhi", "CIAE, Bhopal", "NABL", "BIS (Bureau of Indian Standards)"],
    correct: 3,
  ...
  // PLANT PATHOLOGY (9)
  {
    ...
    options: ["Brown planthopper (Nilaparvata lugens)", "Rice thrips (Stenchaetothrips biformis)", "White-backed planthopper (Sogatella furcifera)", "Green leafhopper (Nephotettix virescens)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Flag smut", "Karnal bunt", "Loose smut", "Covered smut (stinking smut)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Late blight of potato", "Anthrax (Bacillus anthracis)", "Wheat rust", "Tobacco mosaic virus"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Abscisic acid (ABA)", "Auxin", "Salicylic acid (SA)", "Ethylene"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Pseudomonas syringae pv. syringae", "Agrobacterium tumefaciens", "Erwinia carotovora", "Xanthomonas axonopodis pv. citri"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Host, Pathogen, Environment", "Host, Pathogen, Vector", "Pathogen, Environment, Time", "Host, Vector, Environment"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Downy mildew", "Stalk rot", "Stewart's wilt and leaf blight", "Charcoal rot"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Form obligate symbiosis", "Live on the surface without penetrating", "Require living host tissue for growth", "Kill host tissue and feed on dead material"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Basidiospores", "Ascospores", "Conidia (pycnidiospores)", "Chlamydospores"],
    correct: 2,
  ...
  // AGRICULTURAL ECONOMICS (7)
  {
    ...
    options: ["Leon Walras", "John Stuart Mill", "Jeremy Bentham", "Alfred Marshall"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Surplus production", "Low productivity and traditional farming methods", "Advanced mechanisation", "High capital intensity"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["PV of benefits / PV of costs", "Net benefit / Net cost", "Total cost / Total benefit", "Gross output / Gross input"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["State APMC Acts (model since 2003)", "WDRA Act 2007", "Essential Commodities Act 1955", "Contract Farming Act 2020"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Organic farming", "Watershed management", "HYV seeds, fertilisers and irrigation", "Crop insurance schemes"],
    correct: 2,
  ...
  // SURVEYING (4)
  {
    ...
    options: ["At an angle to the chain line", "Perpendicular to the chain line", "Along the chain line", "Between two chain lines"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Grid North", "Magnetic North", "True North", "Astronomical North"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Even", "Prime number", "Odd", "Any number"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Above the nearest benchmark", "Below mean sea level", "Above the instrument axis", "Above mean sea level"],
    correct: 3,
  ...
  // FORESTRY (5)
  {
    ...
    options: ["Private timber companies", "Forest-dwelling Scheduled Tribes and other traditional forest dwellers", "State governments", "Forest Department officials"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Site index (height of dominant trees at base age)", "Rainfall of the area", "Species composition", "Age of the stand"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Boundary/border planting", "Alley cropping", "Taungya system", "Windbreak / shelterbelt"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["28.30%", "19.05%", "24.62%", "21.71%"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Tropical dry deciduous forest", "Subtropical broadleaf forest", "Mangrove forest", "Tropical moist deciduous forest"],
    correct: 2,
  ...
  // HORTICULTURE (10)
  {
    ...
    options: ["Bappakai", "Kurukan", "Vellaikolamban", "Olour"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Suckers and rhizome bits", "Grafting", "Air layering", "Seeds"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Under extreme cold conditions", "In water", "Before they are shed from the parent plant", "In soil rich in nitrogen"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Bower (Pandal) system", "Espalier system", "Kniffin system", "Head training"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Vegetative growth increases", "Flowering is promoted", "Dormancy breaks", "Flowering is inhibited"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["IIHR, Bangalore", "Punjab Agricultural University", "IARI, New Delhi", "NHB, Gurugram"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Acetylene (from calcium carbide)", "Ethylene / Ethephon", "Carbon dioxide", "Nitrogen"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lycopersicon esculentum", "Capsicum annuum", "Solanum torvum", "Solanum melongena"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Latent heat flux from evapotranspiration", "The fraction of incoming solar radiation reflected by a surface", "Net radiation absorbed by crop canopy", "Total incoming solar radiation at the top of atmosphere"],
    correct: 1,
  ...
  // EXTENSION (6)
  {
    ...
    options: ["During majority phase (~34%)", "Among first 13.5% but not the earliest", "First, representing ~2.5% of the population", "Last after all others"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["FAO", "Directorate of Extension", "NAARM", "World Bank (Daniel Benor)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Communication and behaviour change", "Farm credit", "Market development", "Agricultural input supply"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Farmers are passive recipients of information", "Government officers design programmes unilaterally", "Community members actively analyse their own situation", "Experts diagnose problems for farmers"],
    correct: 2,
  ...
  { id:"gt5_096", qNo:96, subject:"general-agriculture", question:"The Soil Health Card Scheme was launched in India in:", options:["2010", "2015", "2017", "2012"], correct: 1, explanation:"Soil Health Card Scheme was launched on 19 February 2015 to provide soil health cards to all farmers across the country, giving recommendations on nutrient management based on soil test results." },
  { id:"gt5_097", qNo:97, subject:"general-agriculture", question:"IARI (Indian Agricultural Research Institute) in New Delhi is also called:", options:["Raj Institute", "Green Institute", "Pusa Institute", "Agriculture Hub"], correct: 2, explanation:"IARI, established in 1905, is popularly known as 'Pusa Institute' as it was originally located at Pusa, Bihar before moving to New Delhi in 1936. It is India's premier agricultural research institution." },
  { id:"gt5_098", qNo:98, subject:"general-agriculture", question:"The concept of 'Evergreen Revolution' was given by:", options:["M.S. Swaminathan", "C. Subramaniam", "V. Kurien", "Norman Borlaug"], correct: 0, explanation:"Dr. M.S. Swaminathan coined 'Evergreen Revolution' to mean increasing productivity in perpetuity without causing ecological harm — combining food security with environmental sustainability." },
  { id:"gt5_099", qNo:99, subject:"general-agriculture", question:"Under PM-KISAN scheme, eligible farmers receive per year:", options:["₹6,000", "₹10,000", "₹4,000", "₹2,000"], correct: 0, explanation:"PM-KISAN (Pradhan Mantri Kisan Samman Nidhi), launched February 2019, provides ₹6,000 per year (₹2,000 each in 3 installments) as direct income support to all eligible farmer families." },
  { id:"gt5_100", qNo:100, subject:"general-agriculture", question:"The headquarters of FAO (Food and Agriculture Organization) is located at:", options:["Geneva, Switzerland", "Vienna, Austria", "Rome, Italy", "New York, USA"], correct: 2, explanation:"FAO is headquartered in Rome, Italy. It was founded in 1945 and works to defeat hunger worldwide. Its mandate covers food security, agriculture, forestry, fisheries and rural development." },
];
