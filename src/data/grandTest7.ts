...
export const GRAND_TEST_7: GrandTestQuestion[] = [
  // AGRONOMY (6)
  {
    ...
    options: ["Total biomass to grain yield", "Grain yield to total above-ground biological yield", "Root biomass to shoot biomass", "Leaf area to total plant weight"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5:1 to 10:1", "25:1 to 30:1", "50:1 to 60:1", "100:1 to 120:1"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Net radiation", "Wind speed", "Soil type", "Vapour pressure deficit"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cross-pollination between varieties", "Release of chemicals by plants that inhibit or stimulate other plants", "Alternate cropping of two crops", "Mixed cropping system"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5–7 days", "8–12 days", "25–30 days", "35–40 days"],
    correct: 1,
  ...
  // KHARIF CROPS (7)
  {
    ...
    options: ["Nitrogen accumulation", "Declining soil organic matter and soil compaction (hard pan)", "Waterlogging improvement", "Phosphorus build-up"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fusarium wilt only", "Sterility mosaic disease and Fusarium wilt", "Pod borers only", "Phytophthora blight"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Bacillus subtilis", "Bacillus thuringiensis var. kurstaki (cry1Ac gene)", "Pseudomonas fluorescens", "Trichoderma viride"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Cool and humid", "Hot, dry to semi-arid", "Tropical humid", "Sub-alpine"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["India", "Ethiopia", "Mexico", "Indonesia"],
    correct: 1,
  ...
  // RABI CROPS (5)
  {
    ...
    options: ["March–April", "June–July", "October–November", "December–January"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Sonora 64 / Lerma Rojo (Mexican dwarf wheat)", "NP 809", "C 306", "HD 2329"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Increase tillering", "Shorten the internodes and prevent lodging", "Promote rooting", "Delay flowering"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Germination", "Vegetative", "Flowering and pod fill", "Maturity"],
    correct: 2,
  ...
  // GENETICS (7)
  {
    ...
    options: ["James Watson", "Alfred Knudson", "Francis Crick", "Barbara McClintock"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mutation theory", "Dominance theory / Overdominance theory", "Polyploidy theory", "Neutral theory"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Differences in DNA amplification rates", "Variation in fragment sizes after restriction enzyme digestion", "Chromosome morphology differences", "Protein electrophoresis patterns"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Inducing DNA mutations", "Inhibiting spindle fibre formation during cell division", "Stimulating cell division rate", "Breaking chromosome arms"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["VA / VP", "VP / VG", "VG / VP", "VA / VG"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Seeds are untreated", "Seeds conform to the morphological and agronomic description of the variety", "Seeds are certified organic", "Seeds are 100% germinating"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Germination percentage", "Genetic purity of the seed lot", "Seed moisture content", "Physical purity"],
    correct: 1,
  ...
  // SOIL SCIENCE (5)
  {
    ...
    options: ["pF 0.5", "pF 1.5", "pF 2.5", "pF 4.2"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A soil horizon", "A sequence of soils along a topographic slope with related genesis", "A type of clay mineral", "A soil profile", ],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Detachment → Transport → Deposition", "Deposition → Transport → Detachment", "Transport → Detachment → Deposition", "Detachment → Deposition → Transport"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Zingg (1940)", "Musgrave (1947)", "Wischmeier and Smith (1965)", "Renard et al. (1997)"],
    correct: 2,
  ...
  // SOIL FERTILITY (5)
  {
    ...
    options: ["Tip burn", "Hollow stem / Brown curd", "Bottom rot", "Black leg"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Optimal tillage depth", "Fertiliser dose based on soil nutrient status and expected yield", "Irrigation schedule", "Seed rate for the crop"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Nitrogen and potassium", "Phosphorus and micronutrients (Zn, Cu)", "Calcium and magnesium", "Sulphur and chlorine"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Deficiency-induced uptake", "Uptake of nutrients beyond the plant's metabolic requirement", "Nutrient antagonism", "Root-mediated nutrient immobilisation"],
    correct: 1,
  ...
  // ENTOMOLOGY (5)
  {
    ...
    options: ["Antennae", "First abdominal segment", "Thorax", "Head"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Paul Müller (1939)", "Fritz Haber (1918)", "Justus von Liebig (1840)", "Carl Bosch (1913)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Parasitoid of aphids", "Predator of soft-bodied insects (aphids, mites, eggs)", "Pollinator", "Biological weed control agent"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Contact and systemic insecticide", "Fumigant only", "Stomach poison only", "Repellent"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Mass trapping only", "Monitoring pest population, mass trapping, and mating disruption", "Only repelling pests", "Attracting beneficial insects"],
    correct: 1,
  ...
  // CROP PESTS (5)
  {
    ...
    options: ["Causes direct feeding damage only", "Transmits begomoviruses (e.g., Tomato Yellow Leaf Curl Virus, Cotton Leaf Curl Virus)", "Causes galls on leaves", "Produces honeydew that causes leaf burn"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["V.M. Stern et al. (1959)", "Paul DeBach (1974)", "Rachel Carson (1962)", "Norman Borlaug (1965)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Caterpillars and grubs", "Aphids, whiteflies, and thrips", "Stem borers", "Soil insects"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["An anticoagulant", "A phosphine-releasing stomach poison", "A nervous system disruptor", "A repellent"],
    correct: 1,
  ...
  // FARM MACHINERY (6)
  {
    ...
    options: ["Sieves", "Air current (wind/fan)", "Density differences in water", "Magnetic separation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Horizontal conveying", "Vertical lifting of grain", "Cleaning and sorting", "Moisture reduction"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["15–20 cm", "25–35 cm", "45–60 cm", "60–100 cm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["They use electrical power", "They trap solar energy in a greenhouse effect, increasing temperature and reducing humidity", "They use microwave technology", "They recirculate air continuously"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Engine power to wheel power", "Theoretical performance to actual field performance (×100)", "Working width to transport width", "Actual area covered to total area of field"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Only at the threshing cylinder", "At cutter bar, cylinder, and sieves/separation (total field loss)", "Only at the rear of the machine", "Only at the grain tank"],
    correct: 1,
  ...
  // PLANT PATHOLOGY (9)
  {
    ...
    options: ["Phytophthora drechsleri f. sp. cajani", "Fusarium udum", "Rhizoctonia solani", "Sclerotium rolfsii"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Glomerella cingulata", "Diaporthe citri", "Botryosphaeria obtusa", "Guignardia bidwellii"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Fungicide soaking", "Hot water treatment at 50°C for 2 hours or 54°C for 30 minutes", "Cold stratification", "Gamma irradiation"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vertical resistance", "Horizontal resistance", "Immunity", "Tolerance"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Helminthosporium oryzae (Bipolaris oryzae)", "Cercospora oryzae", "Curvularia lunata", "Alternaria padwickii"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Hyperparasitism", "Production of iturin, surfactin, and fengycin antibiotics", "Competition for iron (siderophores only)", "Induced systemic resistance only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Aspergillus flavus and A. parasiticus", "Fusarium graminearum", "Penicillium expansum", "Claviceps purpurea"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["A slow resistance response over weeks", "Rapid, localised cell death that contains pathogen spread", "Systemic chlorosis", "Pathogen detoxification by enzymes"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Proportion spent on food increases", "Proportion spent on food decreases", "Savings decrease", "Expenditure on luxury goods decreases"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Third Plan", "Fifth Plan", "Sixth Plan", "Seventh Plan"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Ministry of Agriculture", "National Sample Survey Office (NSSO)", "Directorate of Economics and Statistics", "ICAR"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["There is only one seller", "There is only one buyer", "There are many buyers and sellers", "Government controls prices"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The cost of producing crop A", "The foregone profit from crop B", "The market price of crop A", "The total farm input cost"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["₹1/kg for wheat, ₹2/kg for rice", "₹2/kg for wheat, ₹3/kg for rice, ₹1/kg for millets", "₹5/kg for all food grains", "At MSP prices"],
    correct: 1,
  ...
  // SURVEYING (4)
  {
    ...
    options: ["10 m", "20 m", "20.117 m (66 feet)", "30 m"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Field surveys", "Photographs (aerial or terrestrial)", "Gravity measurements", "Satellite signals only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Battery life of receiver", "Number of visible satellites and atmospheric delays", "Map scale", "Operator error only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Soil type boundaries", "Lines of equal elevation above MSL", "Property boundaries", "Drainage channels"],
    correct: 1,
  ...
  // FORESTRY (5)
  {
    ...
    options: ["Forestry on government reserve lands only", "Growing trees on non-forest land (farm land, degraded land) by communities", "Plantation forestry for commercial timber", "Afforestation of catchment areas"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Kerala", "Tamil Nadu", "Odisha", "West Bengal"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["A forest fire break crop", "A fast-growing tree planted with a main species to provide shade and protection", "A medicinal plant species", "A wind-breaking species"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Reducing Environmental Degradation Decisions", "Reducing Emissions from Deforestation and Forest Degradation (+ conservation, sustainable management, enhancement)", "Regional Economic Development and Deforestation", "Reforestation and Environmental Development Drive"],
    correct: 1,
  ...
  // HORTICULTURE (10)
  {
    ...
    options: ["Measuring tree height", "Estimating spacing in orchards", "Soil sampling", "Pruning tall mango trees"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Calcium deficiency during storage", "CO₂ injury in Controlled Atmosphere (CA) storage", "Boron toxicity", "Ethylene exposure"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Citrus fruit, Rutaceae", "Tropical fruit (Nephelium lappaceum), Sapindaceae", "Stone fruit, Rosaceae", "Berry fruit, Vitaceae"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mango for ripeness", "Citrus for maturity indexing", "Grapes for harvest timing", "All of the above"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Zingiberaceae", "Apiaceae", "Orchidaceae", "Lamiaceae"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Removing vegetable colour by peeling", "Brief heat treatment to inactivate enzymes before freezing/canning", "Chemical whitening of vegetables", "Drying in shade"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["10 × 10 m (100 trees/ha)", "5 × 5 m (400 trees/ha)", "2.5 × 2.5 m (1600 trees/ha)", "3 × 3 m (1111 trees/ha)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["King × Willow-leaf mandarin", "Clementine × Satsuma", "Blood orange × Sweet lime", "Mosambi × Karna khatta"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Insect damage", "High respiration rate and water loss (transpiration)", "Mechanical damage during transport", "Chemical residues"],
    correct: 1,
  ...
  // EXTENSION (6)
  {
    ...
    options: ["ICAR alone", "World Bank + Government of India", "FAO + UNDP", "Asian Development Bank"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Bidirectional flow between researchers and farmers", "Unidirectional flow from research → extension → farmer", "Farmer-led innovation", "Peer-to-peer technology sharing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Lecture-based instruction", "Discovery-based, participatory learning in the field", "Text-book based learning", "Remote e-learning"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["ITC Limited", "Government of India", "NABARD", "World Bank"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Loud sounds that disturb farmers", "Any interference or barrier that distorts the message", "Technical agricultural terminology", "Volume of communication"],
    correct: 1,
  ...
  { id:"gt7_096", qNo:96, subject:"general-agriculture", question:"IFAD (International Fund for Agricultural Development) was established in:", options:["1960","1970","1977","1985"], correct:2, explanation:"IFAD was established in 1977 as a UN specialized agency. It is headquartered in Rome, Italy and focuses on rural poverty reduction by investing in agriculture, rural enterprises and natural resource management in developing countries." },
  { id:"gt7_097", qNo:97, subject:"general-agriculture", question:"'Zero Hunger' is which Sustainable Development Goal (SDG)?", options:["SDG 1","SDG 2","SDG 3","SDG 4"], correct:1, explanation:"SDG 2 'Zero Hunger' aims to end hunger, achieve food security, improve nutrition and promote sustainable agriculture by 2030. It is one of the 17 SDGs adopted by the UN in 2015." },
  { id:"gt7_098", qNo:98, subject:"general-agriculture", question:"e-NAM (National Agriculture Market) is an online trading platform for:", options:["Fertilizer procurement by state governments","Trading of agricultural produce across APMC mandis","Export of spices to foreign markets","Procurement of tractors and farm machinery"], correct:1, explanation:"e-NAM is a pan-India electronic trading portal launched in April 2016 that networks existing APMC mandis to create a unified national market for agricultural commodities, enabling transparent price discovery." },
  { id:"gt7_099", qNo:99, subject:"general-agriculture", question:"The government target of 'Doubling Farmers' Income' was set for the year:", options:["2019","2020","2022","2025"], correct:2, explanation:"The Government of India set a target to double farmers' real income by 2022 (base year 2015–16), based on the Ashok Dalwai Committee recommendations. Key strategies include increased crop productivity, market reforms and value addition." },
  { id:"gt7_100", qNo:100, subject:"general-agriculture", question:"CGIAR (Consultative Group on International Agricultural Research) was established to:", options:["Provide agricultural loans to developing countries","Support international agricultural research for food security and poverty reduction","Regulate international trade in agricultural commodities","Monitor global food prices"], correct:1, explanation:"CGIAR (established 1971) is a global research partnership of 15 international agricultural research centres (including IRRI, CIMMYT, ICRISAT) focused on reducing rural poverty, improving food security and nutrition." },
];
