...
export const GRAND_TEST_7: GrandTestQuestion[] = [
  // AGRONOMY (6)
  {
    ...
    options: ["Grain yield to total above", "Total biomass to grain yield", "Root biomass to shoot biomass", "Leaf area to total plant weight"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["50:1 to 60:1", "25:1 to 30:1", "100:1 to 120:1", "5:1 to 10:1"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Vapour pressure deficit", "Wind speed", "Soil type", "Net radiation"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Mixed cropping system", "Cross-pollination between varieties", "Alternate cropping of two crops", "Release of chemicals by plants that inhibit or stimulate other plants"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["25–30 days", "35–40 days", "5–7 days", "8–12 days"],
    correct: 3,
  ...
  // KHARIF CROPS (7)
  {
    ...
    options: ["Nitrogen accumulation", "Waterlogging improvement", "Phosphorus build-up", "Declining soil organic matter and soil compaction (hard pan)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Phytophthora blight", "Sterility mosaic disease and Fusarium wilt", "Fusarium wilt only", "Pod borers only"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Cool and humid", "Tropical humid variety", "Sub-alpine species", "Hot, dry to semi-arid"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["India", "Ethiopia", "Indonesia", "Mexico"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["5.5–6.5", "4.5–5.5", "7.5–8.5", "6.5–7.5"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Shorten the internodes and prevent lodging", "Delay flowering", "Increase tillering", "Promote rooting"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Maturity plant", "Flowering and pod fill", "Vegetative type", "Germination plant"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Barley", "Linseed", "Pea", "Wheat"],
    correct: 0,
  ...
  // GENETICS (7)
  {
    ...
    options: ["Barbara McClintock", "Francis Crick", "James Watson", "Alfred Knudson"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Transposition", "Conjugation", "Transformation", "Transduction"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Differences in DNA amplification rates", "Protein electrophoresis patterns", "Chromosome morphology differences", "Variation in fragment sizes after restriction enzyme digestion"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Inhibiting spindle fibre formation during cell division", "Stimulating cell division rate", "Breaking chromosome arms", "Inducing DNA mutations"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["VP / VG", "VA / VG", "VA / VP", "VG / VP"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Seeds conform to the morphological and agronomic description of the variety", "Seeds are certified organic", "Seeds are untreated", "Seeds are 100% germinating"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Germination percentage", "Seed moisture content", "Genetic purity of the seed lot", "Physical purity"],
    correct: 2,
  ...
  // SOIL SCIENCE (5)
  {
    ...
    options: ["pF 4.2", "pF 0.5", "pF 2.5", "pF 1.5"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["A soil profile", "A type of clay mineral", "A sequence of soils along a topographic slope with related genesis", "A soil horizon"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Detachment → Transport → Deposition", "Detachment → Deposition → Transport", "Transport → Detachment → Deposition", "Deposition → Transport → Detachment"],
    correct: 0,
  ...
  // SOIL FERTILITY (5)
  {
    ...
    options: ["Black leg", "Bottom rot", "Tip burn", "Hollow stem / Brown curd"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Irrigation schedule", "Fertiliser dose based on soil nutrient status and expected yield", "Seed rate for the crop", "Optimal tillage depth"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Sulphur and chlorine", "Phosphorus and micronutrients", "Calcium and magnesium", "Nitrogen and potassium"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Uptake of nutrients beyond the plant's metabolic requirement", "Deficiency-induced uptake", "Root-mediated nutrient immobilisation", "Nutrient antagonism"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Justus von Liebig (1840)", "Fritz Haber (1918)", "Paul Müller (1939)", "Carl Bosch (1913)"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Parasitoid of aphids", "Pollinator", "Predator of soft", "Biological weed control agent"],
    correct: 2,
  ...
  // CROP PESTS (5)
  {
    ...
    options: ["Transmits begomoviruses", "Produces honeydew that causes leaf burn", "Causes galls on leaves", "Causes direct feeding damage only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["It lives underground", "It has short life cycle with multiple generations", "It is polyphagous, rapidly metabolises insecticides through cytochrome P450 enzymes", "It has hard cuticle"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Paul DeBach (1974)", "Rachel Carson (1962)", "Norman Borlaug (1965)", "V.M. Stern et al. (1959)"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Stem borers", "Aphids, whiteflies, and thrips", "Soil insects", "Caterpillars and grubs"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["An anticoagulant", "A repellent", "A nervous system disruptor", "A phosphine-releasing stomach poison"],
    correct: 3,
  ...
  // FARM MACHINERY (6)
  {
    ...
    options: ["Density differences in water", "Magnetic separation", "Air current (wind/fan)", "Sieves"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Cleaning and sorting", "Vertical lifting of grain", "Moisture reduction", "Horizontal conveying"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["60–100 cm", "45–60 cm", "15–20 cm", "25–35 cm"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["They recirculate air continuously", "They use electrical power", "They use microwave technology", "They trap solar energy in a greenhouse effect, increasing temperature and reducing humidity"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Engine power to wheel power", "Actual area covered to total area of field", "Working width to transport width", "Theoretical performance to actual field performance (×100)"],
    correct: 3,
  ...
  // PLANT PATHOLOGY (9)
  {
    ...
    options: ["Rhizoctonia solani", "Fusarium udum", "Phytophthora drechsleri f. sp. cajani", "Sclerotium rolfsii"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Guignardia bidwellii", "Botryosphaeria obtusa", "Glomerella cingulata", "Diaporthe citri"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Fungicide soaking", "Cold stratification", "Gamma irradiation", "Hot water treatment at 50°C for 2 hours or 54°C for 30 minutes"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Horizontal resistance", "Vertical resistance", "Tolerance", "Immunity"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Curvularia lunata", "Helminthosporium oryzae", "Cercospora oryzae", "Alternaria padwickii"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Production of iturin, surfactin, and fengycin antibiotics", "Hyperparasitism", "Competition for iron (siderophores only)", "Induced systemic resistance only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Penicillium expansum", "Claviceps purpurea", "Aspergillus flavus and A. parasiticus", "Fusarium graminearum"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Systemic chlorosis", "Rapid, localised cell death that contains pathogen spread", "Pathogen detoxification by enzymes", "A slow resistance response over weeks"],
    correct: 1,
  ...
  // AGRICULTURAL ECONOMICS (7)
  {
    ...
    options: ["NAFED", "CACP", "Reserve Bank of India", "FCI (Food Corporation of India)"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Fifth Plan", "Seventh Plan", "Sixth Plan", "Third Plan"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["National Sample Survey Office (NSSO)", "ICAR", "Directorate of Economics and Statistics", "Ministry of Agriculture"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["There are many buyers and sellers", "There is only one buyer", "There is only one seller", "Government controls prices"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["The foregone profit from crop B", "The market price of crop A", "The total farm input cost", "The cost of producing crop A"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Photographs", "Field surveys", "Gravity measurements", "Satellite signals only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Property boundaries", "Lines of equal elevation above MSL", "Drainage channels", "Soil type boundaries"],
    correct: 1,
  ...
  // FORESTRY (5)
  {
    ...
    options: ["Growing trees on non", "Plantation forestry for commercial timber", "Afforestation of catchment areas", "Forestry on government reserve lands only"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Odisha", "Kerala", "West Bengal", "Tamil Nadu"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["A wind-breaking species", "A fast", "A medicinal plant species", "A forest fire break crop"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Regional Economic Development and Deforestation", "Reforestation and Environmental Development Drive", "Reducing Emissions from Deforestation and Forest Degradation", "Reducing Environmental Degradation Decisions"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Dipterocarpaceae", "Fabaceae", "Lamiaceae", "Meliaceae"],
    correct: 2,
  ...
  // HORTICULTURE (10)
  {
    ...
    options: ["Pruning tall mango trees", "Estimating spacing in orchards", "Measuring tree height", "Soil sampling"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Calcium deficiency during storage", "Ethylene exposure", "CO₂ injury in Controlled Atmosphere (CA) storage", "Boron toxicity"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Stone fruit, Rosaceae", "Tropical fruit (Nephelium lappaceum), Sapindaceae", "Citrus fruit, Rutaceae", "Berry fruit, Vitaceae"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Mango for ripeness", "All of the above", "Citrus for maturity indexing", "Grapes for harvest timing"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Apiaceae", "Lamiaceae", "Zingiberaceae", "Orchidaceae"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["Removing vegetable colour by peeling", "Drying in shade", "Chemical whitening of vegetables", "Brief heat treatment to inactivate enzymes before freezing/canning"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["5 × 5 m (400 trees/ha)", "3 × 3 m (1111 trees/ha)", "2.5 × 2.5 m (1600 trees/ha)", "10 × 10 m (100 trees/ha)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Clementine × Satsuma", "King × Willow-leaf mandarin", "Blood orange × Sweet lime", "Mosambi × Karna khatta"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Chemical residues", "High respiration rate and water loss", "Mechanical damage during transport", "Insect damage"],
    correct: 1,
  ...
  // EXTENSION (6)
  {
    ...
    options: ["Asian Development Bank", "ICAR alone", "World Bank + Government of India", "FAO + UNDP"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["Unidirectional flow from research → extension → farmer", "Peer-to-peer technology sharing", "Farmer-led innovation", "Bidirectional flow between researchers and farmers"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Discovery", "Lecture-based instruction", "Text-book based learning", "Remote e-learning"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["ITC Limited", "NABARD", "Government of India", "World Bank"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Technical agricultural terminology", "Volume of communication", "Loud sounds that disturb farmers", "Any interference or barrier that distorts the message"],
    correct: 3,
  ...
  { id:"gt7_096", qNo:96, subject:"general-agriculture", question:"IFAD (International Fund for Agricultural Development) was established in:", options: ["1985", "1970", "1977", "1960"], correct: 2, explanation:"IFAD was established in 1977 as a UN specialized agency. It is headquartered in Rome, Italy and focuses on rural poverty reduction by investing in agriculture, rural enterprises and natural resource management in developing countries." },
  { id:"gt7_097", qNo:97, subject:"general-agriculture", question:"'Zero Hunger' is which Sustainable Development Goal (SDG)?", options: ["SDG 1", "SDG 4", "SDG 3", "SDG 2"], correct: 3, explanation:"SDG 2 'Zero Hunger' aims to end hunger, achieve food security, improve nutrition and promote sustainable agriculture by 2030. It is one of the 17 SDGs adopted by the UN in 2015." },
  { id:"gt7_098", qNo:98, subject:"general-agriculture", question:"e-NAM (National Agriculture Market) is an online trading platform for:", options: ["Fertilizer procurement by state governments", "Export of spices to foreign markets", "Trading of agricultural produce across APMC mandis", "Procurement of tractors and farm machinery"], correct: 2, explanation:"e-NAM is a pan-India electronic trading portal launched in April 2016 that networks existing APMC mandis to create a unified national market for agricultural commodities, enabling transparent price discovery." },
  { id:"gt7_099", qNo:99, subject:"general-agriculture", question:"The government target of 'Doubling Farmers' Income' was set for the year:", options: ["2019", "2025", "2020", "2022"], correct: 3, explanation:"The Government of India set a target to double farmers' real income by 2022 (base year 2015–16), based on the Ashok Dalwai Committee recommendations. Key strategies include increased crop productivity, market reforms and value addition." },
  { id:"gt7_100", qNo:100, subject:"general-agriculture", question:"CGIAR (Consultative Group on International Agricultural Research) was established to:", options: ["Monitor global food prices", "Regulate international trade in agricultural commodities", "Provide agricultural loans to developing countries", "Support international agricultural research for food security and poverty reduction"], correct: 3, explanation:"CGIAR (established 1971) is a global research partnership of 15 international agricultural research centres (including IRRI, CIMMYT, ICRISAT) focused on reducing rural poverty, improving food security and nutrition." },
];
